    ...
    <thead>
        <tr>
            <th class="left" width="1%">
                {include file="common/check_items.tpl" check_statuses=$call_request_statuses}
            </th>
            <th width="10%">
                ...
                <td colspan="3" valign="top">
                    ...
                    {if $request.cart_products}
                        <div>
                            ...
                            <i class="icon-caret-down cm-combination" id="on_call_req_{$request.request_id}"></i>
                            <i class="icon-caret-up cm-combination hidden" id="off_call_req_{$request.request_id}"></i>
                        </div>
                    {/if}
                </td>

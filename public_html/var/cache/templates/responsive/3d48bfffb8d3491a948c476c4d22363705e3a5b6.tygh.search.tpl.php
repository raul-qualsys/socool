<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:13:42
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/orders/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11093847985f63a75697e9e8-76515065%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d48bfffb8d3491a948c476c4d22363705e3a5b6' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/orders/search.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11093847985f63a75697e9e8-76515065',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63a7569e19c9_72514186',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63a7569e19c9_72514186')) {function content_5f63a7569e19c9_72514186($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('search_options','id','status','customer','date','total','text_no_orders','orders','search_options','id','status','customer','date','total','text_no_orders','orders'));
?>
...
<table class="ty-table ty-orders-search">
    <thead>
        <tr>
            <th><a class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
        <tr>
            <td class="ty-orders-search__item"><a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><strong>#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
</strong></a></td>
            ...
            <td class="ty-orders-search__item">
                <ul class="ty-orders-search__user-info">
                    <li class="ty-orders-search__user-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['firstname'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
</li>
                    <li  class="ty-orders-search__user-mail"><a href="mailto:<?php echo htmlspecialchars(rawurlencode($_smarty_tpl->tpl_vars['o']->value['email']), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
                </ul>
            </td>
            <td class="ty-orders-search__item"><a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>

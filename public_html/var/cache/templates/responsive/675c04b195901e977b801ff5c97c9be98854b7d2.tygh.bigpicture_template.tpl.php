<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:47:49
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/product_templates/bigpicture_template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16740680085ee26e4511fe97-42941241%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '675c04b195901e977b801ff5c97c9be98854b7d2' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/product_templates/bigpicture_template.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16740680085ee26e4511fe97-42941241',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26e451f07e4_64800008',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26e451f07e4_64800008')) {function content_5ee26e451f07e4_64800008($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
><bdi><?php echo $_smarty_tpl->tpl_vars['product']->value['product'];?>
                    ...
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:image_wrap")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:image_wrap"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                        ...
                        <?php if (!$_smarty_tpl->tpl_vars['no_images']->value) {?>
                            <div class="ty-product-bigpicture__img <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['image_pairs'])<1) {?> ty-product-bigpicture__no-thumbs<?php }?> cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['thumbnails_gallery']=="Y") {?>ty-product-bigpicture__as-gallery<?php } else { ?>ty-product-bigpicture__as-thumbs<?php }?>" id="product_images_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
_update">

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:18:11
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/profile_fields/s_state.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11696672325ee2bbb3d7a713-16745549%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe036d3bb85c2a82d58c7ec91d815cf1ee7c8adc' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/profile_fields/s_state.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11696672325ee2bbb3d7a713-16745549',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bbb3d95616_37121143',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bbb3d95616_37121143')) {function content_5ee2bbb3d95616_37121143($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<div class="litecheckout__field litecheckout__field--xsmall">
    <select data-ca-lite-checkout-field="user_data.s_state"
            ...
            data-ca-lite-checkout-last-value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
...
?>
            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country_state']->value['code'], ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php if ($_smarty_tpl->tpl_vars['country_state']->value['code']===$_smarty_tpl->tpl_vars['state']->value) {?>selected<?php }?>
            ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country_state']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
        <?php } ?>
    </select>
...
"
           placeholder=" "
           value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value, ENT_QUOTES, 'ISO-8859-1');?>
"

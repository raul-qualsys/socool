<?php /* Smarty version Smarty-3.1.21, created on 2020-06-25 17:48:06
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1485966165ef529a6c4fd13-24172558%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eeec8c0491247d03fea5aa4f01927ec72e97862f' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/profiles/update.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1485966165ef529a6c4fd13-24172558',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef529a6d00bc5_16468418',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef529a6d00bc5_16468418')) {function content_5ef529a6d00bc5_16468418($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['action']) {?>
    <?php $_smarty_tpl->tpl_vars['dispatch'] = new Smarty_variable("profiles.update.".((string)$_smarty_tpl->tpl_vars['runtime']->value['action']), null, 0);?>
<?php }?>

<?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add"&&$_smarty_tpl->tpl_vars['settings']->value['General']['quick_registration']=="Y") {?>
    <div class="ty-account">

        <form name="profiles_register_form" enctype="multipart/form-data" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
            ...
            <?php if ($_REQUEST['return_url']) {?>
                <input type="hidden" name="return_url" value="<?php echo htmlspecialchars($_REQUEST['return_url'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            <?php }?>
            ...
            <div class="ty-profile-field__buttons buttons-container">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/register_profile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[".((string)$_smarty_tpl->tpl_vars['dispatch']->value)."]"), 0);?>
...
" method="post">
                ...
                <input type="hidden" name="profile_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['profile_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <div class="ty-profile-field__buttons buttons-container">
                    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add") {?>
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/register_profile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[".((string)$_smarty_tpl->tpl_vars['dispatch']->value)."]",'but_id'=>"save_profile_but"), 0);?>

                    <?php } else { ?>
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[".((string)$_smarty_tpl->tpl_vars['dispatch']->value)."]",'but_meta'=>"ty-btn__secondary",'but_id'=>"save_profile_but"), 0);?>
...
?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['allow_usergroup_signup']=="Y"||$_smarty_tpl->tpl_vars['settings']->value['General']['allow_usergroup_signup']!="Y"&&$_smarty_tpl->tpl_vars['ug_status']->value=="A") {?>
                                <tr>
                                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['usergroup']->value['usergroup'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                                    <td class="ty-center">
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['allow_usergroup_signup']=="Y") {?>
                                        <td>
                                            <a class="cm-ajax" data-ca-target-id="content_usergroups" href="<?php echo htmlspecialchars(fn_url("profiles.usergroups?usergroup_id=".((string)$_smarty_tpl->tpl_vars['usergroup']->value['usergroup_id'])."&type=".((string)$_smarty_tpl->tpl_vars['_req_type']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_link_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                        </td>
                                    <?php }?>
                                </tr>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 01:36:57
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/topmenu_dropdown.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20148668885ee1d1098fe4d9-44572213%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3fe2b45340be92d0f7c51c5b5440c35dbc3a3ee1' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/topmenu_dropdown.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20148668885ee1d1098fe4d9-44572213',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1d1099896f1_26466109',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1d1099896f1_26466109')) {function content_5ee1d1099896f1_26466109($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
if ($_smarty_tpl->tpl_vars['item1']->value['class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['class'], ENT_QUOTES, 'ISO-8859-1');
}?>">
...
if ($_smarty_tpl->tpl_vars['item2']->value['class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2']->value['class'], ENT_QUOTES, 'ISO-8859-1');
}?>">
...
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['item2']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                    </li>
                                <?php } ?>
...
"<?php }?> class="ty-menu__submenu-link" <?php if ($_smarty_tpl->tpl_vars['item2']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                            </div>
...
if ($_smarty_tpl->tpl_vars['item3']->value['class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item3']->value['class'], ENT_QUOTES, 'ISO-8859-1');
}?>">
...
"<?php }?>
                                                                        class="ty-menu__submenu-link" <?php if ($_smarty_tpl->tpl_vars['item3']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item3']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                                            </li>
                                                        <?php } ?>
                                                        <?php if ($_smarty_tpl->tpl_vars['item2']->value['show_more']&&$_smarty_tpl->tpl_vars['item2_url']->value) {?>
                                                            <li class="ty-menu__submenu-item ty-menu__submenu-alt-link">
                                                                <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2_url']->value, ENT_QUOTES, 'ISO-8859-1');?>
"

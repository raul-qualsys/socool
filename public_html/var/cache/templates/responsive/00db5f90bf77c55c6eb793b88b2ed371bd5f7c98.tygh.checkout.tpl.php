<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:18:11
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/payments/checkout.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18948788135ee2bbb3e7bef7-90562512%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '00db5f90bf77c55c6eb793b88b2ed371bd5f7c98' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/payments/checkout.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18948788135ee2bbb3e7bef7-90562512',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bbb3ec08c9_89976120',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bbb3ec08c9_89976120')) {function content_5ee2bbb3ec08c9_89976120($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.set_id.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_no_payments_needed','checkout_terms_n_conditions_alert','skip_payment','text_no_payments_needed','checkout_terms_n_conditions_alert','skip_payment'));
?>
...
?>
        <div class="litecheckout__shipping-method litecheckout__field litecheckout__field--xsmall">
            ...
            <input type="radio"
                   ...
                   id="radio_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                   ...
                   value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                   <?php if ($_smarty_tpl->tpl_vars['payment']->value['payment_id']==$_smarty_tpl->tpl_vars['cart']->value['payment_id']) {?>checked<?php }?>
            />

            <label id="payments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                   class="litecheckout__shipping-method__wrapper js-litecheckout-toggle"
                   for="radio_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                   data-ca-toggling="payments_form_wrapper_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
            ...
            >
                ...
                <?php }?>
                <p class="litecheckout__shipping-method__title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
                <p class="litecheckout__shipping-method__delivery-time"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
            </label>
...
?>
        <p>
            <?php echo $_smarty_tpl->__("text_no_payments_needed");?>
...
?>
        ...
        <div class="litecheckout__group litecheckout__payment-method"
             data-ca-toggling-by="payments_form_wrapper_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
             data-ca-hideble="true"
        >
            <input type="hidden" name="payment_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
...
"/>
            ...
            <?php if ($_smarty_tpl->tpl_vars['order_id']->value) {?>
                <input type="hidden" name="order_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <?php }?>

            <input type="hidden" name="payment_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php if ($_smarty_tpl->tpl_vars['iframe_mode']->value) {?>
            <div class="ty-payment-method-iframe__box">
                <iframe width="100%" height="700" id="order_iframe_<?php echo htmlspecialchars(@constant('TIME'), ENT_QUOTES, 'ISO-8859-1');?>
"
                        src="<?php echo htmlspecialchars(fn_checkout_url("checkout.process_payment",@constant('AREA')), ENT_QUOTES, 'ISO-8859-1');?>
"
                ...
                <?php if ($_smarty_tpl->tpl_vars['cart_agreements']->value||$_smarty_tpl->tpl_vars['settings']->value['Checkout']['agree_terms_conditions']=="Y") {?>
                    <div id="payment_method_iframe_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['payment_id'], ENT_QUOTES, 'ISO-8859-1');?>
"

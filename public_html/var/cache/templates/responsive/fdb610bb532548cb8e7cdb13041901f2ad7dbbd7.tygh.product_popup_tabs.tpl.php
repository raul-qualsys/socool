<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:47:50
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/tabs/components/product_popup_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8773724775ee26e46119844-46886690%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdb610bb532548cb8e7cdb13041901f2ad7dbbd7' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/tabs/components/product_popup_tabs.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8773724775ee26e46119844-46886690',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26e46149812_47891968',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26e46149812_47891968')) {function content_5ee26e46149812_47891968($_smarty_tpl) {?><?php if (!is_callable('smarty_function_render_block')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.render_block.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php if (trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['tab_content_capture']->value])) {?>
                <li class="ty-popup-tabs__item"><i class="ty-popup-tabs__icon ty-icon-popup"></i><a id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab']->value['html_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-dialog-opener" data-ca-target-id="content_block_popup_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" rel="nofollow"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
                <div id="content_block_popup_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 01:36:57
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/auth/login_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80697035ee1d10948f003-55858014%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29a4298f4043274f2f1e55b0459d98581f24b5d6' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/auth/login_form.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '80697035ee1d10948f003-55858014',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1d1094c69e2_75121406',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1d1094c69e2_75121406')) {function content_5ee1d1094c69e2_75121406($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("login", null, null); ob_start(); ?>
    <form name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
...
" name="user_login" size="30" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['demo_username'], ENT_QUOTES, 'ISO-8859-1');?>
...
</label><a href="<?php echo htmlspecialchars(fn_url("auth.recover_password"), ENT_QUOTES, 'ISO-8859-1');?>
...
" class="ty-login__input" maxlength="32" />
        ...
        <?php if ($_smarty_tpl->tpl_vars['style']->value=="popup") {?>
            <div class="ty-login-reglink ty-center">
                <a class="ty-login-reglink__a" href="<?php echo htmlspecialchars(fn_url("profiles.add"), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:login_buttons")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:login_buttons"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <div class="buttons-container clearfix">
                ...
                <div class="ty-login__remember-me">
                    <label for="remember_me_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-login__remember-me-label"><input class="checkbox" type="checkbox" name="remember_me" id="remember_me_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:10:24
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/components/bottom_panel/bottom_panel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7268669845ee265806bdec7-84568277%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '91694d3a98d1daf96b02945f71ea9327ad4e1e27' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/components/bottom_panel/bottom_panel.tpl',
      1 => 1564032795,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '7268669845ee265806bdec7-84568277',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee265807e8433_88233284',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee265807e8433_88233284')) {function content_5ee265807e8433_88233284($_smarty_tpl) {?><?php if (!is_callable('smarty_block_styles')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.styles.php';
if (!is_callable('smarty_function_style')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.style.php';
...
<?php $_smarty_tpl->tpl_vars['utm'] = new Smarty_variable("utm_source=".((string)smarty_modifier_replace(preg_replace('!\s+!', '',strtolower(@constant('PRODUCT_NAME'))),'-','_'))."&utm_medium=".((string)$_smarty_tpl->tpl_vars['edition']->value), null, 0);?>

<div class="bp__container">
    <div id="bp_bottom_panel"
        class="bp-panel bp-panel--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['edition']->value, ENT_QUOTES, 'ISO-8859-1');?>
 bp-panel--<?php echo htmlspecialchars(@constant('ACCOUNT_TYPE'), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        data-bp-nav-active=<?php echo htmlspecialchars(@constant('ACCOUNT_TYPE'), ENT_QUOTES, 'ISO-8859-1');?>

        data-bp-modes-active="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['active_mode']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <a href="<?php if (@constant('ACCOUNT_TYPE')==="customer") {
echo htmlspecialchars(fn_url('',"C"), ENT_QUOTES, 'ISO-8859-1');
} else {
echo htmlspecialchars(fn_url('',"A"), ENT_QUOTES, 'ISO-8859-1');
}?>"
            class="bp-logo"
        ...
        <div class="bp-nav
            ...
            <?php }?>
            ">
            <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)@constant('AREA'))."&to_area=C",'A'), ENT_QUOTES, 'ISO-8859-1');?>
"
            ...
            <a href="<?php echo htmlspecialchars(smarty_modifier_replace(fn_url("bottom_panel.redirect?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)@constant('AREA'))."&user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id'])."&switch_company_id=0","A"),$_smarty_tpl->tpl_vars['config']->value['vendor_index'],$_smarty_tpl->tpl_vars['config']->value['admin_index']), ENT_QUOTES, 'ISO-8859-1');?>
" class="bp-nav__item cm-no-ajax
            ...
            <?php if (fn_allowed_for("MULTIVENDOR")) {?>
                <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)@constant('AREA'))."&user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id']),"V"), ENT_QUOTES, 'ISO-8859-1');?>
" class="bp-nav__item cm-no-ajax
            ...
            <div class="bp-modes">
                <a 
                    <?php if ($_smarty_tpl->tpl_vars['active_mode']->value==="text") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp1=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_tmp1), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp2=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_tmp2), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp3=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_tmp3), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } else { ?>
                        href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php }?>
                ...
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"live_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                    <a href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp4=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_tmp4), ENT_QUOTES, 'ISO-8859-1');?>
"
                ...
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"theme_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                    <a href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp5=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_tmp5), ENT_QUOTES, 'ISO-8859-1');?>
"
...
ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp6=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_tmp6), ENT_QUOTES, 'ISO-8859-1');
} else { ?>#<?php }?>"
...
: <?php echo $_smarty_tpl->__("n_days",array($_smarty_tpl->tpl_vars['trial_left']->value));?>
                    ...
                    <a target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['demo_product_buy_url'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" class="bp-btn">
                        <span class="bp-btn__text bp-btn__text--animation"><?php echo $_smarty_tpl->__("bottom_panel.buy_license");?>
</span>
                    </a>
                <?php } else { ?>
                    <a target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['download'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" class="bp-btn">
                    ...
                    <div class="bp-dropdown-menu">
                        <?php if (@constant('ACCOUNT_TYPE')==="customer") {?>
                            <div class="bp-dropdown-menu__group">
                                <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("themes.manage","A"), ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("bottom_panel.change_theme");?>
"><?php echo $_smarty_tpl->__("bottom_panel.change_theme");?>
</a>
                                <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("block_manager.manage&selected_location=".((string)$_smarty_tpl->tpl_vars['location_data']->value['location_id']),"A"), ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("bottom_panel.edit_layout");?>
"><?php echo $_smarty_tpl->__("bottom_panel.edit_layout");?>
</a>
                                <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("templates.manage","A"), ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("bottom_panel.edit_template");?>
"><?php echo $_smarty_tpl->__("bottom_panel.edit_template");?>
</a>
                                <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("languages.translations","A"), ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("bottom_panel.edit_translations");?>
"><?php echo $_smarty_tpl->__("bottom_panel.edit_translations");?>
</a>
                            </div>
                            <div class="bp-dropdown-menu__group">
                                <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("menus.manage","A"), ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.edit_menus");?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['page']->value==="products") {?>
                                    <a class="bp-dropdown-menu__item" href="<?php echo htmlspecialchars(fn_url("tabs.manage","A"), ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.edit_product_tabs");?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['edition']->value==="demo"&&$_smarty_tpl->tpl_vars['config']->value['demo_instance']['uid']&&$_smarty_tpl->tpl_vars['config']->value['demo_instance']['refreshable']) {?>
                            <div class="bp-dropdown-menu__group">
                                <a class="bp-dropdown-menu__item" href=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['demo_instance']['refresh_url'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.restore_demo");?>
            ...
            <div class="bp-dropdown bp-actions__item">
                ...
                <div class="bp-dropdown-menu">
                    <div class="bp-dropdown-menu__group">
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['docs_url'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("bottom_panel.documentation");?>
</a>
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['forum'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("bottom_panel.community_forums");?>
</a>
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['video_tutorials'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("bottom_panel.video_tutorials");?>
</a>
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['faq'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("bottom_panel.faq");?>
</a>
                    </div>
                    <div class="bp-dropdown-menu__group">
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['helpdesk_url'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("bottom_panel.customer_help_desk");?>
</a>
                        <a class="bp-dropdown-menu__item" target="_blank" href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['developers_catalog'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div id="bp_bottom_buttons" class="bp-bottom-buttons
        ...
        <?php if ($_smarty_tpl->tpl_vars['edition']->value==="personal_demo") {?>
            <a class="bp-bottom-button bp-bottom-button--primary bp-bottom-button--text
                ...
                <?php }?>"
                href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['demo_product_buy_url'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['edition']->value==="demo") {?>
            <a class="bp-bottom-button bp-bottom-button--primary bp-bottom-button--text
                <?php if ($_COOKIE['pb_is_bottom_panel_open']==="true") {?>        
                    bp-bottom-button--disabled bp-bottom-button--disabled-action
                <?php }?>"
                href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['config']->value['resources']['download'],$_smarty_tpl->tpl_vars['utm']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-bp-bottom-buttons="action"
                target="_blank">
            ...
            <div class="bp-modes">
                <a 
                    <?php if ($_smarty_tpl->tpl_vars['active_mode']->value==="text") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp7=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_tmp7), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp8=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_tmp8), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');
$_tmp9=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_tmp9), ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php } else { ?>
                        href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
"
                ...
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"live_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                    <a href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp10=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_tmp10), ENT_QUOTES, 'ISO-8859-1');?>
"
                        id="settings_live_editor"
                        class="cm-no-ajax bp-modes__item bp-modes__item--text
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value==="text") {?>bp-modes__item--active<?php }?>"
                ...
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"theme_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                    <a href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp11=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_tmp11), ENT_QUOTES, 'ISO-8859-1');?>
"
                        id="settings_theme_editor"
                        class="cm-no-ajax bp-modes__item bp-modes__item--theme
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value==="theme") {?>bp-modes__item--active<?php }?>"
...
ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'ISO-8859-1');
$_tmp12=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_tmp12), ENT_QUOTES, 'ISO-8859-1');
} else { ?>#<?php }?>"
                       id="settings_block_manager"
                       class="cm-no-ajax bp-modes__item bp-modes__item--build
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value==="build") {?>bp-modes__item--active<?php }?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-12-17 06:48:55
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/newsletters/hooks/profiles/account_update.pre.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19970869725fdb53b7cd7eb3-94098961%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b08dd3c61ddd4d506acd3b259827df546959c07' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/newsletters/hooks/profiles/account_update.pre.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19970869725fdb53b7cd7eb3-94098961',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fdb53b7d4df68_79916607',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fdb53b7d4df68_79916607')) {function content_5fdb53b7d4df68_79916607($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?>
                ...
                <?php }?>
                <input id="all_profile_mailing_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
" type="hidden" name="all_mailing_lists[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />

                <div class="ty-newsletters__item<?php if (!$_smarty_tpl->tpl_vars['list']->value['show_on_registration']) {?> hidden<?php }?>">
                    <input id="profile_mailing_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
" type="checkbox" name="mailing_lists[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['user_mailing_lists']->value[$_smarty_tpl->tpl_vars['list']->value['list_id']]) {?>checked="checked"<?php }?> class="checkbox" /><label for="profile_mailing_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['object'], ENT_QUOTES, 'ISO-8859-1');?>
</label>
                </div>
            <?php } ?>
        </div>

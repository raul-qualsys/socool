<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:45
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18266959935ee2bb99f04013-13952085%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4825a143e892e595db843700cbf2c516dfd6feb5' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18266959935ee2bb99f04013-13952085',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb9a06b136_13387448',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb9a06b136_13387448')) {function content_5ee2bb9a06b136_13387448($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.truncate.php';
...
">
                <?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']) {?>
                    <a href="<?php echo htmlspecialchars(fn_url("gift_certificates.update?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)), ENT_QUOTES, 'ISO-8859-1');?>
">
                    ...
                    <div class="ty-mtb-xs ty-center"><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("edit"),'but_href'=>"gift_certificates.update?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value),'but_role'=>"text"), 0);?>
</div>
                <?php } else { ?>
                    <?php echo $_smarty_tpl->getSubTemplate ("addons/gift_certificates/views/gift_certificates/components/gift_certificates_cart_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('width'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_width'],'height'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_height']), 0);?>
...
" class="ty-cart-content__product-title">
 ...
 cm-post ty-delete-big" href="<?php echo htmlspecialchars(fn_url("gift_certificates.delete?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['c_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
:</label><span class="ty-control-group__item"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
        </div>
        <div class="ty-control-group">
            <label class="ty-control-group__label"><?php echo $_smarty_tpl->__("gift_cert_from");?>
:</label><span class="ty-control-group__item"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
        </div>
        <div class="ty-control-group">
...
echo $_smarty_tpl->__("postal_mail");
        ...
        <a id="sw_gift_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combination ty-cart-content__detailed-link"><?php echo $_smarty_tpl->__("free_products");?>
</a>

        <div id="gift_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden">
...
"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value['product']),70,"...",true);?>
                        ...
                        <?php }?>
                        <a class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 ty-delete-big" href="<?php echo htmlspecialchars(fn_url("checkout.delete?cart_id=".((string)$_smarty_tpl->tpl_vars['key']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['c_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
][extra][parent][certificate]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
                    </div>
                    <div class="ty-control-group">
                    ...
                    <div class="ty-control-group">
                        ...
                        <input type="text" size="3" name="cart_products[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>

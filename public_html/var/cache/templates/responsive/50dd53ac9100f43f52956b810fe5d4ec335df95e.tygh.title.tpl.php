<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:18:50
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/customer/title.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8354365145ee2bbda43e299-82091754%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50dd53ac9100f43f52956b810fe5d4ec335df95e' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/customer/title.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8354365145ee2bbda43e299-82091754',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bbda45d3e0_23125195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bbda45d3e0_23125195')) {function content_5ee2bbda45d3e0_23125195($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
$_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div class="litecheckout__group">
    <div class="litecheckout__item litecheckout__item--fill">
        <h2 class="litecheckout__step-title"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['block_title']->value)===null||$tmp==='' ? $_smarty_tpl->__("lite_checkout.customer_information") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</h2>
    </div>
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['allow_multiple_profiles']->value) {?>
        <div class="litecheckout__item litecheckout__item--center">
            <a
                ...
                href="<?php echo htmlspecialchars(fn_url("checkout.update_profile"), ENT_QUOTES, 'ISO-8859-1');?>
"

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:10:26
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/theme_editor/components/fileuploader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5276635225ee26582df3854-96420523%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b05b68c3402324fa235c15e7c9050302ed5abe72' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/theme_editor/components/fileuploader.tpl',
      1 => 1564032795,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '5276635225ee26582df3854-96420523',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26582e0fb42_56686501',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26582e0fb42_56686501')) {function content_5ee26582e0fb42_56686501($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
" title=""><p class="cm-fu-file " style="display: none;"><span class="filename-link"></span><i class="glyph-cancel" id="clean_selection_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("remove_this_item");?>
" onclick="Tygh.fileuploader.clean_selection(this.id); Tygh.fileuploader.toggle_links(this.id, 'show');">&nbsp;</i></p></div><div id="link_container_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
</span><?php } else { ?><span class="te-btn ty-left fileinput-btn"><input type="file" name="file_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 01:36:57
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/cart_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10394568175ee1d1097d1ce9-90669993%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83f7f538d39d4ab37958364c6bd8937074d73155' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/cart_content.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10394568175ee1d1097d1ce9-90669993',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1d1098475a3_39627297',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1d1098475a3_39627297')) {function content_5ee1d1098475a3_39627297($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:cart_content")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:cart_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <div class="ty-dropdown-box" id="cart_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
" class="ty-dropdown-box__title cm-combination">
        <a href="<?php echo htmlspecialchars(fn_url("checkout.cart"), ENT_QUOTES, 'ISO-8859-1');?>
">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:dropdown_title")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:dropdown_title"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <?php if ($_SESSION['cart']['amount']) {?>
                    ...
                    <span class="ty-minicart-title ty-hand"><?php echo htmlspecialchars($_SESSION['cart']['amount'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['product']->value['product'])===null||$tmp==='' ? fn_get_product_name($_smarty_tpl->tpl_vars['product']->value['product_id']) : $tmp);?>
                                                    ...
                                                    <p>
                                                        <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['amount'], ENT_QUOTES, 'ISO-8859-1');?>
...
" rel="nofollow" class="ty-btn ty-btn__secondary"><?php echo $_smarty_tpl->__("view_cart");?>
    ...
    <!--cart_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>

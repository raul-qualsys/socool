<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:13:01
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/complete.tpl" */ ?>
<?php /*%%SmartyHeaderCode:739468345f63a72d210d80-90458682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25fbccd7e0e5a27172945aef0039eade54bfd3d9' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/complete.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '739468345f63a72d210d80-90458682',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63a72d2619e7_26188184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63a72d2619e7_26188184')) {function content_5f63a72d2619e7_26188184($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
    ...
    <p><?php echo $_smarty_tpl->__("text_order_placed_successfully");?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['order_info']->value) {?>
            <?php if ($_smarty_tpl->tpl_vars['order_info']->value['child_ids']) {?>
                <a href="<?php echo htmlspecialchars(fn_url("orders.search?period=A&order_id=".((string)$_smarty_tpl->tpl_vars['order_info']->value['child_ids'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("order_details");?>
</a>
            <?php } else { ?>
                <a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['order_info']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("order_details");?>
</a>
            <?php }?>
        <?php }?>
...
<div class="ty-checkout-complete__create-account">
    ...
    <div class="ty-login">
        <form name="order_register_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
            <input type="hidden" name="order_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:43:55
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/product_filters/selected_filters.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5573888345ee26d5bda32b5-18044796%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8218a6a05e34a19fec28a02022dcefde16828272' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/product_filters/selected_filters.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5573888345ee26d5bda32b5-18044796',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26d5bde70f8_58759382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26d5bde70f8_58759382')) {function content_5ee26d5bde70f8_58759382($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_sizeof')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.sizeof.php';
...
<div class="ty-horizontal-product-filters ty-selected-product-filters cm-product-filters cm-horizontal-filters" id="selected_filters_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
    ...
    <div class="ty-horizontal-product-filters-dropdown<?php if ($_smarty_tpl->tpl_vars['filter']->value['selected_variants']||$_smarty_tpl->tpl_vars['filter']->value['selected_range']) {?> active<?php }?>">
        <div id="sw_elm_selected_filter_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['filter_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-horizontal-product-filters-dropdown__wrapper cm-combination"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['filter'], ENT_QUOTES, 'ISO-8859-1');
...
)<?php }?><a class="cm-ajax cm-ajax-full-render cm-history" href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['reset_url']->value), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="ty-icon-cancel-circle"></i></a><i class="ty-horizontal-product-filters-dropdown__icon ty-icon-down-micro"></i></div>
        <div id="elm_selected_filter_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['filter_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
<!--selected_filters_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>

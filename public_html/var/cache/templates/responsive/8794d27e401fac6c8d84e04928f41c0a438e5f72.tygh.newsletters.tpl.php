<?php /* Smarty version Smarty-3.1.21, created on 2020-12-18 20:34:37
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/newsletters/blocks/lite_checkout/newsletters.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17125537995fdd66bd8046a0-28281337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8794d27e401fac6c8d84e04928f41c0a438e5f72' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/newsletters/blocks/lite_checkout/newsletters.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17125537995fdd66bd8046a0-28281337',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fdd66bd87d971_81805269',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fdd66bd87d971_81805269')) {function content_5fdd66bd87d971_81805269($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
"/>
            <div class="ty-newsletters__item<?php if (!$_smarty_tpl->tpl_vars['list']->value['show_on_checkout']) {?> hidden<?php }?>">
                <label for="fake_subscribe_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                    <input type="checkbox"
                           id="subscribe_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                           name="mailing_lists[]"
                           value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                    ...
                    />
                    <input type="checkbox"
                           id="fake_subscribe_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                           data-ca-target-id="subscribe_list_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                           value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['list']->value['list_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                           <?php if ($_smarty_tpl->tpl_vars['user_mailing_lists']->value[$_smarty_tpl->tpl_vars['list']->value['list_id']]) {?>checked="checked"<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['show_newsletters_content']->value) {?>
    <div class="litecheckout__group litecheckout__newsletters">
        <div class="litecheckout__item litecheckout__item--full">
            <h2 class="litecheckout__step-title"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['block']->value['name'])===null||$tmp==='' ? $_smarty_tpl->__("text_signup_for_subscriptions") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</h2>
        </div>
        <div class="litecheckout__item litecheckout__item--full">

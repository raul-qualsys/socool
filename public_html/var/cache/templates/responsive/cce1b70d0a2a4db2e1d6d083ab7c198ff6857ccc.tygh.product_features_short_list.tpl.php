<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:43:56
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/products/components/product_features_short_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10274942745ee26d5c268442-61747942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cce1b70d0a2a4db2e1d6d083ab7c198ff6857ccc' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/products/components/product_features_short_list.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10274942745ee26d5c268442-61747942',
  'function' => 
  array (
    'feature_value' => 
    array (
  ...
  'unifunc' => 'content_5ee26d5c2d0c71_80308287',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26d5c2d0c71_80308287')) {function content_5ee26d5c2d0c71_80308287($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
<?php if (!is_callable('smarty_modifier_enum')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['fvariant']->value['variant'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['fvariant']->value['value'] : $tmp), ENT_QUOTES, 'ISO-8859-1');
...
echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['feature']->value['variant'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['feature']->value['value'] : $tmp), ENT_QUOTES, 'ISO-8859-1');
} elseif ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::SINGLE_CHECKBOX")) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');
}

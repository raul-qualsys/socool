<?php /* Smarty version Smarty-3.1.21, created on 2020-06-26 04:19:16
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/gift_certificates/hooks/wishlist/view.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9074430325ef5bd94e86318-20613541%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2c1de733b71872ab9e9030aa7e754c6cdd1c3c28' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/gift_certificates/hooks/wishlist/view.post.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9074430325ef5bd94e86318-20613541',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef5bd94f29265_65076198',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef5bd94f29265_65076198')) {function content_5ef5bd94f29265_65076198($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
<?php echo smarty_function_math(array('equation'=>"it + 1",'assign'=>"iteration",'it'=>$_smarty_tpl->tpl_vars['iteration']->value),$_smarty_tpl);?>
    ...
    <div class="ty-gift-certificate-wishlist ty-column<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['columns']->value, ENT_QUOTES, 'ISO-8859-1');?>
">

            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                <div class="ty-twishlist-item">
                    <a href="<?php echo htmlspecialchars(fn_url("gift_certificates.wishlist_delete?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt ty-twishlist-item__txt"><?php echo $_smarty_tpl->__("remove");?>
                ...
                <div class="ty-grid-list__image">
                    <a href="<?php echo htmlspecialchars(fn_url("gift_certificates.update?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
if ($_smarty_tpl->tpl_vars['gift']->value['products']) {?> + <?php echo $_smarty_tpl->__("free_products");
                ...
                <div class="ty-grid-list__control">
                    <div class="ty-quick-view-button">
                        <a id="opener_gift_cert_picker_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-btn ty-btn__secondary ty-btn__big cm-dialog-opener cm-dialog-auto-size" data-ca-target-id="gift_cert_quick_view_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url("gift_certificates.update?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" rel="nofollow"><?php echo $_smarty_tpl->__("quick_view");?>
            ...
            <div class="hidden" id="gift_cert_quick_view_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("gift_certificate");?>
">
                <form action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (!$_smarty_tpl->tpl_vars['config']->value['tweaks']['disable_dhtml']) {?>class="cm-ajax cm-form-dialog-closer"<?php }?> method="post" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
gift_cert_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
">

                <input type="hidden" value="cart_status*,wish_list*" name="result_ids" />
                <input type="hidden" name="gift_cert_data[send_via]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['send_via'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <input type="hidden" name="gift_cert_data[amount]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['amount'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <input type="hidden" name="gift_cert_data[correct_amount]" value="N" />
                <input type="hidden" name="gift_cert_data[recipient]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <input type="hidden" name="gift_cert_data[sender]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <input type="hidden" name="gift_cert_data[message]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['message'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['email']) {?><input type="hidden" name="gift_cert_data[email]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['title']) {?><input type="hidden" name="gift_cert_data[title]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['firstname']) {?><input type="hidden" name="gift_cert_data[firstname]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['firstname'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['lastname']) {?><input type="hidden" name="gift_cert_data[lastname]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['address']) {?><input type="hidden" name="gift_cert_data[address]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['address'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['city']) {?><input type="hidden" name="gift_cert_data[city]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['city'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['country']) {?><input type="hidden" name="gift_cert_data[country]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['country'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['state']) {?><input type="hidden" name="gift_cert_data[state]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['gift']->value['zipcode']) {?><input type="hidden" name="gift_cert_data[zipcode]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
...
"><?php echo $_smarty_tpl->getSubTemplate ("addons/gift_certificates/views/gift_certificates/components/gift_certificates_cart_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('width'=>"150",'height'=>"150"), 0);?>
                        ...
                        <div class="ty-mtb-xs ty-center"><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("edit"),'but_href'=>"gift_certificates.update?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value),'but_role'=>"text"), 0);?>
</div>
                    </div>
...
:</label>
                            <span class="ty-control-group__item"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                        </div>
                        <div class="ty-control-group product-list-field">
                            <label class="ty-control-group__label"><?php echo $_smarty_tpl->__("gift_cert_from");?>
:</label>
                            <span class="ty-control-group__item"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                        </div>
                        <div class="ty-control-group product-list-field">
...
?>
                                ...
                                <input type="hidden" name="gift_cert_data[products][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key_cert_prod']->value, ENT_QUOTES, 'ISO-8859-1');?>
][product_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wishlist']->value['products'][$_smarty_tpl->tpl_vars['key_cert_prod']->value]['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                                <input type="hidden" name="gift_cert_data[products][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key_cert_prod']->value, ENT_QUOTES, 'ISO-8859-1');?>
][amount]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wishlist']->value['products'][$_smarty_tpl->tpl_vars['key_cert_prod']->value]['amount'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_product']->value['product'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                    ...
                                    <td class="ty-center ty-nowrap">
                                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['products'][$_smarty_tpl->tpl_vars['key_cert_prod']->value]['amount'], ENT_QUOTES, 'ISO-8859-1');?>
</td>

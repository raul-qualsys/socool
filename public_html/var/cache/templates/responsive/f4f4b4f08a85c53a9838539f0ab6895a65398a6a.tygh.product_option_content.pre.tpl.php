<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:47:49
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15808236695ee26e454ae0c2-26799559%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4f4b4f08a85c53a9838539f0ab6895a65398a6a' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15808236695ee26e454ae0c2-26799559',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26e4552d035_08249102',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26e4552d035_08249102')) {function content_5ee26e4552d035_08249102($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
if ($_smarty_tpl->tpl_vars['product']->value['variation_features_variants']&&$_smarty_tpl->tpl_vars['product']->value['detailed_params']['info_type']==="D") {?>
    ...
    <div id="features_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
_AOC">
...
?>
                ...
                <div class="ty-control-group ty-product-options__item clearfix">
                    <label class="ty-control-group__label ty-product-options__item-label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
:</label>
                    <bdi>
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['feature']->value['variant_id']!=$_smarty_tpl->tpl_vars['variant']->value['variant_id']) {?>
                                    <?php continue 1;?>
                                <?php }?>
                                <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
                            <?php } ?>
...
$_smarty_tpl->tpl_vars['variant']->_loop = true;
?>
                                    <option data-ca-variant-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                            data-ca-product-url="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['product_url']->value,"product_id=".((string)$_smarty_tpl->tpl_vars['variant']->value['product']['product_id']))), ENT_QUOTES, 'ISO-8859-1');?>
"
                                            <?php if ($_smarty_tpl->tpl_vars['feature']->value['variant_id']==$_smarty_tpl->tpl_vars['variant']->value['variant_id']) {?>selected="selected"<?php }?>
                                    >
                                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
...
$_smarty_tpl->tpl_vars['variant']->_loop = true;
?>
                                <a href="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['product_url']->value,"product_id=".((string)$_smarty_tpl->tpl_vars['variant']->value['product']['product_id']))), ENT_QUOTES, 'ISO-8859-1');?>
"
                                   ...
                                   <?php if ($_smarty_tpl->tpl_vars['feature']->value['purpose']===$_smarty_tpl->tpl_vars['purpose_create_variations']->value||$_smarty_tpl->tpl_vars['quick_view']->value) {?>data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['container']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>
                                >
...
?>
                                <input type="radio"
                                       name="feature_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
...
"
                                       <?php if ($_smarty_tpl->tpl_vars['feature']->value['variant_id']==$_smarty_tpl->tpl_vars['variant']->value['variant_id']) {?>
                                           checked
                                       <?php }?>
                                       id="feature_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
_variant_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                       data-ca-variant-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                       data-ca-product-url="<?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['product_url']->value,"product_id=".((string)$_smarty_tpl->tpl_vars['variant']->value['product']['product_id']))), ENT_QUOTES, 'ISO-8859-1');?>
"
...
"
                                />
                                <label for="feature_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
_variant_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['variant']->value['variant_id'], ENT_QUOTES, 'ISO-8859-1');?>
"

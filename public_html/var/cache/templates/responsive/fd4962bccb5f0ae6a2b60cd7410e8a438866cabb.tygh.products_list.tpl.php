<?php /* Smarty version Smarty-3.1.21, created on 2020-06-21 10:01:33
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/list_templates/products_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6464187555eef764d401737-13691775%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd4962bccb5f0ae6a2b60cd7410e8a438866cabb' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/list_templates/products_list.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6464187555eef764d401737-13691775',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eef764d4b5c55_76212019',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eef764d4b5c55_76212019')) {function content_5eef764d4b5c55_76212019($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_block")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_block"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <div class="ty-product-list clearfix">
                ...
                <?php if ($_smarty_tpl->tpl_vars['bulk_addition']->value) {?>
                    <input class="cm-item ty-float-right ty-product-list__bulk" type="checkbox" id="bulk_addition_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
 image-reload" id="list_image_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
">
                            <input type="hidden" name="image[list_image_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][link]" value="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])), ENT_QUOTES, 'ISO-8859-1');?>
" />
                        <?php }?>
...
,product" />
                        ...
                        <?php }?>
                    <!--list_image_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></span>
                ...
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_block_content")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_block_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['js_product_var']->value) {?>
                        <input type="hidden" id="product_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                    <?php }?>
                    
                    <?php if ($_smarty_tpl->tpl_vars['item_number']->value=="Y") {?><strong><?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['iteration'], ENT_QUOTES, 'ISO-8859-1');?>
.&nbsp;</strong><?php }?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:10:26
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/theme_editor/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2983608155ee26582b45664-48881132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a5cd72008ccc78edb35e8b06e889392eb51282c' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/theme_editor/view.tpl',
      1 => 1564032795,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '2983608155ee26582b45664-48881132',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26582d90cc7_63782241',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26582d90cc7_63782241')) {function content_5ee26582d90cc7_63782241($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_to_json')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.to_json.php';
if (!is_callable('smarty_modifier_count')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.count.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
<?php if ($_smarty_tpl->tpl_vars['theme_manifest']->value['converted_to_css']) {?>
    <input type="hidden" name="selected_css_file" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_css_file']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php } else { ?>
    <input type="hidden" name="style_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-is-default="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['is_default'], ENT_QUOTES, 'ISO-8859-1');?>
">
    <input type="hidden" name="style[name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
">
<?php }?>
<input type="hidden" name="selected_section" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_section']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
<a href="<?php echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor"), ENT_QUOTES, 'ISO-8859-1');?>
...
: </span><span class="te-layout-title te-layout-nolink"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span></a>
        <?php } else { ?>
            <a id="sw_te-layouts" class="te-layout-name cm-combination"><span class="te-layout-label"><?php echo $_smarty_tpl->__("layout");?>
: </span><span class="te-layout-title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span></a>
...
?>
                    <li><a class="cm-te-change-layout" data-ca-layout-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value['layout_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['layout_data']->value['layout_id']!=$_smarty_tpl->tpl_vars['layout']->value['layout_id']) {?>href="<?php echo htmlspecialchars(fn_link_attach($_smarty_tpl->tpl_vars['theme_url']->value,"s_layout=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
                <?php } ?>
            </ul>
        <?php }?>
        ...
        <?php if (!$_smarty_tpl->tpl_vars['theme_manifest']->value['converted_to_css']) {?>
            ...
            <div class="te-header-menu-wrap">
                <div class="te-header-menu-wrap-left">
                    ...
                    <div class="te-select-box cm-te-selectbox te-theme" tabindex="0"><span class="cm-style-title"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['current_style_name']->value)===null||$tmp==='' ? $_smarty_tpl->__("none") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['runtime']->value['layout']['style_id']===$_smarty_tpl->tpl_vars['s_item']->value['style_id']) {?>active<?php }?>">
                                <a class="cm-te-load-style te-list-item <?php if ($_smarty_tpl->tpl_vars['runtime']->value['layout']['style_id']===$_smarty_tpl->tpl_vars['s_item']->value['style_id']) {?>active<?php }?>" data-ca-target-id="theme_editor" href="<?php echo htmlspecialchars(fn_url("theme_editor.view?style_id=".((string)$_smarty_tpl->tpl_vars['s_item']->value['style_id'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-style-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['s_item']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['s_item']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</a>

                                <a class="ty-icon-wrap-duplicate cm-te-duplicate-style" data-ca-style-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['s_item']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
"></i></a>
                                ...
                                <?php if ((($tmp = @$_smarty_tpl->tpl_vars['s_item']->value['is_removable'])===null||$tmp==='' ? true : $tmp)) {?>
                                    <a class="ty-icon-wrap-remove cm-ajax cm-confirm" data-ca-target-id="te_styles_list" href="<?php echo htmlspecialchars(fn_url("theme_editor.delete_style?style_id=".((string)$_smarty_tpl->tpl_vars['s_item']->value['style_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                        <li <?php if ($_smarty_tpl->tpl_vars['selected_section']->value==$_smarty_tpl->tpl_vars['section']->value) {?>class="active"<?php }?> data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['s']->value);?>
        ...
        <?php } else { ?>
            ...
            <div class="te-header-menu-wrap">
                <div class="te-header-menu-wrap-left">
                    <div class="te-select-box cm-te-selectbox te-theme" tabindex="0"><span class="cm-style-title"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['selected_css_file']->value)===null||$tmp==='' ? $_smarty_tpl->__("none") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span><i class="ty-icon-d-arrow"></i>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['css_file']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                </li>
                            <?php }
    ...
    <div class="te-wrap te-general cm-te-section <?php if ($_smarty_tpl->tpl_vars['selected_section']->value!="te_general") {?>hidden<?php }?>" id="te_general">
        <div class="te-inner-wrap">
            <div class="te-general-group">
                ...
                <input type="text" class="hidden" name="logotypes_image_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][type]" value="M">
                <input type="text" class="hidden" name="logotypes_image_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"></i></span><?php echo $_smarty_tpl->getSubTemplate ("backend:views/theme_editor/components/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('var_name'=>"logotypes_image_icon[".((string)$_smarty_tpl->tpl_vars['id']->value)."]",'disabled'=>$_smarty_tpl->tpl_vars['current_style']->value['is_default']), 0);?>
                    ...
                    <div class="te-favicon cm-te-logo" data-ca-image-area="favicon" style="background-image: url('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['image_path'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['field']->value['type']=="checkbox") {?>
                    <div class="te-general-group">
                        <div class="te-checkbox clearfix">
                            <label for="elm_toggle_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                <input type="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="false" class="cm-te-value-changer" />
                                <input type="checkbox" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" class="cm-te-value-changer" id="elm_toggle_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="true" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['name']->value]=="true") {?>checked="checked"<?php }?>><span class="te-toggle"><span class="te-toggle-on"><?php echo $_smarty_tpl->__("theme_editor.on");?>
    ...
    <div class="te-wrap te-css cm-te-section <?php if ($_smarty_tpl->tpl_vars['selected_section']->value!="te_css") {?>hidden<?php }?>" id="te_css">
        <div class="te-inner-wrap">
            <textarea name="style[custom_css]" cols="30" rows="10"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['custom_css'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['type']->value=="favicon") {?>
                    <?php continue 1;?>
                <?php }?>
                <li <?php if ($_smarty_tpl->tpl_vars['type']->value=="theme") {?>class="active"<?php }?>><a data-ca-target-id="elm_logo_section_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                ...
                <div class="cm-te-tab-contents" <?php if ($_smarty_tpl->tpl_vars['type']->value!="theme") {?>style="display:none;"<?php }?> id="elm_logo_section_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    <input type="text" class="hidden" name="logotypes_image_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][type]" value="M">
                    <input type="text" class="hidden" name="logotypes_image_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
                    ...
                    <div class="attach-images">
                        <div class="upload-box clearfix">
                            <div class="image-wrap pull-left">
                                <div class="te-image">
                                    <div class="te-bg-image cm-te-logo" data-ca-image-area="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'ISO-8859-1');?>
" style="background-image: url('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['image_path'], ENT_QUOTES, 'ISO-8859-1');?>
'); background-repeat: no-repeat; background-position: center center;"></div>
                                </div>
                                <div class="logo-alt"><input type="text" class="cm-image-field" id="alt_text_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="logotypes_image_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][image_alt]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['alt'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
        <div class="te-colors clearfix">
            <label for="elm_te_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['field']->value['description']);?>
                ...
                <div class="te-select-box cm-te-selectbox cm-te-google cm-te-value-changer" tabindex="0" data-ca-select-box-default="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'ISO-8859-1');?>
"><span></span><i class="ty-icon-d-arrow"></i>
                    <input type="text" class="hidden cm-te-selectbox-storage" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['name']->value]) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'ISO-8859-1');
...
?>
                        <li data-ca-select-box-value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['family']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['name']->value]==$_smarty_tpl->tpl_vars['family']->value) {?>class="active"<?php }?> style="font-family: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['family']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['family_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</li>
                        <?php } ?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['field']->value['properties']['size']) {?>
                    ...
                    <div class="te-select-box te-font-size cm-te-selectbox cm-te-value-changer" tabindex="0"><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_value']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span><i class="ty-icon-d-arrow"></i>
                        <input type="text" class="hidden cm-te-selectbox-storage" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['size_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['size_name']->value], ENT_QUOTES, 'ISO-8859-1');?>
">
                        <ul class="te-select-dropdown">
...
?>
                            <li data-ca-select-box-value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['font_size']->value, ENT_QUOTES, 'ISO-8859-1');?>
px" <?php if ($_smarty_tpl->tpl_vars['current_value']->value==$_smarty_tpl->tpl_vars['font_size']->value) {?>class="active"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['font_size']->value, ENT_QUOTES, 'ISO-8859-1');?>
</li>
                            <?php } ?>
                        </ul>
                    </div>
...
?>
                ...
                <div class="te-font-style-wrap">
                    <input type="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prop_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prop']->value['default'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                    <input class="cm-te-value-changer te-font-style-checkbox" type="checkbox" id="font_style_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prop_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prop']->value['property'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['prop_name']->value]==$_smarty_tpl->tpl_vars['prop']->value['property']) {?>checked="checked"<?php }?> /><label for="font_style_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="te-font-style <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prop']->value['property'], ENT_QUOTES, 'ISO-8859-1');?>
...
&nbsp;</span>
                            ...
                            <a id="sw_backgrounds_adv_color_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combination te-advanced-options"><i class="glyph-cog"></i></a>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['field']->value['gradient']||$_smarty_tpl->tpl_vars['field']->value['transparent']||$_smarty_tpl->tpl_vars['field']->value['full_width']) {?>
                    <div id="backgrounds_adv_color_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
&nbsp;</span>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['field']->value['full_width']) {?>
                            ...
                            <div class="te-fullwidth te-checkbox clearfix">
                                <label for="elm_toggle_full_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                    <input type="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['full_width']['match'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="false" class="cm-te-value-changer" />
                                    <input type="checkbox" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['full_width']['match'], ENT_QUOTES, 'ISO-8859-1');?>
]" class="cm-te-value-changer" id="elm_toggle_full_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="true" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['full_width']['match']]=="true") {?>checked="checked"<?php }?>>
                            ...
                            <div class="te-fullwidth te-checkbox clearfix">
                                <label for="elm_toggle_full_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                    <input type="hidden" name="style[data][copy][full_width][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="0">
                                    <input type="checkbox" name="style[data][copy][full_width][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" class="cm-te-value-changer" id="elm_toggle_full_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="1" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['color']['match']]==$_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['full_width']['match']]) {?>checked="checked"<?php }?>>
                        ...
                        <div class="te-transparent te-checkbox clearfix">
                            <label for="elm_toggle_transparent_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                <input type="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['transparent']['match'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="false" class="cm-te-value-changer">
                                <input type="checkbox" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['transparent']['match'], ENT_QUOTES, 'ISO-8859-1');?>
]" class="cm-te-value-changer" id="elm_toggle_transparent_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="true" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['transparent']['match']]=="true") {?>checked="checked"<?php }?>>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['field']->value['properties']['pattern']) {?>
                        <div class="te-bg-pattern-group clearfix">
                            ...
                            <a id="sw_backgrounds_adv_pattern_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="te-advanced-options cm-combination"><i class="glyph-cog"></i></a>
                            <div id="elm_preview_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="te-pattern-preview <?php if (!$_smarty_tpl->tpl_vars['current_style']->value['parsed']) {?> te-pattern-empty<?php }?> input-prepend cm-te-pattern-selector" data-ca-pattern-dialog="backgrounds_adv_pattern_selector_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                <?php if ($_smarty_tpl->tpl_vars['current_style']->value['parsed']) {?>
                                    <img width="100%" height="100%" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['parsed'][$_smarty_tpl->tpl_vars['field']->value['properties']['pattern']], ENT_QUOTES, 'ISO-8859-1');?>
" />
                                <?php } else { ?>
                                    <i class="ty-icon-image"></i>
                                <?php }?>
                            </div>
                            <div id="backgrounds_adv_pattern_selector_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden te-bg-pattern-selector cm-te-patterns-container">
                                <div class="te-bg-pattern-container">
                                    <div class="te-bg-pattern-list">
                                        <ul class="cm-te-pattern-list" data-ca-holder-id="elm_holder_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
                                                <li><div class="te-pattern-preview cm-te-select-pattern">
                                                        <img width="100%" height="100%" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pattern']->value, ENT_QUOTES, 'ISO-8859-1');?>
?<?php echo htmlspecialchars(@constant('TIME'), ENT_QUOTES, 'ISO-8859-1');?>
" />
                                                    </div></li>
                                            <?php } ?>
                                            <li class="divider"></li>
                            ...
                            <input type="text" class="hidden cm-te-pattern-holder cm-te-value-changer" id="elm_holder_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['pattern'], ENT_QUOTES, 'ISO-8859-1');?>
]" data-ca-preview-id="elm_preview_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['current_style']->value['parsed'][$_smarty_tpl->tpl_vars['field']->value['properties']['pattern']])===null||$tmp==='' ? "transparent" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
                        </div>
                    <?php }?>

                    <div id="backgrounds_adv_pattern_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
&nbsp;</span>
                                <div class="sse-bg-position-main-wrap clearfix">
                                    ...
                                    <div class="te-bg-position-wrap clearfix">
                                        <div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="center_left" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'ISO-8859-1');?>
                                    ...
                                    <div class="te-bg-position-wrap clearfix">
                                        <div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="bottom_left" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'ISO-8859-1');?>
                        ...
                        <div>
                            <?php $_smarty_tpl->_capture_stack[0][] = array("repeat_content", null, null); ob_start(); ?>
                                <input type="text" class="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['repeat'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['repeat']])===null||$tmp==='' ? "repeat" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
                                <ul class="te-select-dropdown">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                            ...
                            <div class="te-select-box cm-te-selectbox cm-te-value-changer" tabindex="0"><span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['repeat_title']->value)===null||$tmp==='' ? $_smarty_tpl->__("theme_editor.repeat") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span><i class="ty-icon-d-arrow"></i>
                        ...
                        <div>
                            <?php $_smarty_tpl->_capture_stack[0][] = array("scroll_content", null, null); ob_start(); ?>
                                <input type="text" class="hidden" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['attachment'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['attachment']])===null||$tmp==='' ? "scroll" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
                                <ul class="te-select-dropdown">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                            ...
                            <div class="te-select-box cm-te-selectbox cm-te-value-changer" tabindex="0"><span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['scroll_title']->value)===null||$tmp==='' ? $_smarty_tpl->__("theme_editor.scroll") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span><i class="ty-icon-d-arrow"></i>
...
<?php } else { ?>
    <div class="te-wrap te-css cm-te-section">
        <div class="te-inner-wrap">
            <div id="css_content" class="cm-te-css-editor"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['css_content']->value, ENT_QUOTES, 'ISO-8859-1');?>
</div>
        </div>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:42
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/options_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15414609935ee2bb967d5ad2-00012461%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '744fcaa95174c1fb4ebac408d7aa58e95dc19257' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/options_info.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15414609935ee2bb967d5ad2-00012461',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb96838c66_48832962',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb96838c66_48832962')) {function content_5ee2bb96838c66_48832962($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
$_smarty_tpl->tpl_vars["show_options_title"] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['show_options_title']->value)===null||$tmp==='' ? true : $tmp), null, 0);?>
...
echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['var']->value['variant_name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['var']->value['value'] : $tmp), ENT_QUOTES, 'ISO-8859-1');
}
if ($_smarty_tpl->tpl_vars['product']->value['extra']['custom_files'][$_smarty_tpl->tpl_vars['po']->value['option_id']]) {
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['file']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['file']->value['name'],"40"), ENT_QUOTES, 'ISO-8859-1');?>
...
if (trim(Smarty::$_smarty_vars['capture']['options_content'])&&trim(Smarty::$_smarty_vars['capture']['options_content'])!='&nbsp;') {
...
<bdi><span class="ty-product-options clearfix"><span class="ty-product-options-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_name'], ENT_QUOTES, 'ISO-8859-1');?>
...
if ($_smarty_tpl->tpl_vars['fields_prefix']->value) {?><input type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>

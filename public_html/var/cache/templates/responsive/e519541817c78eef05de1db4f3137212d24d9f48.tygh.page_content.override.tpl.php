<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:51:11
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1750136765ee26f0f237944-87267202%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e519541817c78eef05de1db4f3137212d24d9f48' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1750136765ee26f0f237944-87267202',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26f0f325508_13438682',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26f0f325508_13438682')) {function content_5ee26f0f325508_13438682($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
" method="post" name="forms_form" enctype="multipart/form-data">
    ...
    <input type="hidden" name="page_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
?>
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']!=@constant('FORM_IP_ADDRESS')&&$_smarty_tpl->tpl_vars['element']->value['element_type']!=@constant('FORM_REFERER')) {?>
        <div class="ty-control-group">
            <label for="<?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_FILE')) {?>type_<?php echo htmlspecialchars(md5("fb_files[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]"), ENT_QUOTES, 'ISO-8859-1');
} else { ?>elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');
...
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-mask-phone-label<?php }?> <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>cm-multiple-checkboxes<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</label>

            <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_SELECT')) {?>
                <select id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-form-builder__select" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]">
...
?>
                    <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]==$_smarty_tpl->tpl_vars['var']->value['element_id']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                <?php } ?>
                </select>
...
?>
                <label class="ty-form-builder__radio-label">
                    <input class="ty-form-builder__radio radio" <?php if ((!$_smarty_tpl->tpl_vars['form_values']->value&&$_smarty_tpl->getVariable('smarty')->value['foreach']['rd']['iteration']==1)||($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]==$_smarty_tpl->tpl_vars['var']->value['element_id'])) {?>checked="checked"<?php }?> type="radio" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
&nbsp;&nbsp;
                </label>
                <?php } ?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_CHECKBOX')) {?>
                <input type="hidden" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="N" />
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-form-builder__checkbox checkbox" <?php if ($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]=="Y") {?>checked="checked"<?php }?> type="checkbox" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="Y" />
                
                
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_SB')) {?>
                <select class="ty-form-builder__multiple-select" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
][]" multiple="multiple" >
                    <?php  $_smarty_tpl->tpl_vars['var'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['var']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['element']->value['variants']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['var']->key => $_smarty_tpl->tpl_vars['var']->value) {
...
?>
                        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (smarty_modifier_in_array($_smarty_tpl->tpl_vars['var']->value['element_id'],$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value])) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                    <?php } ?>
                </select>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>
                <div id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                <?php  $_smarty_tpl->tpl_vars['var'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['var']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['element']->value['variants']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['var']->key => $_smarty_tpl->tpl_vars['var']->value) {
...
?>
                    <label class="ty-form-builder__checkbox-label">
                        <input class="ty-form-builder__checkbox" type="checkbox" <?php if (smarty_modifier_in_array($_smarty_tpl->tpl_vars['var']->value['element_id'],$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value])) {?>checked="checked"<?php }?> id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
][]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_INPUT')) {?>
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-form-builder__input-text ty-input-text <?php if ($_smarty_tpl->tpl_vars['element']->value['position']==1) {?>cm-focus <?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'ISO-8859-1');?>
" />

            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_TEXTAREA')) {?>
                <textarea id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-form-builder__textarea" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" cols="67" rows="10"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_EMAIL')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_NUMBER')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?>
                ...
                <input type="hidden" name="customer_email" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <?php }?>
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-input-text <?php if ($_smarty_tpl->tpl_vars['element']->value['position']==1) {?>cm-focus <?php }
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-mask-phone<?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'ISO-8859-1');?>
" />
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_COUNTRIES')) {?>
                ...
                <select id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" class="ty-form-builder__country cm-country cm-location-billing_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k_country']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_STATES')) {?>
                ...
                <select class="ty-form-builder__state cm-state cm-location-billing_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k_state']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]">
...
" <?php if ($_smarty_tpl->tpl_vars['_state']->value==$_smarty_tpl->tpl_vars['state']->value['code']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <input type="text" class="cm-state cm-location-billing_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k_state']->value, ENT_QUOTES, 'ISO-8859-1');?>
 ty-input-text hidden" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
_d" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>

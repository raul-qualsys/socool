<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:18:12
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/checkout/summary.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20854497695ee2bbb417f5b6-77538057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb2110f09aa7faffa0bb15efca4efa0b2bcfa296' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/blocks/checkout/summary.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20854497695ee2bbb417f5b6-77538057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bbb41c8397_81724409',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bbb41c8397_81724409')) {function content_5ee2bbb41c8397_81724409($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('items','shipping','order_discount','payment_surcharge','taxes','included','order_total','items','shipping','order_discount','payment_surcharge','taxes','included','order_total'));
?>
...
?>
                    <tr>
                        <td class="ty-checkout-summary__item" data-ct-checkout-summary="tax-name <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
">
                            <div class="ty-checkout-summary__taxes-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
 <bdi>(<?php echo $_smarty_tpl->getSubTemplate ("common/modifier.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('mod_value'=>$_smarty_tpl->tpl_vars['tax']->value['rate_value'],'mod_type'=>$_smarty_tpl->tpl_vars['tax']->value['rate_type']), 0);

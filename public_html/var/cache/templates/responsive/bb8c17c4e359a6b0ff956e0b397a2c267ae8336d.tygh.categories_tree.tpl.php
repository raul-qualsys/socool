<?php /* Smarty version Smarty-3.1.21, created on 2020-06-12 03:17:52
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/sitemap/components/categories_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19477232435ee33a30c3ecf2-29998752%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb8c17c4e359a6b0ff956e0b397a2c267ae8336d' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/sitemap/components/categories_tree.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19477232435ee33a30c3ecf2-29998752',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee33a30c7a079_81549038',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee33a30c7a079_81549038')) {function content_5ee33a30c7a079_81549038($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
?>
     <?php if ($_smarty_tpl->tpl_vars['category']->value['level']=="0") {?>
         ...
         <ul class="ty-sitemap__tree-section-list">
                 <li class="ty-sitemap__tree-list-item parent"><a href="<?php echo htmlspecialchars(fn_url("categories.view?category_id=".((string)$_smarty_tpl->tpl_vars['category']->value['category_id'])), ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-strong"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
              <?php $_smarty_tpl->tpl_vars["ul_subcategories"] = new Smarty_variable("started", null, 0);?>
          <?php }?>
     <?php } else { ?>
             <li class="ty-sitemap__tree-list-item" style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
px<?php }?>;"><a href="<?php echo htmlspecialchars(fn_url("categories.view?category_id=".((string)$_smarty_tpl->tpl_vars['category']->value['category_id'])), ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:42
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/products/components/product_notification_items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4835421415ee2bb9658afb4-01622870%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ded55b7d9ad1136062c86bdc4fe7cf89ac5ef427' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/products/components/product_notification_items.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4835421415ee2bb9658afb4-01622870',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb965b1d00_21122709',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb965b1d00_21122709')) {function content_5ee2bb965b1d00_21122709($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
" class="ty-product-notification__product-name"><?php echo fn_get_product_name($_smarty_tpl->tpl_vars['product']->value['product_id']);?>
                    ...
                    <?php if (!($_smarty_tpl->tpl_vars['settings']->value['Checkout']['allow_anonymous_shopping']=="hide_price_and_add_to_cart"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                        <div class="ty-product-notification__price">
                            <?php if (!$_smarty_tpl->tpl_vars['hide_amount']->value) {?>
                                <span class="none"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['amount'], ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php } ?>
    <?php } else { ?>
    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['empty_text']->value, ENT_QUOTES, 'ISO-8859-1');?>

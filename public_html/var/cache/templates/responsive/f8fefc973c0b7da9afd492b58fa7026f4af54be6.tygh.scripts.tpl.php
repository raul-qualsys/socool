<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 01:37:01
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/scripts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17969239265ee1d10ddd7f33-57001474%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8fefc973c0b7da9afd492b58fa7026f4af54be6' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/scripts.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17969239265ee1d10ddd7f33-57001474',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1d10de952a0_83947188',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1d10de952a0_83947188')) {function content_5ee1d10de952a0_83947188($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_scripts')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.scripts.php';
...
',
                'coefficient': '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['coefficient'], ENT_QUOTES, 'ISO-8859-1');?>
'
            }
        },
        default_editor: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['Appearance']['default_wysiwyg_editor'], ENT_QUOTES, 'ISO-8859-1');?>
',
        default_previewer: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['Appearance']['default_image_previewer'], ENT_QUOTES, 'ISO-8859-1');?>
',
...
',
        images_dir: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
',
        notice_displaying_time: <?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['notice_displaying_time']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['Appearance']['notice_displaying_time'], ENT_QUOTES, 'ISO-8859-1');
} else { ?>0<?php }?>,
        cart_language: '<?php echo htmlspecialchars(@constant('CART_LANGUAGE'), ENT_QUOTES, 'ISO-8859-1');?>
',
        language_direction: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
',
        default_language: '<?php echo htmlspecialchars(@constant('DEFAULT_LANGUAGE'), ENT_QUOTES, 'ISO-8859-1');?>
',
...
',
        phone_validation_mode: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['Appearance']['phone_validation_mode'], ENT_QUOTES, 'ISO-8859-1');?>
'
    });
    ...
    <?php if ($_smarty_tpl->tpl_vars['config']->value['tweaks']['anti_csrf']) {?>
        ...
        _.security_hash = '<?php echo htmlspecialchars(fn_generate_security_hash(''), ENT_QUOTES, 'ISO-8859-1');?>
';
    <?php }?>
}(Tygh, Tygh.$));
<?php echo '</script'; ?>

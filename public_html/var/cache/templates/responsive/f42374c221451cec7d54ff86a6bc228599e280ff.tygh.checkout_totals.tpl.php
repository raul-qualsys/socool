<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:46
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/checkout_totals.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4913883695ee2bb9a084757-75363374%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f42374c221451cec7d54ff86a6bc228599e280ff' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/checkout_totals.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4913883695ee2bb9a084757-75363374',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb9a0af9e1_05303906',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb9a0af9e1_05303906')) {function content_5ee2bb9a0af9e1_05303906($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('change','calculate','calculate_shipping_cost','cart_subtotal','total_cost','change','calculate','calculate_shipping_cost','cart_subtotal','total_cost'));
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {
$_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start();
if ($_smarty_tpl->tpl_vars['location']->value=="cart"&&$_smarty_tpl->tpl_vars['cart']->value['shipping_required']==true&&$_smarty_tpl->tpl_vars['settings']->value['Checkout']['estimate_shipping_cost']=="Y") {?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("shipping_estimation", null, null); ob_start(); ?>
        <i class="ty-cart-total__icon-estimation ty-icon-flight"></i><a id="opener_shipping_estimation_block" class="cm-dialog-opener cm-dialog-auto-size ty-cart-total__a-estimation" data-ca-target-id="shipping_estimation_block" href="<?php echo htmlspecialchars(fn_url("checkout.cart"), ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="ty-cart-total">
    <div class="ty-cart-total__wrapper clearfix" id="checkout_totals">
        ...
        <ul class="ty-cart-statistic__total-list">
            ...
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['estimate_shipping_cost']=="N") {?>
                <span class="ty-cart-statistic__total-title"><?php echo $_smarty_tpl->__("cart_subtotal");?>
</span>
                <span class="ty-cart-statistic__total-value">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['cart']->value['discounted_subtotal'],'span_id'=>"cart_total",'class'=>"ty-price"), 0);?>

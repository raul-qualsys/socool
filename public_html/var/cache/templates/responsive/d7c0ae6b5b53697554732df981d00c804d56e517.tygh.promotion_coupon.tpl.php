<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:46
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/promotion_coupon.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16543992185ee2bb9a228386-15372984%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7c0ae6b5b53697554732df981d00c804d56e517' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/promotion_coupon.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16543992185ee2bb9a228386-15372984',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb9a25aae1_30940322',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb9a25aae1_30940322')) {function content_5ee2bb9a25aae1_30940322($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<div>
    <form class="cm-ajax cm-ajax-force cm-ajax-full-render" name="coupon_code_form<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['position']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" />
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:discount_coupons")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:discount_coupons"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <div class="ty-discount-coupon__control-group ty-input-append">
                <label for="coupon_field<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['position']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden cm-required"><?php echo $_smarty_tpl->__("promo_code");?>
</label>
                <input type="text" class="ty-input-text cm-hint" id="coupon_field<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['position']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
 ...
 "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['coupon_code']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>"checkout.delete_coupon?coupon_code=".((string)$_smarty_tpl->tpl_vars['coupon_code']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['_redirect_url']->value),'but_role'=>"delete",'but_meta'=>"ty-coupons__item-delete cm-ajax cm-ajax-full-render",'but_target_id'=>"checkout*,cart_status*,cart_items,litecheckout_form"), 0);?>

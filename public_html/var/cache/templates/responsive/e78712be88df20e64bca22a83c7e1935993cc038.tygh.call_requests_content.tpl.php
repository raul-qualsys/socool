<?php /* Smarty version Smarty-3.1.21, created on 2020-06-19 11:16:14
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10737194295eece4ce3c4430-68647601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e78712be88df20e64bca22a83c7e1935993cc038' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl',
      1 => 1565883483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10737194295eece4ce3c4430-68647601',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eece4ce402015_74588058',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eece4ce402015_74588058')) {function content_5eece4ce402015_74588058($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
$_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">

<form name="call_requests_form<?php if (!$_smarty_tpl->tpl_vars['product']->value) {?>_main<?php }?>" id="form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<input type="hidden" name="result_ids" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
...
<?php if ($_smarty_tpl->tpl_vars['product']->value) {?>
    <input type="hidden" name="call_data[product_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    <div class="ty-cr-product-info-container">
        ...
        <div class="ty-cr-product-info-header">
            <h3 class="ty-product-block-title"><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product'], ENT_QUOTES, 'ISO-8859-1');?>
</bdi></h3>
        </div>
    </div>
<?php }?>
...
<div class="ty-control-group">
    <label class="ty-control-group__title" for="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_name"><?php echo $_smarty_tpl->__("your_name");?>
</label>
    <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_name" size="50" class="ty-input-text-full" type="text" name="call_data[name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['call_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" />
</div>

<div class="ty-control-group">
    <label for="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_phone" class="ty-control-group__title cm-mask-phone-label<?php if (!$_smarty_tpl->tpl_vars['product']->value) {?> cm-required<?php }?>"><?php echo $_smarty_tpl->__("phone");?>
    ...
    <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_phone" class="ty-input-text-full cm-mask-phone ty-inputmask-bdi" size="50" type="text" name="call_data[phone]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['call_data']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
...
_email" class="ty-control-group__title cm-email"><?php echo $_smarty_tpl->__("email");?>
        ...
        <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_email" class="ty-input-text-full" size="50" type="text" name="call_data[email]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['call_data']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
...
_convenient_time_from" class="ty-control-group__title"><?php echo $_smarty_tpl->__("call_requests.convenient_time");?>
        ...
        <bdi>
            <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_convenient_time_from" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_from]" value="" placeholder="<?php echo htmlspecialchars(@constant('CALL_REQUESTS_DEFAULT_TIME_FROM'), ENT_QUOTES, 'ISO-8859-1');?>
" /> -
            <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_convenient_time_to" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_to]" value="" placeholder="<?php echo htmlspecialchars(@constant('CALL_REQUESTS_DEFAULT_TIME_TO'), ENT_QUOTES, 'ISO-8859-1');?>
" />
        </bdi>
    </div>
...
} else { ?><div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">

<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:13:42
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/orders/components/orders_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13322309265f63a7569e8aa6-56664942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b57c08dba3f2c34d9a42dc8a51bbd9045f946877' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/orders/components/orders_search_form.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13322309265f63a7569e8aa6-56664942',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63a756a05fb4_88153604',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63a756a05fb4_88153604')) {function content_5f63a756a05fb4_88153604($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<div class="clearfix">
    ...
    <div class="span4 ty-control-group">
        ...
        <input type="text" name="order_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
&nbsp;(<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['symbol'];?>
        ...
        <input type="text" name="total_sec_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['total_sec_from'], ENT_QUOTES, 'ISO-8859-1');?>
" size="3" class="ty-control-group__price" />&nbsp;&#8211;&nbsp;<input type="text" name="total_sec_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['total_sec_to'], ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:43:55
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/breadcrumbs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4226503735ee26d5bce2b10-82709721%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61b28e647ca7dee49dfb0c984c3dd17d525399d8' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/common/breadcrumbs.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4226503735ee26d5bce2b10-82709721',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26d5bd555e0_15496672',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26d5bd555e0_15496672')) {function content_5ee26d5bd555e0_15496672($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_sizeof')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.sizeof.php';
...
if ($_smarty_tpl->tpl_vars['bc']->value['link']) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['bc']->value['link']), ENT_QUOTES, 'ISO-8859-1');?>
...
}?>"<?php if ($_smarty_tpl->tpl_vars['bc']->value['nofollow']) {?> rel="nofollow"<?php }?>><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['bc']->value['title']), ENT_QUOTES, 'ISO-8859-1', true);?>
</a><?php } else { ?><span class="ty-breadcrumbs__current"><bdi><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['bc']->value['title']), ENT_QUOTES, 'ISO-8859-1', true);?>
</bdi></span><?php }
}

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:17:46
         compiled from "/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/shipping_estimation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5685044275ee2bb9a0b5fe7-61308807%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ede0d9a9c1a4ada7c38b9f7619831b8f50bced05' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/themes/responsive/templates/views/checkout/components/shipping_estimation.tpl',
      1 => 1565855938,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5685044275ee2bb9a0b5fe7-61308807',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bb9a1c98a5_75340585',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bb9a1c98a5_75340585')) {function content_5ee2bb9a1c98a5_75340585($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('calculate_shipping_cost','country','select_country','state','select_state','select_state','city','zip_postal_code','get_rates','select_shipping_method','none','free_shipping','no_shipping_required','free_shipping','text_no_shipping_methods','total','select','text_no_shipping_methods','recalculate_rates','select_shipping_method','get_rates','calculate_shipping_cost','country','select_country','state','select_state','select_state','city','zip_postal_code','get_rates','select_shipping_method','none','free_shipping','no_shipping_required','free_shipping','text_no_shipping_methods','total','select','text_no_shipping_methods','recalculate_rates','select_shipping_method','get_rates'));
?>
...
<div id="est_box<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
$_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["shipping_estimation_block_id"] = new Smarty_variable("shipping_estimation".$_tmp1.((string)$_smarty_tpl->tpl_vars['id_suffix']->value), null, 0);?>
        ...
        <div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <form class="cm-ajax" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
estimation_form<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" method="post">
                ...
                <?php if ($_smarty_tpl->tpl_vars['additional_id']->value) {?><input type="hidden" name="additional_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['additional_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" /><?php }?>
                <input type="hidden" name="result_ids" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
,shipping_estimation_buttons,shipping_estimation_rates<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
                ...
                <div class="ty-control-group">
                    <label class="ty-control-group__label cm-required" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_country<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("country");?>
</label>
                    <select id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_country<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-country cm-location-estimation<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div class="ty-control-group">
                    <label class="ty-control-group__label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_state<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("state");?>
</label>
                    <select class="cm-state cm-location-estimation<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
 <?php if (!$_smarty_tpl->tpl_vars['states']->value[$_smarty_tpl->tpl_vars['_country']->value]) {?>hidden<?php }?> ty-input-text-medium" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_state<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['state']->value['code']==$_smarty_tpl->tpl_vars['_state']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php }
...
?>
 ...
 -</option>
                    ...
                    <input type="text" class="cm-state cm-location-estimation<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
 ty-input-text-medium <?php if ($_smarty_tpl->tpl_vars['states']->value[$_smarty_tpl->tpl_vars['cart']->value['user_data']['s_country']]) {?>hidden<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_state<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_d" name="customer_location[state]" size="20" maxlength="64" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_state']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['states']->value[$_smarty_tpl->tpl_vars['cart']->value['user_data']['s_country']]) {?>disabled="disabled"<?php }?> />
                </div>

                <div class="ty-control-group">
                    <label class="ty-control-group__label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_city<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("city");?>
</label>
                    <input type="text" class="ty-input-text-medium" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_city<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="customer_location[city]" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['user_data']['s_city'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                </div>

                <div class="ty-control-group">
                    <label class="ty-control-group__label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_zipcode<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("zip_postal_code");?>
</label>
                    <input type="text" class="ty-input-text-medium" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
elm_zipcode<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="customer_location[zipcode]" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['user_data']['s_zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                </div>
                ...
                <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['buttons_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="shipping_estimation"||$_REQUEST['show_shippings']=="Y") {?>
                <?php if (!$_smarty_tpl->tpl_vars['cart']->value['shipping_failed']&&!$_smarty_tpl->tpl_vars['cart']->value['company_shipping_failed']) {?>
                    ...
                    <div id="shipping_estimation_rates<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    <form class="cm-ajax" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
select_shipping_form<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
                    <input type="hidden" name="redirect_mode" value="cart" />
                    <input type="hidden" name="result_ids" value="checkout_totals" />
                    <input type="hidden" name="suffix" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
...
?>
                        ...
                        <?php if (!fn_allowed_for("ULTIMATE")||smarty_modifier_count($_smarty_tpl->tpl_vars['product_groups']->value)>1) {?>
                            <p>
                                <strong><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['group']->value['name'])===null||$tmp==='' ? $_smarty_tpl->__("none") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</strong>
                            </p>
                        <?php }?>
                        <?php if (!fn_allowed_for("ULTIMATE")||smarty_modifier_count($_smarty_tpl->tpl_vars['product_groups']->value)>1) {?>
...
?>
                                <li>
                                    ...
                                    <?php } else { ?>
                                        <?php echo htmlspecialchars(fn_get_product_name($_smarty_tpl->tpl_vars['product']->value['product_id']), ENT_QUOTES, 'ISO-8859-1');?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                                    ...
                                    <p>
                                        <input
                                            type="radio"
                                            class="ty-valign"
                                            id="sh_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"
                                            name="shipping_ids[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]"
                                            value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                            onclick="fn_calculate_total_shipping('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
');"
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checked']->value, ENT_QUOTES, 'ISO-8859-1');?>
 />
                                            <label for="sh_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                                                class="ty-valign" id="shipping_label_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_time']->value, ENT_QUOTES, 'ISO-8859-1');?>

                                                <?php if ($_smarty_tpl->tpl_vars['rate']->value) {?> <?php echo $_smarty_tpl->tpl_vars['rate']->value;
}?>
                                            <!--shipping_label_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></label>
                    ...
                    <div id="shipping_estimation_total<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
:</strong>&nbsp;<?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['cart']->value['display_shipping_cost'],'class'=>"ty-price"), 0);?>
                    ...
                    <!--shipping_estimation_total<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
...
">
                    ...
                    <!--shipping_estimation_rates<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
                <?php } else { ?>
            ...
            <?php }?>
        <!--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_estimation_block_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>

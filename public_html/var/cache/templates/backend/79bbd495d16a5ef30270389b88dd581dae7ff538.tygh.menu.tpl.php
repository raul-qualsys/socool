<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:50
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5318296095ee234266636d3-40732601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79bbd495d16a5ef30270389b88dd581dae7ff538' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/menu.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5318296095ee234266636d3-40732601',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_5ee2342676f7e5_51373818',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2342676f7e5_51373818')) {function content_5ee2342676f7e5_51373818($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?>
        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['attr']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="navbar-admin-top cm-sticky-scroll" data-ca-stick-on-screens="sm-large,md,md-large,lg,uhd" data-ca-top="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_top']->value, ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-padding="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_padding']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <!--Navbar-->
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            ...
            <div class="nav-ult">
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                    ...
                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_url']->value, ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['companies_available_count']>1) {?>
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array("extra_content", null, null); ob_start(); ?>
                        <?php if (fn_check_view_permissions("companies.manage","GET")) {?>
                            <li class="divider"></li>
                            <li><a href="<?php echo htmlspecialchars(fn_url("companies.manage?switch_company_id=0"), ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php } else { ?>
                    <ul class="nav">
                        <?php if ($_smarty_tpl->tpl_vars['auth']->value['company_id']) {?>
                            <li class="dropdown">
                                <a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("vendor");?>
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['company_data']['company'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                            </li>
                        <?php } else { ?>
                            <?php if (fn_check_view_permissions("companies.manage","GET")) {?>
                                <li class="dropdown vendor-submenu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <span><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['name']->value,60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
</span><?php if ($_smarty_tpl->tpl_vars['storefront_status_icon']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_status_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="brand company-name"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name'],60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                    <?php if ($_smarty_tpl->tpl_vars['storefront_status_icon']->value) {?>
                    <a href="<?php echo htmlspecialchars(fn_url("storefronts.manage"), ENT_QUOTES, 'ISO-8859-1');?>
" class="brand">
                        <i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_status_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <?php } else { ?>
                        <li class="dropdown">
                            <a class="unedited-element"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        </li>
                    <?php }?>
                <?php }?>
...
?>
                    <li class="dropdown dropdown-top-menu-item<?php if ($_smarty_tpl->tpl_vars['first_level_title']->value==$_smarty_tpl->tpl_vars['navigation']->value['selected_tab']) {?> active<?php }?> navigate-items">
                        <a id="elm_menu_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['first_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="#" class="dropdown-toggle <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['first_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
if ($_smarty_tpl->tpl_vars['second_level_title']->value==$_smarty_tpl->tpl_vars['navigation']->value['subsection']) {?> active<?php }?> <?php if ($_smarty_tpl->tpl_vars['second_level']->value['is_promo']) {?>cm-promo-popup<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class'], ENT_QUOTES, 'ISO-8859-1');?>
...
>
                                    <?php if ($_smarty_tpl->tpl_vars['second_level']->value['type']=="title") {?>
                                        <a id="elm_menu_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['first_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class_href']) {?>class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class_href'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php smarty_template_function_menu_attrs($_smarty_tpl,array('attrs'=>$_smarty_tpl->tpl_vars['second_level']->value['attrs']['href']));?>
>
                                            <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['second_level']->value['title'])===null||$tmp==='' ? $_smarty_tpl->__($_smarty_tpl->tpl_vars['second_level_title']->value) : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class_href']) {?>class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class_href'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['second_level']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                                                ...
                                                <li class="<?php if ($_smarty_tpl->tpl_vars['sm']->value['active']) {?>active<?php }?> <?php if ($_smarty_tpl->tpl_vars['sm']->value['is_promo']) {?>cm-promo-popup<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class'], ENT_QUOTES, 'ISO-8859-1');?>
...
>
                                                    ...
                                                    <?php } elseif ($_smarty_tpl->tpl_vars['sm']->value['type']!="divider") {?>
                                                        <a id="elm_menu_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['first_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subitem_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['sm']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
" <?php smarty_template_function_menu_attrs($_smarty_tpl,array('attrs'=>$_smarty_tpl->tpl_vars['sm']->value['attrs']['href']));?>
><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['sm']->value['title'])===null||$tmp==='' ? $_smarty_tpl->__($_smarty_tpl->tpl_vars['subitem_title']->value) : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                                    <?php }?>
                                                </li>
                                                <?php } elseif ($_smarty_tpl->tpl_vars['sm']->value['type']=="divider") {?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
                ...
                <li class="dropdown dropdown-top-menu-item">
                    ...
                    <ul class="dropdown-menu pull-right">
...
</strong><br><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_info']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        </li>
                        <li class="divider"></li>
                        ...
                        <li><a href="<?php echo htmlspecialchars(fn_url("profiles.update?user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("edit_profile");?>
</a></li>
                        <li><a href="<?php echo htmlspecialchars(fn_url("auth.logout"), ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div class="subnav" id="header_subnav">
        ...
        <div class="search pull-right">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:global_search")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:global_search"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <form id="global_search" method="get" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
">
...
" id="search_button"></button>
                    <label for="gs_text"><input type="text" class="cm-autocomplete-off" id="gs_text" name="q" value="<?php echo htmlspecialchars($_REQUEST['q'], ENT_QUOTES, 'ISO-8859-1');?>
" /></label>
                </form>
        ...
        <ul class="nav hover-show nav-pills">
            <li class="mobile-hidden"><a href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if (fn_allowed_for("ULTIMATE")) {?>
                    ...
                    <p class="menu-heading__title-block ult">
                        <span class="menu-heading__title-block--text">
                            <?php if ($_smarty_tpl->tpl_vars['auth']->value['company_id']) {?>
                                <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['company_data']['company'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                            <?php } else { ?>
                                <?php if (fn_check_view_permissions("companies.manage","GET")) {?>
                                    <span><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['name']->value,60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
                                ...
                                <?php }?>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['storefront_status_icon']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_status_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></i><?php }?>
                ...
                <?php if (fn_allowed_for("MULTIVENDOR")&&!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
                    ...
                    <p class="menu-heading__title-block mve">
                        <span class="menu-heading__title-block--text">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span>
                            <a href="<?php echo htmlspecialchars(fn_url("storefronts.manage"), ENT_QUOTES, 'ISO-8859-1');?>
">
                                <i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_status_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['company_data']['company'], ENT_QUOTES, 'ISO-8859-1');?>
                        ...
                        <?php } else { ?>
                            <?php if (fn_check_view_permissions("companies.get_companies_list","GET")) {?>
                                <li class="dropdown" data-disable-dropdown-processing="true">
                                    ...
                                    ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                </li>
                            <?php } else { ?>
                                <li class="dropdown" data-disable-dropdown-processing="true">
                    ...
                    <?php if (fn_allowed_for("ULTIMATE")) {?>
                        <?php if ($_smarty_tpl->tpl_vars['runtime']->value['companies_available_count']>1) {?>
                            ...
                            <?php } else { ?>
                                <li class="dropdown" data-disable-dropdown-processing="true">
                                    <a class="unedited-element"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                </li>
                            <?php }?>
                        <?php }?>
...
"
            ...
            <?php }?>
                <li class="dropdown"><a href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
...
$_smarty_tpl->tpl_vars["second_level"]->_loop = true;
 $_smarty_tpl->tpl_vars['second_level_title']->value = $_smarty_tpl->tpl_vars["second_level"]->key;
?>
                            <li class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level_title']->value, ENT_QUOTES, 'ISO-8859-1');
...
><a class="<?php if ($_smarty_tpl->tpl_vars['second_level']->value['is_promo']) {?>cm-promo-popup<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (!$_smarty_tpl->tpl_vars['second_level']->value['is_promo']) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['second_level']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php smarty_template_function_menu_attrs($_smarty_tpl,array('attrs'=>$_smarty_tpl->tpl_vars['second_level']->value['attrs']['href']));?>
>
...
?>
                                            <li class="<?php if ($_smarty_tpl->tpl_vars['sm']->value['active']) {?>active<?php }?> <?php if ($_smarty_tpl->tpl_vars['sm']->value['is_promo']) {?>cm-promo-popup<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['second_level']->value['attrs']['class'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php smarty_template_function_menu_attrs($_smarty_tpl,array('attrs'=>$_smarty_tpl->tpl_vars['sm']->value['attrs']['main']));?>
><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['sm']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
" <?php smarty_template_function_menu_attrs($_smarty_tpl,array('attrs'=>$_smarty_tpl->tpl_vars['sm']->value['attrs']['href']));?>
><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['subitem_title']->value);?>
</a></li>
                                        <?php } ?>

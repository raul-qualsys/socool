<?php /* Smarty version Smarty-3.1.21, created on 2020-07-29 15:02:42
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/shippings/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20162437215f21d5e2719da2-64898594%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1c3c1b6b16769b2356e52c3646dbe2ae9b60fb2' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/shippings/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20162437215f21d5e2719da2-64898594',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f21d5e27aa491_85401569',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f21d5e27aa491_85401569')) {function content_5f21d5e27aa491_85401569($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
?>
    ...
    <tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['shipping']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
 <?php if (!$_smarty_tpl->tpl_vars['allow_save']->value) {?>cm-hide-inputs<?php } else { ?>cm-no-hide-input<?php }?>">
    <input type="hidden" name="shipping_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
][tax_ids][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['tax_ids'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['tax_ids'], ENT_QUOTES, 'ISO-8859-1');?>
" />
        <td class="mobile-hide">
            <input type="checkbox" name="shipping_ids[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" /></td>
        <td data-th="<?php echo $_smarty_tpl->__("position_short");?>
">
            <input type="text" name="shipping_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
][position]" size="3" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['position'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-micro input-hidden" /></td>
        <td data-ct-shipping-name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>
" data-th="<?php echo $_smarty_tpl->__("name");?>
">
            <a href="<?php echo htmlspecialchars(fn_url("shippings.update?shipping_id=".((string)$_smarty_tpl->tpl_vars['shipping']->value['shipping_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
">
            <input type="text" name="shipping_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
][delivery_time]" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['delivery_time'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-mini input-hidden" /></td>
        <td class="nowrap" data-th="<?php echo $_smarty_tpl->__("weight_limit");?>
&nbsp;(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'], ENT_QUOTES, 'ISO-8859-1');?>
)">
            <input type="text" name="shipping_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
][min_weight]" size="4" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['min_weight'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-mini input-hidden" />&nbsp;-&nbsp;<input type="text" name="shipping_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:42:48
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/pickers/products/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11628874385ee234d8115be3-14871261%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45a98f854e67310f42f873606602403109b3a143' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/pickers/products/picker.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11628874385ee234d8115be3-14871261',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234d817b0a6_80304401',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234d817b0a6_80304401')) {function content_5ee234d817b0a6_80304401($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
<?php if ($_smarty_tpl->tpl_vars['view_mode']->value!="list") {?>
    ...
    <a data-ca-external-click-id="opener_picker_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-external-click btn <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
"></i><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['show_but_text']->value) {?>
            <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_products") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
<?php if ($_smarty_tpl->tpl_vars['type']->value=="links") {?>
    <input type="hidden" id="p<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_ids" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {
echo htmlspecialchars(implode(",",$_smarty_tpl->tpl_vars['item_ids']->value), ENT_QUOTES, 'ISO-8859-1');
}?>" />
...
_no_item"<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?> class="hidden"<?php }?>>
    <tr class="no-items">
        <td colspan="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['colspan']->value)===null||$tmp==='' ? "3" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="cm-display-radio" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <input id="<?php if ($_smarty_tpl->tpl_vars['input_id']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['input_id']->value, ENT_QUOTES, 'ISO-8859-1');
} else { ?>c<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_ids<?php }?>" type="hidden" class="cm-picker-value" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_products") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
        </div>
    </div>
<?php }?><?php }} ?>

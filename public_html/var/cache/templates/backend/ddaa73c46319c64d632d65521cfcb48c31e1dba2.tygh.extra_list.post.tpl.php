<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:22:19
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7654140115ee2bcab331585-66421120%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddaa73c46319c64d632d65521cfcb48c31e1dba2' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7654140115ee2bcab331585-66421120',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bcab36ede3_54690543',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bcab36ede3_54690543')) {function content_5ee2bcab36ede3_54690543($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.truncate.php';
...
?>
<tr <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
>
    <td>
        <div class="pull-left">
        <i id="on_gc_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hand cm-combination icon-caret-right"></i><i title="<?php echo $_smarty_tpl->__("collapse_sublist_of_items");?>
" id="off_gc_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:&nbsp;<a href="<?php echo htmlspecialchars(fn_url("gift_certificates.update?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift']->value['gift_cert_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
<tr id="gc_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
        ...
        <tr class="no-border">
            ...
            <td>&nbsp;</td>
            <td class="nowrap" width="100%"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
        </tr>
        <tr>
            ...
            <td>&nbsp;</td>
            <td class="nowrap" width="100%"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
        </tr>
        <tr>
...
"><?php }
echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['oi']->value['product'],50,"...",true), ENT_QUOTES, 'ISO-8859-1');

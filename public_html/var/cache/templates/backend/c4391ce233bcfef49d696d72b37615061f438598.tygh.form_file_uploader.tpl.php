<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 11:59:59
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/form_file_uploader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14942872275ee2630f85ace2-67284738%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c4391ce233bcfef49d696d72b37615061f438598' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/form_file_uploader.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14942872275ee2630f85ace2-67284738',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2630f88bb19_69637091',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2630f88bb19_69637091')) {function content_5ee2630f88bb19_69637091($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_sizeof')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.sizeof.php';
...
<div class="file-uploader cm-file-uploader"
    data-ca-upload-url="<?php echo htmlspecialchars(fn_url("image.upload"), ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-thumbnail-width="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thumbnail_width']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-thumbnail-height="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thumbnail_height']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-existing-pairs="<?php echo htmlspecialchars(json_encode(array_values((($tmp = @$_smarty_tpl->tpl_vars['existing_pairs']->value)===null||$tmp==='' ? array() : $tmp))), ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-existing-pair-thumbnails="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['existing_files']->value), ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-template-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['template_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-max-files-count="100"
    data-ca-new-files-param-name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['file_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-default-image-pair-type="A"
    data-ca-max-file-size="<?php echo htmlspecialchars(min(array($_smarty_tpl->tpl_vars['upload_max_filesize']->value,$_smarty_tpl->tpl_vars['post_max_size']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"

    data-ca-image-pair-types="<?php echo htmlspecialchars(json_encode(array_filter((($tmp = @$_smarty_tpl->tpl_vars['image_pair_types']->value)===null||$tmp==='' ? array() : $tmp))), ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-allow-sorting="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['allow_update_files']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-destroy-after-initializing="<?php echo htmlspecialchars(!$_smarty_tpl->tpl_vars['allow_update_files']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
    data-ca-allow-thumbnail-upload="true"
    data-ca-image-pair-object-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    ...
                    <div class="btn-group file-uploader__pickers-buttons" id="last_edited_items">
                        <a class="btn file-uploader__pickers-buttons-select" data-ca-fileupload-picker-local>
                            <?php if ($_smarty_tpl->tpl_vars['existing_files']->value) {?>
                                <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['upload_file_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("drop_images_select_short") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>

                            <?php } else { ?>
                                <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['upload_file_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("drop_images_select") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
<div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['template_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" style="display: none;">

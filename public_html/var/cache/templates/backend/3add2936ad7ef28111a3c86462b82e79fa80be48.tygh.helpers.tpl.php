<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:43
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/buttons/helpers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15920720635ee2341fa9ad12-84883385%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3add2936ad7ef28111a3c86462b82e79fa80be48' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/buttons/helpers.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15920720635ee2341fa9ad12-84883385',
  'function' => 
  array (
    'btn' => 
    array (
  ...
  'unifunc' => 'content_5ee2341faf6462_96450785',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2341faf6462_96450785')) {function content_5ee2341faf6462_96450785($_smarty_tpl) {?><?php
\Tygh\Languages\Helper::preloadLangVars(array('delete_selected','delete','tools'));
?>

<?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
?><?php if (!function_exists('smarty_template_function_btn')) {
    ...
    <?php $_smarty_tpl->tpl_vars['method'] = new Smarty_variable(strtoupper($_smarty_tpl->tpl_vars['method']->value), null, 0);?>

    <?php ob_start();?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['method']->value)===null||$tmp==='' ? "GET" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['method']->value)===null||$tmp==='' ? "POST" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp4=ob_get_clean();?><?php if (fn_check_view_permissions($_smarty_tpl->tpl_vars['href']->value,$_tmp3)&&fn_check_view_permissions($_smarty_tpl->tpl_vars['dispatch']->value,$_tmp4)) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['type']->value=="text") {?>
        ...
        <a <?php if ($_smarty_tpl->tpl_vars['target']->value) {?>target="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['target']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['class']->value) {?>class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['data_value']->value) {?>
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_value']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                <?php }?>
            <?php } ?>
        <?php }?>
...
; return false;"<?php }?>
        >
        <?php if ($_smarty_tpl->tpl_vars['icon']->value&&$_smarty_tpl->tpl_vars['icon_first']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></i><?php }?>
            <?php if ($_smarty_tpl->tpl_vars['raw']->value==false) {?>
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['text']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?><?php if (!function_exists('smarty_template_function_dropdown')) {
    ...
    <?php if (trim(smarty_modifier_replace(strip_tags($_smarty_tpl->tpl_vars['content']->value),"&nbsp;",''))!='') {?>
        <div class="btn-group<?php if ($_smarty_tpl->tpl_vars['placement']->value=="left") {?> dropleft<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
            <a class="btn dropdown-toggle" data-toggle="dropdown" <?php if ($_smarty_tpl->tpl_vars['title']->value) {?>title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
                <i class="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['icon']->value)===null||$tmp==='' ? "icon-cog" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"></i>

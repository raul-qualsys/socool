<?php /* Smarty version Smarty-3.1.21, created on 2020-07-01 05:56:45
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/companies/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20029169125efc6bedbb25b9-24051396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f768dc80c80c2518bb76e42c2c98ca9f789b7070' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/companies/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20029169125efc6bedbb25b9-24051396',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5efc6bedcd7dc4_17787532',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5efc6bedcd7dc4_17787532')) {function content_5efc6bedcd7dc4_17787532($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
if (!is_callable('smarty_modifier_puny_decode')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.puny_decode.php';
...
<div class="table-responsive-wrapper">
    ...
    <tr>
        ...
        <th width="6%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=id&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <th width="25%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=company&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")) {?>
            <th width="25%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=email&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            <th width="25%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=storefront&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <?php }?>
        <th width="20%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=date&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
    <tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['company']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" data-ct-company-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
        <td class="left mobile-hide">
            <input type="checkbox" name="company_ids[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" />
        </td>
        <td class="row-status" data-th="<?php echo $_smarty_tpl->__("id");?>
"><a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])), ENT_QUOTES, 'ISO-8859-1');?>
">&nbsp;<span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
</span>&nbsp;</a></td>
        <td class="row-status" data-th="<?php echo $_smarty_tpl->__("name");?>
"><a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
</a></td>
        <?php if (fn_allowed_for("MULTIVENDOR")) {?>
            <td class="row-status" data-th="<?php echo $_smarty_tpl->__("email");?>
"><a href="mailto:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
</a></td>
        <?php }?>
        <?php if (fn_allowed_for("ULTIMATE")) {?>
...
" id="storefront_url_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_href']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>
</a><!--storefront_url_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></td>
        <?php }?>
        <td class="row-status" data-th="<?php echo $_smarty_tpl->__("registered");?>
"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['company']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</td>

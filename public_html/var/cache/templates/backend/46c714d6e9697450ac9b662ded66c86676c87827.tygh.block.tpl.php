<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:02
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/render/block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5119863735ee26312c8f0f0-27380578%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46c714d6e9697450ac9b662ded66c86676c87827' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/render/block.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5119863735ee26312c8f0f0-27380578',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26312cc5912_31479319',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26312cc5912_31479319')) {function content_5ee26312cc5912_31479319($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?><?php
    ...
    <?php if (!$_smarty_tpl->tpl_vars['dynamic_object']->value&&$_smarty_tpl->tpl_vars['block_data']->value['items_count']>0) {?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("confirm_message", null, null); ob_start(); ?>
            <?php if ($_smarty_tpl->tpl_vars['status']->value=="A") {?>
                <?php $_smarty_tpl->tpl_vars['action'] = new Smarty_variable(strtolower($_smarty_tpl->__("disable")), null, 0);?>
            <?php } else { ?>
                <?php $_smarty_tpl->tpl_vars['action'] = new Smarty_variable(strtolower($_smarty_tpl->__("enable")), null, 0);?>
            <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <div class="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['default_class']->value)===null||$tmp==='' ? "device-specific-block block" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
 <?php if ($_smarty_tpl->tpl_vars['status']->value!="A") {?>block-off<?php }?> <?php if ($_smarty_tpl->tpl_vars['parent_grid']->value['content_align']==constant("\Tygh\BlockManager\Grid::ALIGN_RIGHT")) {?>pull-right<?php } elseif ($_smarty_tpl->tpl_vars['parent_grid']->value['content_align']=="\Tygh\BlockManager\Grid::ALIGN_LEFT") {?>pull-left<?php }?> <?php if ($_smarty_tpl->tpl_vars['external_render']->value) {?>bm-external-render<?php }?>"
         ...
         data-block-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
         ...
         id="snapping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['snapping_id'], ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['external_render']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['external_id']->value, ENT_QUOTES, 'ISO-8859-1');
}?>"
    >
        <div class="block-header" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
">
            ...
            <div class="block-header-icon <?php if ($_smarty_tpl->tpl_vars['block_data']->value['type']) {?>bmicon-<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['block_data']->value['type'],"_","-"), ENT_QUOTES, 'ISO-8859-1');
            ...
            <h4 class="block-header-title <?php if ($_smarty_tpl->tpl_vars['show_for_location']->value&&$_smarty_tpl->tpl_vars['block_data']->value['location']!=$_smarty_tpl->tpl_vars['show_for_location']->value) {?>fixed-block<?php }?> <?php if ($_smarty_tpl->tpl_vars['parent_grid']->value['width']==1) {?>hidden<?php }?>">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
...
"<?php if ($_smarty_tpl->tpl_vars['dynamic_object']->value) {?>data-ca-bm-object-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object']->value['object_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>><?php echo Smarty::$_smarty_vars['capture']['confirm_message'];?>
</div>

            <?php } else { ?>
                <input type="hidden" name="block_data[block_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
" id="ajax_update_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['external_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
...
<span class="action-switch"></span></a></li>
        ...
        <?php }?>
<!--snapping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['snapping_id'], ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['external_render']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['external_id']->value, ENT_QUOTES, 'ISO-8859-1');
}?>--></div>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 13:05:25
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5707038845ee27265c7cfb0-24915660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ff05f05bc4eaf91375f25f7c39370c439b195e2' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/group.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5707038845ee27265c7cfb0-24915660',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee27265cad4b4_17473602',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee27265cad4b4_17473602')) {function content_5ee27265cad4b4_17473602($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
<ul class="conditions-tree-group cm-row-item">
    <li class="no-node<?php if ($_smarty_tpl->tpl_vars['root']->value) {?>-root<?php }?>">
        ...
        <div class="pull-right">
            <a class="icon-trash cm-delete-row cm-tooltip conditions-tree-remove" name="remove" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo $_smarty_tpl->__("remove_this_item");?>
"></a>
        </div>
        <?php }?>
        <div id="add_condition_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix_md5']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
    <li id="container_condition_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix_md5']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="cm-row-item<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['conditions']['last']) {?> cm-last-item<?php }?>">
    ...
    <li id="container_add_condition_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix_md5']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
&prefix=' + encodeURIComponent(this.name) + '&condition=' + this.value + '&elm_id=' + this.id, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'ISO-8859-1');?>
result_ids: 'container_' + this.id<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rdelim']->value, ENT_QUOTES, 'ISO-8859-1');?>
)">
            <option value=""> -- </option>

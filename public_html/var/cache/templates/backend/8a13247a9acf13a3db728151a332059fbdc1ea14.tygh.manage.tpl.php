<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:11:18
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/templates/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11242764205ee265b656c450-18845886%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a13247a9acf13a3db728151a332059fbdc1ea14' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/templates/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11242764205ee265b656c450-18845886',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee265b65a7107_66192800',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee265b65a7107_66192800')) {function content_5ee265b65a7107_66192800($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
'
        ...
        _.templates.selected_path = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_path']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
        <?php }?>
        _.templates.rel_path = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rel_path']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
    }(Tygh, Tygh.$));
<?php echo '</script'; ?>
...
">
    ...
    <div class="install-addon">
        <form name="upload_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 13:05:25
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/bonus.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11900993225ee27265dbb0a7-32371642%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ebe51691c0e30057811580ae235153cf8e756203' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/bonus.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11900993225ee27265dbb0a7-32371642',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee27265de12c4_31953297',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee27265de12c4_31953297')) {function content_5ee27265de12c4_31953297($_smarty_tpl) {?><?php if (!is_callable('smarty_function_include_ext')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.include_ext.php';
...
<div class="conditions-tree-node clearfix cm-row-item">
    <div class="pull-right">
        <a class="hand icon-trash cm-delete-row cm-tooltip" name="remove" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
[bonus]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bonus_data']->value['bonus'], ENT_QUOTES, 'ISO-8859-1');?>
" />

    <?php if ($_smarty_tpl->tpl_vars['schema']->value['bonuses'][$_smarty_tpl->tpl_vars['bonus_data']->value['bonus']]['type']=="input") {?>
    <input class="input-text" type="text" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[value]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bonus_data']->value['value'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
[value]" value="Y" /><?php echo $_smarty_tpl->__("yes");?>
    ...
    <input type="checkbox" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value==$_smarty_tpl->tpl_vars['bonus_data']->value['discount_bonus']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['v']->value);?>
        ...
        <input class="input-medium cm-numeric" data-a-dec="." data-a-sep="" data-a-sign="" type="text" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[discount_value]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bonus_data']->value['discount_value'], ENT_QUOTES, 'ISO-8859-1');?>
" />

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-15 09:41:34
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4930976655ee7889eee86d1-90072330%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52bb020b102d500643d8603308262f296f72c214' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4930976655ee7889eee86d1-90072330',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee7889ef2ba34_32541153',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee7889ef2ba34_32541153')) {function content_5ee7889ef2ba34_32541153($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
 ...
 <span><a href="<?php echo htmlspecialchars(fn_url("addons.manage&type=installed"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addons_counter']->value['installed'], ENT_QUOTES, 'ISO-8859-1');?>
</a></span></li>
                <li><?php echo $_smarty_tpl->__("tools_addons_activated_count");?>
 <span><a href="<?php echo htmlspecialchars(fn_url("addons.manage&type=active"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addons_counter']->value['activated'], ENT_QUOTES, 'ISO-8859-1');?>
</a></span></li>
                <li><?php echo $_smarty_tpl->__("tools_addons_other_addons_count");?>
 <span><a href="<?php echo htmlspecialchars(fn_url("addons.manage&source=third_party"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addons_counter']->value['other'], ENT_QUOTES, 'ISO-8859-1');?>
</a></span></li>
            <!--addons_counter--></ul>
        </div>
        <hr>
...
<?php if ((in_array($_smarty_tpl->tpl_vars['search']->value['type'],array('installed','active','disabled')))) {?>
    <?php $_smarty_tpl->tpl_vars['preset_tab'] = new Smarty_variable("tab_installed_addons", null, 0);?>
<?php } elseif (in_array($_smarty_tpl->tpl_vars['search']->value['type'],array('not_installed'))) {?>
    <?php $_smarty_tpl->tpl_vars['preset_tab'] = new Smarty_variable("tab_browse_all_available_addons", null, 0);?>
<?php } else { ?>
    <?php $_smarty_tpl->tpl_vars['preset_tab'] = new Smarty_variable('', null, 0);?>
<?php }?>

<div id="addons_nav_tabs" class="tabs cm-j-tabs clear" data-ca-preset-tab-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset_tab']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <ul class="nav nav-tabs">
        <li id="tab_installed_addons" class="cm-js"><a><?php echo $_smarty_tpl->__("installed_addons");?>
</a></li>

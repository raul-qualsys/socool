<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 18:21:34
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/products_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4805818835ef13cfe9d84f7-85538204%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf2271428b3247164b8305cf0b5f94ff43b98c41' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/products_list.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4805818835ef13cfe9d84f7-85538204',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef13cfea17679_01423121',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef13cfea17679_01423121')) {function content_5ef13cfea17679_01423121($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);
        ...
        <?php }?>
        <th width="80%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=product&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <?php if ($_smarty_tpl->tpl_vars['show_price']->value) {?>
            <th class="right" width="10%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=price&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
    <tr id="picker_product_row_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
" class="cm-item mrg-check" id="checkbox_id_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
" /></td>
        <?php }?>
...
" />
            ...
            <?php if ($_smarty_tpl->tpl_vars['hide_amount']->value) {?>
                <label for="checkbox_id_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
" type="text" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['default_product_amount']->value)===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" name="product_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
" data-ca-target-form="add_products"><i class="icon-share-alt" data-ca-check-filter="#picker_product_row_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
"></i></a>
                </div>
            </td>
        <?php }?>

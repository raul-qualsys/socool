<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:00
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/attach_images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7939518605ee2631096c708-64646283%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c81932af35d2965b5603b1cbbb45dd77a2936fd' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/attach_images.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7939518605ee2631096c708-64646283',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee263109bbd62_65530165',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee263109bbd62_65530165')) {function content_5ee263109bbd62_65530165($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.inline_script.php';
...
_image_data<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][pair_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pair']->value['pair_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-image-field" />
<input type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_image_data<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][type]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['type']->value)===null||$tmp==='' ? "M" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-image-field" />
<input type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_image_data<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][object_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-image-field" />

<div id="box_attach_images_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="attach-images">
    ...
    <?php if (!$_smarty_tpl->tpl_vars['hide_titles']->value) {?>
        <?php if (!'hide_desc') {?>
        <div class="desc">
            <span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['detailed_title']->value)===null||$tmp==='' ? $_smarty_tpl->__("popup_larger_image") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>

            <?php if ($_smarty_tpl->tpl_vars['detailed_text']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['detailed_text']->value, ENT_QUOTES, 'ISO-8859-1');
}?>
            :</span>
        </div>
        <?php }?>
    ...
    <div class="upload-box clearfix <?php if ($_smarty_tpl->tpl_vars['no_thumbnail']->value&&!$_smarty_tpl->tpl_vars['pair']->value['icon']) {?>hidden<?php }?>" id="load_thumbnail_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <?php if ($_smarty_tpl->tpl_vars['delete_pair']->value&&$_smarty_tpl->tpl_vars['pair']->value['pair_id']) {?>
            <div class="float-right">
                <a data-ca-target-id="box_attach_images_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url("image.delete_image_pair?pair_id=".((string)$_smarty_tpl->tpl_vars['pair']->value['pair_id'])."&object_type=".((string)$_smarty_tpl->tpl_vars['object_type']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="icon-remove"></i></a>
        ...
        <?php if (!$_smarty_tpl->tpl_vars['hide_titles']->value) {?>
            <h5>
                <span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['icon_title']->value)===null||$tmp==='' ? $_smarty_tpl->__("thumbnail") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                <?php if ($_smarty_tpl->tpl_vars['icon_text']->value) {?><span class="small-note"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['icon_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span><?php }?>
            </h5>
        <?php }?>
        ...
        <div class="pull-left image-wrap">
            ...
            <?php if (!(fn_allowed_for("MULTIVENDOR")&&$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['object_type']->value=="category")) {?>
                <a data-ca-target-id="image_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pair']->value['image_id'], ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url("image.delete_image?pair_id=".((string)$_smarty_tpl->tpl_vars['pair']->value['pair_id'])."&image_id=".((string)$_smarty_tpl->tpl_vars['pair']->value['image_id'])."&object_type=".((string)$_smarty_tpl->tpl_vars['object_type']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="icon-comment"></i></span>
                    <input type="text" id="alt_icon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_image_data<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][image_alt]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pair']->value['icon']['alt'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                    </div>
                </div>
            <?php }?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['detailed_title']->value) {?>
        <h5><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['detailed_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span></h5>
    <?php }?>
        ...
        <div class="pull-left image-wrap">
            <?php if (!$_smarty_tpl->tpl_vars['hide_images']->value) {?>
                <?php if ($_smarty_tpl->tpl_vars['pair']->value['detailed_id']) {?>
                    <?php if (!(fn_allowed_for("MULTIVENDOR")&&$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['object_type']->value=="category")) {?>
                        <a data-ca-target-id="image_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pair']->value['detailed_id'], ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url("image.delete_image?pair_id=".((string)$_smarty_tpl->tpl_vars['pair']->value['pair_id'])."&image_id=".((string)$_smarty_tpl->tpl_vars['pair']->value['detailed_id'])."&object_type=detailed"), ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['hide_alt']->value) {?>
                <div class="image-alt">
                    <div class="input-prepend">
                        <span class="add-on label-info cm-tooltip cm-hide-with-inputs" title="<?php echo $_smarty_tpl->__("alt_text");?>
"><i class="icon-comment"></i></span>
                        <input type="text" id="alt_det_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_image_data<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][detailed_alt]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pair']->value['detailed']['alt'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                    </div>
                </div>
            <?php }?>
        ...
        <div class="image-upload cm-hide-with-inputs">
            <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('var_name'=>((string)$_smarty_tpl->tpl_vars['name']->value)."_image_detailed".((string)$_smarty_tpl->tpl_vars['suffix']->value)."[".((string)$_smarty_tpl->tpl_vars['key']->value)."]",'is_image'=>true), 0);?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:09:09
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/shipments/components/shipments_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12191359165f63a645b1f6c0-05918884%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '957265286cd389823354fbf48bd025ded2a857af' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/shipments/components/shipments_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12191359165f63a645b1f6c0-05918884',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63a645b413a3_03599025',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63a645b413a3_03599025')) {function content_5f63a645b413a3_03599025($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
:</label>
    <div class="break">
        <input type="text" name="cname" id="elm_cname" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['cname'], ENT_QUOTES, 'ISO-8859-1');?>
" size="30"/>
    </div>
</div>
...
:</label>
    <input type="text" name="order_id" id="elm_order_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
" size="15"/>
</div>
...
?>
        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==$_smarty_tpl->tpl_vars['status']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
        <?php } ?>
    </select>

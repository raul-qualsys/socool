<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 11:59:59
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/products/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9872490825ee2630f4c36b3-97640956%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd60824b26c7d0f02361798bcd8427acfad8ca4f' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/products/update.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9872490825ee2630f4c36b3-97640956',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2630f5f61e7_62711545',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2630f5f61e7_62711545')) {function content_5ee2630f5f61e7_62711545($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
" id="product_categories">
                            ...
                            <?php }?>
                            <label for="product_categories_add_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rnd']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
                        <div class="controls">
                            ...
                            <textarea id="elm_product_full_descr"
                                      ...
                                      data-ca-is-block-manager-enabled="<?php echo htmlspecialchars(intval(fn_check_view_permissions("block_manager.block_selection","GET")), ENT_QUOTES, 'ISO-8859-1');?>
"
                            ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['full_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
...
:</label>
                        <div class="controls">
                            <input type="text" name="product_data[product_code]" id="elm_product_code" size="20" maxlength=<?php echo htmlspecialchars(smarty_modifier_enum("ProductFieldsLength::PRODUCT_CODE"), ENT_QUOTES, 'ISO-8859-1');?>
  value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['product_code'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
                            </div>
                        </div>
...
:</label>
                        <div class="controls">
                            <input type="text" name="product_data[list_price]" id="elm_list_price" size="10" value="<?php echo htmlspecialchars(fn_format_price((($tmp = @$_smarty_tpl->tpl_vars['product_data']->value['list_price'])===null||$tmp==='' ? "0.00" : $tmp),$_smarty_tpl->tpl_vars['primary_currency']->value,null,false), ENT_QUOTES, 'ISO-8859-1');?>
" class="input-long" />
                            </div>
                        </div>
...
?>
                                <label class="checkbox inline" for="elm_taxes_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['tax_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                                    <input type="checkbox" name="product_data[tax_ids][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['tax_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" id="elm_taxes_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['tax_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (smarty_modifier_in_array($_smarty_tpl->tpl_vars['tax']->value['tax_id'],$_smarty_tpl->tpl_vars['product_data']->value['tax_ids'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['tax_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
:</label>
                        <div class="controls">
                            <textarea id="elm_product_short_descr"
                                      ...
                                      rows="2"
                                      class="cm-wysiwyg input-large"
                            ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['short_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
...
:</label>
                        <div class="controls">
                            <input type="text" <?php if ($_smarty_tpl->tpl_vars['disable_edit_popularity']->value) {?>disabled="disabled"<?php }?> name="product_data[popularity]" id="elm_product_popularity" size="55" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['product_data']->value['popularity'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" class="input-long" />
                        </div>
                    </div>

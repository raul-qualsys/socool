<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:00
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/object_group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8043989295ee26310a2bbd7-53732584%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28a7712a9583b576cd56e400e30e0d8723f814ef' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/object_group.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8043989295ee26310a2bbd7-53732584',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26310a6efb3_82913487',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26310a6efb3_82913487')) {function content_5ee26310a6efb3_82913487($_smarty_tpl) {?><?php
...
<div class="table-wrapper">
    <table width="100%" class="table table-middle table-objects<?php if ($_smarty_tpl->tpl_vars['table_striped']->value) {?> table-striped<?php }?>">
        <tbody>
    <?php }?>
            <tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['status']->value), ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['additional_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-row-item" 
                <?php if ($_smarty_tpl->tpl_vars['row_id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['row_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>
                data-ct-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['table']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"
            >
                ...
                <td>
                    <input type="checkbox" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checkbox_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['checkbox_value']->value)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['id']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['checked']->value) {?> checked="checked"<?php }?> class="cm-item<?php if ($_smarty_tpl->tpl_vars['hidden_checkbox']->value) {?> hidden<?php }?>" />
                </td>
                <?php }?>
                ...
                <td width="<?php if ($_smarty_tpl->tpl_vars['href_desc']->value) {?>77<?php } else { ?>28<?php }?>%" <?php if ($_smarty_tpl->tpl_vars['href_desc_row_hint']->value) {?>data-th="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_desc_row_hint']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
                    <div class="object-group-link-wrap">
                    <?php if (!$_smarty_tpl->tpl_vars['non_editable']->value) {?>
                        <a <?php if ($_smarty_tpl->tpl_vars['no_popup']->value) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['href']->value), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> class="row-status <?php if (!$_smarty_tpl->tpl_vars['main_link']->value) {?>cm-external-click<?php }
if ($_smarty_tpl->tpl_vars['non_editable']->value) {?> no-underline<?php }
if ($_smarty_tpl->tpl_vars['main_link']->value) {?> link<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_meta']->value, ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-promo-popup<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['non_editable']->value&&!$_smarty_tpl->tpl_vars['not_clickable']->value) {?> data-ca-external-click-id="opener_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }
if ($_smarty_tpl->tpl_vars['main_link']->value) {?> <?php if (!$_smarty_tpl->tpl_vars['is_promo']->value) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['main_link']->value), ENT_QUOTES, 'ISO-8859-1');
}?>"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                    <?php } else { ?>
                        <span class="unedited-element block <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['text']->value)===null||$tmp==='' ? $_smarty_tpl->__("view") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['show_id']->value) {?>
                        <span class="muted"><small> #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
</small></span>
                    <?php }?>
                        ...
                        <?php }?>
                            ...
                            <?php if (!$_smarty_tpl->tpl_vars['non_editable']->value) {?>
                                <?php if ($_smarty_tpl->tpl_vars['href_delete']->value&&!$_smarty_tpl->tpl_vars['skip_delete']->value) {?>
                                    ...
                                    <?php }?>
                                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'text'=>$_smarty_tpl->__("delete"),'href'=>$_smarty_tpl->tpl_vars['href']->value,'class'=>"cm-confirm cm-tooltip cm-ajax cm-ajax-force cm-ajax-full-render ".((string)$_smarty_tpl->tpl_vars['class']->value),'data'=>array("data-ca-target-id"=>$_smarty_tpl->tpl_vars['delete_target_id']->value,"data-ca-params"=>$_smarty_tpl->tpl_vars['delete_data']->value),'method'=>"POST"));?>
</li>
                                <?php }?>
                            <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php if (!$_smarty_tpl->tpl_vars['nostatus']->value) {?>
                    <td width="12%" <?php if ($_smarty_tpl->tpl_vars['status_row_hint']->value) {?>data-th="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_row_hint']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
                ...
                <?php }?>
            <!--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['row_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></tr>
    <?php if (!$_smarty_tpl->tpl_vars['no_table']->value) {?>
        </tbody>
    </table>

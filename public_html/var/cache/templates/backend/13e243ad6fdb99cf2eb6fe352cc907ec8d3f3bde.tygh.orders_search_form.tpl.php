<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:22:04
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/orders/components/orders_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13058156125ee2bc9cba5d05-32666267%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '13e243ad6fdb99cf2eb6fe352cc907ec8d3f3bde' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/orders/components/orders_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13058156125ee2bc9cba5d05-32666267',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bc9cbe8744_50010012',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bc9cbe8744_50010012')) {function content_5ee2bc9cbe8744_50010012($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
<div class="sidebar-field">
    ...
    <input class="cm-phone" type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
" size="50"/>
</div>
...
&nbsp;(<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['symbol'];?>
    ...
    <input type="text" class="input-small" name="total_from" id="total_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['total_from'], ENT_QUOTES, 'ISO-8859-1');?>
" size="3" /> - <input type="text" class="input-small" name="total_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['total_to'], ENT_QUOTES, 'ISO-8859-1');?>
" size="3" />
</div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="nowrap">
                <div class="row-fluid ">
                    <div class="span4">
                        <input type="text" name="issuer" id="issuer" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['issuer'], ENT_QUOTES, 'ISO-8859-1');?>
" size="30" />
                    </div>
...
" size="10"/>
    ...
    <div class="group span6 form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="credit_memo_id" id="crmemo_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['credit_memo_id'], ENT_QUOTES, 'ISO-8859-1');?>
" size="10"/>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="invoice_id" id="inv_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['invoice_id'], ENT_QUOTES, 'ISO-8859-1');?>
" size="10"/>
            </div>
        </div>

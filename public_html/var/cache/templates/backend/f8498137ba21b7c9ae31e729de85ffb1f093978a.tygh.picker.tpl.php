<?php /* Smarty version Smarty-3.1.21, created on 2020-06-23 10:08:32
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/banners/pickers/banners/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16738354905ef21af04b5451-01482238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8498137ba21b7c9ae31e729de85ffb1f093978a' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/banners/pickers/banners/picker.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16738354905ef21af04b5451-01482238',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef21af0532d38_02309928',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef21af0532d38_02309928')) {function content_5ef21af0532d38_02309928($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
" title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_banners") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
    </div>
...
<?php if ($_smarty_tpl->tpl_vars['view_mode']->value!="button") {?>
    ...
    <input id="b<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
_no_item"<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?> class="hidden"<?php }?>>
        <tr class="no-items">
            <td colspan="<?php if ($_smarty_tpl->tpl_vars['positions']->value) {?>3<?php } else { ?>2<?php }?>"><p><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['no_item_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("no_items") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</p></td>
        </tr>
        </tbody>
        </table>

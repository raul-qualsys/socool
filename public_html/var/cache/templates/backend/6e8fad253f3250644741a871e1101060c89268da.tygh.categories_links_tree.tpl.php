<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:12:23
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/categories/components/categories_links_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2218240005ee265f788e006-58732143%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e8fad253f3250644741a871e1101060c89268da' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/categories/components/categories_links_tree.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2218240005ee265f788e006-58732143',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee265f78aedd7_85744682',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee265f78aedd7_85744682')) {function content_5ee265f78aedd7_85744682($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
"<?php if (!$_smarty_tpl->tpl_vars['category']->value['subcategories']) {?> style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
: 14px;"<?php }?> ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
            <?php }?>
        <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <li <?php if ($_smarty_tpl->tpl_vars['category']->value['active']) {?>class="active"<?php }?> style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>

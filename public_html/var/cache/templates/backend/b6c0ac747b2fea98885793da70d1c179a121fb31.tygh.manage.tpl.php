<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:28:57
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/call_requests/views/call_requests/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4084910545f63aae9555f11-23166598%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6c0ac747b2fea98885793da70d1c179a121fb31' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/call_requests/views/call_requests/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4084910545f63aae9555f11-23166598',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63aae95bb1d9_05419366',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63aae95bb1d9_05419366')) {function content_5f63aae95bb1d9_05419366($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('id','date','call_requests.person_name_and_phone','order','status','call_requests.responsible','status','call_requests.no_name_specified','delete','call_requests.requested_product','products_in_cart','call_requests.notes','call_requests.convenient_time','product','quantity','price','no_data','call_requests'));
?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
            ...
            <th width="30%">
                <a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=date&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
            ...
            <th width="25%">
                <a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=order&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_icon']->value;
                ...
                /
                <a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=order_status&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_icon']->value;
            ...
            <th width="10%">
                <a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=user&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
        <tbody class="cm-row-item">
            <tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['request']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
">
                <td class="left">
                    <input type="checkbox" name="request_ids[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item cm-item-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['request']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" />
                </td>
                <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                ...
                <td>
                    <?php if ($_smarty_tpl->tpl_vars['request']->value['name']) {?>
                        <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</strong><br>
                    <?php } else { ?>
                        <div>
                    ...
                    <?php }?>
                    <span><bdi><a href="tel:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
</a></bdi></span>
                </td>
                <td class="nowrap">
                    <div class="cr-table-status">
                        <input type="text" name="call_requests[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
][order_id]" size="3" value="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');
}?>" class="input-micro input-hidden right" />
                        <?php if ($_smarty_tpl->tpl_vars['request']->value['order_id']) {?>
                            / <a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['request']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_statuses']->value[$_smarty_tpl->tpl_vars['request']->value['order_status']]['description'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        <?php }?>
                    </div>
                </td>
                <td>
                    <select name="call_requests[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['user_id']->value==$_smarty_tpl->tpl_vars['request']->value['user_id']) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php } ?>
                    </select>
                </td>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <td class="right nowrap">
                    <div id="call_requests_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                        <?php echo $_smarty_tpl->getSubTemplate ("common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('popup_additional_class'=>"dropleft",'id'=>$_smarty_tpl->tpl_vars['request']->value['request_id'],'status'=>$_smarty_tpl->tpl_vars['request']->value['status'],'update_controller'=>"call_requests",'items_status'=>$_smarty_tpl->tpl_vars['call_request_statuses']->value,'btn_meta'=>strtolower("btn btn-info btn-small cr-btn-status-".((string)$_smarty_tpl->tpl_vars['request']->value['status'])),'extra'=>"&return_url=".((string)$_smarty_tpl->tpl_vars['return_url']->value),'st_result_ids'=>"call_requests_status_".((string)$_smarty_tpl->tpl_vars['request']->value['request_id'])), 0);?>

                    <!--call_requests_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
                </td>
            </tr>
...
:</span><br>
                            <a href="<?php echo htmlspecialchars(fn_url("products.update?product_id=".((string)$_smarty_tpl->tpl_vars['request']->value['product_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['product'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        </div>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['request']->value['cart_products']) {?>
                        <div>
                            <a class="cm-combination cr-switch" id="sw_call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                                <?php echo $_smarty_tpl->__("products_in_cart");?>

                            </a>
                            <i class="icon-caret-down cm-combination" id="on_call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
"></i>
                            <i class="icon-caret-up cm-combination hidden" id="off_call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
"></i>
                        </div>
                    <?php }?>
                </td>
                ...
                <td colspan="3" valign="top">
                    <textarea name="call_requests[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
][notes]" class="input-hidden" cols="20" rows="3" placeholder="<?php echo $_smarty_tpl->__("call_requests.notes");?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['notes'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                    <div class="cr-time">
                        <span><?php echo $_smarty_tpl->__("call_requests.convenient_time");?>
:</span>
                        <span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['request']->value['time_from'])===null||$tmp==='' ? "09:00" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span> - <span><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['request']->value['time_to'])===null||$tmp==='' ? "20:00" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                    </div>
                </td>
            ...
            <?php if ($_smarty_tpl->tpl_vars['request']->value['cart_products']) {?>
                <tr id="call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden">
                    <td>&nbsp;</td>
                    <td colspan="6">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                    </td>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-15 09:42:09
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3446423795ee788c1b3d511-27842208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4372bb88200c8a29777f3cbf02c2a5ef0bd0cfe' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/update.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3446423795ee788c1b3d511-27842208',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee788c1b73b34_39012658',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee788c1b73b34_39012658')) {function content_5ee788c1b73b34_39012658($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
<div id="content_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <div id="content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <div class="tabs cm-j-tabs <?php if ($_smarty_tpl->tpl_vars['separate']->value) {?>cm-track<?php }?> <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['subsections']->value)==1) {?>hidden<?php }?>">
...
?>
                ...
                <li class="cm-js <?php if ($_REQUEST['selected_section']==$_smarty_tpl->tpl_vars['tab_id']->value) {?>active<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><a><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subs']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
            <?php } ?>
        </ul>
    </div>
    <div class="cm-tabs-content" id="tabs_content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <form action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post" name="update_addon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" />
        <input type="hidden" name="addon" value="<?php echo htmlspecialchars($_REQUEST['addon'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
?>
        ...
        <div id="content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <!--content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
<!--content_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_addon']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
<?php if ($_smarty_tpl->tpl_vars['separate']->value) {?>
    <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {

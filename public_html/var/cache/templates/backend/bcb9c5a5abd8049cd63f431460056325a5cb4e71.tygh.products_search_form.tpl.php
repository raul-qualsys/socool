<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:42:47
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6542827165ee234d7d4a640-80001782%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcb9c5a5abd8049cd63f431460056325a5cb4e71' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/products_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6542827165ee234d7d4a640-80001782',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234d7ddcd58_65437681',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234d7ddcd58_65437681')) {function content_5ee234d7ddcd58_65437681($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.array_to_fields.php';
...
search_form" method="get" class="cm-disable-empty <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="search_form">
...
<?php $_smarty_tpl->_capture_stack[0][] = array("simple_search", null, null); ob_start(); ?>
    ...
    <div class="sidebar-field">
        ...
        <input type="text" name="q" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['q'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
...
&nbsp;(<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['symbol'];?>
        ...
        <input type="text" name="price_from" size="1" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['price_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-small" /> - <input type="text" size="1" name="price_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['price_to'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                ...
                <optgroup label="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_cat']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
">
                    <?php $_smarty_tpl->tpl_vars["close_optgroup"] = new Smarty_variable(true, null, 0);?>
                    <?php } else { ?>
                    <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_cat']->value['category_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['search_cat']->value['disabled']) {?>disabled="disabled"<?php }?> <?php if ($_smarty_tpl->tpl_vars['search']->value['cid']==$_smarty_tpl->tpl_vars['search_cat']->value['category_id']) {?>selected="selected"<?php }?> title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_cat']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['search_cat']->value['level']),smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['search_cat']->value['category'], ENT_QUOTES, 'ISO-8859-1', true),$_smarty_tpl->tpl_vars['trunc']->value,"...",true));?>
</option>
                    <?php }?>
                    <?php } ?>
...
<div class="group span6">
    <div class="form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="pcode" id="pcode" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['pcode'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();"/>
            </div>
        </div>
        <div class="control-group">
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("ttc_popularity")), 0);?>
            ...
            <div class="controls">
                <input type="text" name="popularity_from" id="popularity_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['popularity_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" /> - <input type="text" name="popularity_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['popularity_to'], ENT_QUOTES, 'ISO-8859-1');?>
...
&nbsp;(<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['symbol'];?>
        ...
        <div class="controls">
            <input type="text" name="shipping_freight_from" id="shipping_freight_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['shipping_freight_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" /> - <input type="text" name="shipping_freight_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['shipping_freight_to'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" />
        </div>
    </div>
...
&nbsp;(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'], ENT_QUOTES, 'ISO-8859-1');?>
)</label>
        <div class="controls">
            <input type="text" name="weight_from" id="weight_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['weight_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" /> - <input type="text" name="weight_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['weight_to'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" />
        </div>
    </div>
...
:</label>
        <div class="controls">
            <input type="text" name="amount_from" id="amount_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['amount_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" /> - <input type="text" name="amount_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['amount_to'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="input-mini" />
        </div>
    </div>
    <?php }?>
    ...
    <?php if (fn_string_not_empty($_smarty_tpl->tpl_vars['picker_selected_company']->value)) {?>
        <input type="hidden" name="company_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['picker_selected_company']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
    <?php } else { ?>
...
<div class="row-fluid">
    <div class="group span6 form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="updated_in_hours" id="updated_in_hours" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['updated_in_hours'], ENT_QUOTES, 'ISO-8859-1');?>

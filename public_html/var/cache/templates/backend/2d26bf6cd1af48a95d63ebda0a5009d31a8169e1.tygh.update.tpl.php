<?php /* Smarty version Smarty-3.1.21, created on 2020-08-03 13:59:31
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17577097555f285e931e5fc2-80382252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d26bf6cd1af48a95d63ebda0a5009d31a8169e1' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/update.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17577097555f285e931e5fc2-80382252',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f285e93242ce6_43238303',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f285e93242ce6_43238303')) {function content_5f285e93242ce6_43238303($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('products_required','customer_notes','staff_only_notes','notify_customer','notify_orders_department','notify_vendor','create','create_process_payment','create_new_order','save','save_process_payment','editing_order','cancel','add_new_order','editing_order','total','invoice','credit_memo','by'));
?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ORDER_MANAGEMENT']->value, ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div class="span8">
        ...
        <div class="note clearfix">
            <div class="span6">
                ...
                <textarea class="span12" name="customer_notes" id="customer_notes" cols="40" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['notes'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            </div>
            <div class="span6">
                <label for="order_details"><?php echo $_smarty_tpl->__("staff_only_notes");?>
</label>
                <textarea class="span12" name="update_order[details]" id="order_details" cols="40" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['details'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            </div>
        </div>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("mainbox_title", null, null); ob_start(); ?>
 ...
 #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
</span><?php if ($_smarty_tpl->tpl_vars['cart']->value['company_id']) {?>, <?php echo htmlspecialchars(fn_get_company_name($_smarty_tpl->tpl_vars['cart']->value['company_id']), ENT_QUOTES, 'ISO-8859-1');
}?></span>

        <span class="f-small">
        /<?php if ($_smarty_tpl->tpl_vars['cart']->value['company_id']) {
echo htmlspecialchars(fn_get_company_name($_smarty_tpl->tpl_vars['cart']->value['company_id']), ENT_QUOTES, 'ISO-8859-1');?>
)<?php }?>
 ...
 #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']], ENT_QUOTES, 'ISO-8859-1');?>
)
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['user_data']['firstname'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['user_data']['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php if ($_smarty_tpl->tpl_vars['cart']->value['user_data']['user_id']) {
}?>
        / <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['cart']->value['order_timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format'])), ENT_QUOTES, 'ISO-8859-1');?>
, <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['cart']->value['order_timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>

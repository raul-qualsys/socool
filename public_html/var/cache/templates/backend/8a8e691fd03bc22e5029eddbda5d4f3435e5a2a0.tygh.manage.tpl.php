<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:02
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15399203185ee26312be9a75-80871650%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a8e691fd03bc22e5029eddbda5d4f3435e5a2a0' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15399203185ee26312be9a75-80871650',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26312c4e839_52501127',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26312c4e839_52501127')) {function content_5ee26312c4e839_52501127($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_render_location')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.render_location.php';
...
<?php echo '<script'; ?>
 type="text/javascript" class="cm-ajax-force">
    var selected_location = '<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['location']->value['location_id'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
';

    var dynamic_object_id = '<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['dynamic_object']->value['object_id'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
';
    var dynamic_object_type = '<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("tabsbox", null, null); ob_start(); ?>
    ...
    <div class="block-manager-location" id="content_location_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['location_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
    ...
    <!--content_location_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['location_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
...
$_tmp1=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"dialog",'class'=>"cm-ajax-force hand icon-cog",'href'=>"block_manager.update_location?location=".((string)$_smarty_tpl->tpl_vars['location']->value['location_id'])."&s_layout=".((string)$_smarty_tpl->tpl_vars['location']->value['layout_id']),'id'=>"tab_location_".((string)$_smarty_tpl->tpl_vars['location']->value['location_id']),'title'=>$_tmp1.": ".((string)$_smarty_tpl->tpl_vars['tab']->value['title'])));?>
                    ...
                    <?php }?>
                    <a <?php if ($_smarty_tpl->tpl_vars['tab']->value['href']) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['tab']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                    <li class="with-menu <?php if ($_smarty_tpl->tpl_vars['layout']->value['layout_id']==$_smarty_tpl->tpl_vars['runtime']->value['layout']['layout_id']) {?> active<?php }?>">
                        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                            <li><?php ob_start();
echo htmlspecialchars(fn_url("?s_layout=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),"C"), ENT_QUOTES, 'ISO-8859-1');
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                        ...
                        <a href="<?php echo htmlspecialchars(fn_url("block_manager.manage?s_layout=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <div class="clearfix">
                <fieldset>
                    <textarea class="copy-field" id="widget_code_box" readonly="readonly" cols="30" rows="10"><?php echo htmlspecialchars(smarty_modifier_replace(Smarty::$_smarty_vars['capture']['widget_code']," data-no-defer",''), ENT_QUOTES, 'ISO-8859-1');?>
</textarea>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:00
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/product_subscribers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12000237375ee26310a78606-96064840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad29f1980979f0aefc59656b29a7b237f54096aa' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/products/components/product_subscribers.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12000237375ee26310a78606-96064840',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26310a9fb44_46183171',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26310a9fb44_46183171')) {function content_5ee26310a9fb44_46183171($_smarty_tpl) {?><?php
    ...
    <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']||$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['product_data']->value['company_id']==$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>        
        <div class="pull-right">
            <?php $_smarty_tpl->_capture_stack[0][] = array("new_email_picker", null, null); ob_start(); ?>
                <form action="<?php echo htmlspecialchars(fn_url("products.update?product_id=".((string)$_smarty_tpl->tpl_vars['product_id']->value)."&selected_section=subscribers"), ENT_QUOTES, 'ISO-8859-1');?>
...
" />
                <a href="mailto:<?php echo htmlspecialchars(rawurlencode($_smarty_tpl->tpl_vars['s']->value['email']), ENT_QUOTES, 'ISO-8859-1');?>

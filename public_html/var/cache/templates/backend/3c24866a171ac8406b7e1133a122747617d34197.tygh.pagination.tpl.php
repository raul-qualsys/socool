<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:42:37
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19564639175ee234cdc85a77-33561618%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c24866a171ac8406b7e1133a122747617d34197' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/pagination.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19564639175ee234cdc85a77-33561618',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234cdcc5fc1_24098409',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234cdcc5fc1_24098409')) {function content_5ee234cdcc5fc1_24098409($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
...
<?php if (Smarty::$_smarty_vars['capture']['pagination_open']!="Y") {?>
<div class="cm-pagination-container<?php if ($_smarty_tpl->tpl_vars['pagination_class']->value) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination_class']->value, ENT_QUOTES, 'ISO-8859-1');
...
<?php if ($_smarty_tpl->tpl_vars['pagination']->value) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['save_current_page']->value) {?>
        <input type="hidden" name="page" value="<?php echo htmlspecialchars((($tmp = @(($tmp = @$_smarty_tpl->tpl_vars['search']->value['page'])===null||$tmp==='' ? $_REQUEST['page'] : $tmp))===null||$tmp==='' ? 1 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
    <?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 mobile-hide">
                        <a
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 pagination-item"
                            <?php if ($_smarty_tpl->tpl_vars['pagination']->value['prev_page']) {?>
                                href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&page=1"), ENT_QUOTES, 'ISO-8859-1');?>
"
                                data-ca-page="1"
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 pagination-item"
                            <?php if ($_smarty_tpl->tpl_vars['pagination']->value['prev_page']) {?>
                                href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&page=".((string)$_smarty_tpl->tpl_vars['pagination']->value['prev_page'])), ENT_QUOTES, 'ISO-8859-1');?>
"
...
?>
                            <li>
                                <a
                                    data-ca-scroll=".cm-pagination-container"
                                    class="cm-ajax<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 pagination-dropdown-per-page"
                                    href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&items_per_page=".((string)$_smarty_tpl->tpl_vars['step']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"
                                    data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 pagination-item"
                            <?php if ($_smarty_tpl->tpl_vars['pagination']->value['next_page']) {?>
                                href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&page=".((string)$_smarty_tpl->tpl_vars['pagination']->value['next_page'])), ENT_QUOTES, 'ISO-8859-1');?>
"
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 pagination-item"
                            <?php if ($_smarty_tpl->tpl_vars['pagination']->value['next_page']) {?>
                                href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&page=".((string)$_smarty_tpl->tpl_vars['pagination']->value['total_pages'])), ENT_QUOTES, 'ISO-8859-1');?>
"
                                data-ca-page="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['total_pages'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                            <?php }?>>

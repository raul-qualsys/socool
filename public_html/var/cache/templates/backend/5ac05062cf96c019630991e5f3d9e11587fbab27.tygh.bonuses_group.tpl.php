<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 13:05:25
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/bonuses_group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16592149245ee27265da87d7-34093262%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ac05062cf96c019630991e5f3d9e11587fbab27' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/components/bonuses_group.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16592149245ee27265da87d7-34093262',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee27265db7bf6_39281824',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee27265db7bf6_39281824')) {function content_5ee27265db7bf6_39281824($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
?>
    <li id="container_bonus_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-row-item<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['bonuses']['last']) {?> cm-last-item<?php }?>">
    ...
    <li id="container_add_bonus" class="clear hidden cm-row-item">
        <div class="conditions-tree-node">
            <select onchange="Tygh.$.ceAjax('request', fn_url('promotions.dynamic?prefix=' + encodeURIComponent(this.name) + '&bonus=' + this.value + '&elm_id=' + this.id), <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'ISO-8859-1');?>

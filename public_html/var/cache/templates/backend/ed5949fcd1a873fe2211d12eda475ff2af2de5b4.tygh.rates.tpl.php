<?php /* Smarty version Smarty-3.1.21, created on 2020-07-29 15:02:48
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/shippings/components/rates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13295644365f21d5e82f3ee3-30086626%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed5949fcd1a873fe2211d12eda475ff2af2de5b4' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/shippings/components/rates.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13295644365f21d5e82f3ee3-30086626',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f21d5e83925a4_66937537',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f21d5e83925a4_66937537')) {function content_5f21d5e83925a4_66937537($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
?>
<input type="hidden" name="shipping_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
...
?>
            <li class="cm-js <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rates']['first']) {?> active<?php }?>">
                <a href="#destination_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rate']->value['destination_id'], ENT_QUOTES, 'ISO-8859-1');?>
" data-toggle="tab"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rate']->value['destination'], ENT_QUOTES, 'ISO-8859-1');
...
?>
        ...
        <div class="tab-pane<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rates']['first']) {?> active<?php }?>" id="destination_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['shipping']->value['allow_multiple_locations']) {?>
                <div class="control-group">
                    <label class="control-label" for="elm_delivery_time_dest_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("delivery_time");?>
:</label>
                    <div class="controls">
                        <input type="text" class="input-medium" name="shipping_data[rates][delivery_time][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="elm_delivery_time_dest_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" size="30" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rate_data']->value['delivery_time'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                    </div>
                </div>
            <?php }?>
...
?>
                        <tr>
                            <td>
                                <input type="checkbox" name="delete_rate_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][C][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-cost-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-item" /></td>
                            <td class="nowrap">
                                <?php echo $_smarty_tpl->__("more_than");?>
&nbsp;
                                <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>
                                    <input type="hidden" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
                            ...
                            <td>
                                <input type="text" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
}?>][value]" size="5" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['rate']->value['value'])===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small input-hidden" /></td>
                            <td>
                                <select class="input-medium" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][C][<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>0<?php } else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');
}?>][type]">
...
?>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>
                        <tr id="box_add_rate_celm_cost_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                            <td>
...
&nbsp;<?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>'','view'=>"input",'input_name'=>"shipping_data[add_rates][".((string)$_smarty_tpl->tpl_vars['destination_id']->value)."][rate_value][C][0][amount]",'class'=>"input-small input-hidden"), 0);?>
                            ...
                            <td>
                                <input type="text" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][C][0][value]" size="5" value="" class="input-small input-hidden" /></td>
                            <td>
                                <select class="input-medium" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][C][0][type]">
...
?>
                        <tr>
                            <td>
                                <input type="checkbox" name="delete_rate_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][W][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-weight-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-item" /></td>
                            <td class="nowrap">
                                <?php echo $_smarty_tpl->__("more_than");?>
&nbsp;
                                <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>
                                    <input type="hidden" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][W][0][amount]" value="0" />&nbsp;&nbsp;0 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'], ENT_QUOTES, 'ISO-8859-1');?>

                                <?php } else { ?>
                                    <input type="text" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][W][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
][amount]" data-p-sign="s" data-v-min="0.000" data-a-sign=" <?php echo $_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'];?>
" size="5" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');
                                ...
                                <input type="checkbox" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][W][<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>0<?php } else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');
}?>][per_unit]" value="Y" <?php if ($_smarty_tpl->tpl_vars['rate']->value['per_unit']=="Y") {?>checked="checked"<?php }?> class="" />
                            </td>
...
?>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>
                        <tr id="box_add_rate_celm_weight_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                            <td>
...
" size="5" value="" class="cm-numeric input-small input-hidden" /></td>
 ...
 (%)</option>
                            ...
                            <td>
                                <input type="hidden" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][W][0][per_unit]" value="N" />
                                <input type="checkbox" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][W][0][per_unit]" value="Y" class="" />
                            </td>
                            <td>
...
?>
                        <tr>
                            <td>
                                <input type="checkbox" name="delete_rate_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][I][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-items-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-item" /></td>
                            <td class="nowrap">
                                <?php echo $_smarty_tpl->__("more_than");?>
&nbsp;
                                ...
                                <?php } else { ?>
                                    <input type="text" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][I][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');
}?>][per_unit]" value="Y" class="" <?php if ($_smarty_tpl->tpl_vars['rate']->value['per_unit']=="Y") {?>checked="checked"<?php }?> />
                            </td>
...
?>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>
                        <tr id="box_add_rate_celm_items_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                            <td>
...
" size="5" value="" class="cm-numeric input-small input-hidden" /></td>
 ...
 (%)</option>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
][rate_value][I][0][per_unit]" value="Y" class="" />
                            </td>
                            <td>

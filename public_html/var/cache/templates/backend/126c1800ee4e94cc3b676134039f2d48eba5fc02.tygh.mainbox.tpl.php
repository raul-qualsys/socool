<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:50
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9449324055ee23426452e08-18659024%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '126c1800ee4e94cc3b676134039f2d48eba5fc02' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/mainbox.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9449324055ee23426452e08-18659024',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234264b1bc7_58912861',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234264b1bc7_58912861')) {function content_5ee234264b1bc7_58912861($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.inline_script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_block_notes')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.notes.php';
if (!is_callable('smarty_modifier_sanitize_html')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.sanitize_html.php';
...
<a name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['anchor']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></a>
<?php }?>
...
if ($_smarty_tpl->tpl_vars['navigation']->value['dynamic']['active_section']==$_smarty_tpl->tpl_vars['s_id']->value) {?> active<?php }?>"><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['m']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
                        <?php }?>
...
<div class="actions cm-sticky-scroll"
     ...
     data-ca-top="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_top_on_actions_panel']->value, ENT_QUOTES, 'ISO-8859-1');?>
" 
     data-ca-padding="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_padding_on_actions_panel']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
     id="actions_panel">
    ...
    <div class="title pull-left">
        <?php if (isset($_smarty_tpl->tpl_vars['title_start']->value)&&isset($_smarty_tpl->tpl_vars['title_end']->value)) {?>
            <h2 class="title__heading"
                title="<?php echo htmlspecialchars(html_entity_decode(preg_replace('!\s+!', ' ',preg_replace('!<[^>]*?>!', ' ', (($tmp = @$_smarty_tpl->tpl_vars['title_alt']->value)===null||$tmp==='' ? ((string)$_smarty_tpl->tpl_vars['title_start']->value)." ".((string)$_smarty_tpl->tpl_vars['title_end']->value) : $tmp)))), ENT_QUOTES, 'ISO-8859-1');?>
"
            >
                <span class="title__part-start mobile-hidden"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title_start']->value, ENT_QUOTES, 'ISO-8859-1');?>
: </span>
                <span class="title__part-end"><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['title_end']->value), ENT_QUOTES, 'ISO-8859-1');?>
</span>
            </h2>
        <?php } else { ?>
            <h2 class="title__heading" title="<?php echo htmlspecialchars(html_entity_decode(preg_replace('!\s+!', ' ',preg_replace('!<[^>]*?>!', ' ', (($tmp = @$_smarty_tpl->tpl_vars['title_alt']->value)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['title']->value : $tmp)))), ENT_QUOTES, 'ISO-8859-1');?>
...
" id="search_button_mobile" form="global_search"><i class="icon-search"></i></button>
                <label for="gs_text_mobile" class="search-mobile-label"><input type="text" class="cm-autocomplete-off search-mobile-input" id="gs_text_mobile" name="q" value="<?php echo htmlspecialchars($_REQUEST['q'], ENT_QUOTES, 'ISO-8859-1');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['main_buttons_meta']->value, ENT_QUOTES, 'ISO-8859-1');
} else { ?>btn-bar btn-toolbar<?php }?> dropleft pull-right" <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?>id="tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_buttons"<?php }?>>
...
?>
                        <li><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['m']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['meta'], ENT_QUOTES, 'ISO-8859-1');?>
" target="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['target'], ENT_QUOTES, 'ISO-8859-1');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <div class="adv-buttons" <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?>id="tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_adv_buttons"<?php }?>>
            <?php echo $_smarty_tpl->tpl_vars['adv_buttons']->value;?>

            <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?><!--tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="admin-content-wrapper <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['mainbox_content_wrapper_class']->value)===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
...
<div class="sidebar sidebar-left cm-sidebar" id="elm_sidebar">
    <div class="sidebar-toggle"><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sidebar_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
 sidebar-icon"></i></div>
...
if (trim($_smarty_tpl->tpl_vars['sidebar_content']->value)=='') {?> no-sidebar<?php }?> <?php if (fn_allowed_for("ULTIMATE")) {?>ufa<?php }?>" <?php if ($_smarty_tpl->tpl_vars['box_id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['box_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
...
echo $_smarty_tpl->tpl_vars['tools']->value;
    ...
    <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?><div id="content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php }?>
        <?php echo (($tmp = @$_smarty_tpl->tpl_vars['content']->value)===null||$tmp==='' ? "&nbsp;" : $tmp);?>

    <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?><!--content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div><?php }?>

    <?php if ($_smarty_tpl->tpl_vars['box_id']->value) {?><!--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['box_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--><?php }?></div>
</div>

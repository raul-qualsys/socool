<?php /* Smarty version Smarty-3.1.21, created on 2020-06-15 09:41:35
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/components/addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:215246185ee7889f0d7bb7-81792620%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55b21a11794de05dea021121ec9dbf783164a45d' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/addons/components/addons_list.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '215246185ee7889f0d7bb7-81792620',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee7889f13e5e9_42151431',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee7889f13e5e9_42151431')) {function content_5ee7889f13e5e9_42151431($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('manage','settings','version','settings','licensing_and_upgrades','licensing_and_upgrades','uninstall','refresh','mve_ultimate_or_plus_license_required','ultimate_license_required','install','installed','no_data'));
?>
...
<div class="table-responsive-wrapper">
    <table class="table table-addons cm-filter-table table-responsive table-responsive-w-titles" data-ca-input-id="elm_addon" data-ca-clear-id="elm_addon_clear" data-ca-empty-id="elm_addon_no_items<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("addons_row", null, null); ob_start(); ?>
            <tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['a']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['additional_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-row-item <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon_classes']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="addon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                <td class="addon-icon">
                    <div class="bg-icon" <?php if ($_smarty_tpl->tpl_vars['a']->value['status']!="N"&&$_smarty_tpl->tpl_vars['a']->value['install_datetime']) {?>title="<?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['a']->value['install_datetime'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
...
/addons/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
/icon.png" width="38" height="38" border="0" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
                        <?php } else { ?>
                            <?php if ($_smarty_tpl->tpl_vars['a']->value['status']=="N") {?>
                ...
                <td width="80%">
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['non_editable']->value) {?>
                        <?php if ($_smarty_tpl->tpl_vars['a']->value['separate']) {?>
                            <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php if (!$_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?> class="cm-promo-popup"<?php }?>><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        <?php } else { ?>
...
installed"<?php }?>><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                        <?php }?>
                    <?php } else { ?>
                        <span class="unedited-element block"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                    <?php }?>
 ...
 <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['version'])===null||$tmp==='' ? 0.1 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</small>
                        <?php if ($_smarty_tpl->tpl_vars['a']->value['supplier']) {?>
                            <?php if ($_smarty_tpl->tpl_vars['a']->value['supplier_link']) {?>
                                <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['supplier_link'], ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank" class="muted addon-supplier"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['supplier'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                            <?php } else { ?>
                                <small class="muted addon-supplier"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['supplier'], ENT_QUOTES, 'ISO-8859-1');?>
</small>
                            <?php }?>
                        <?php }?>
                    </div>
...
$_smarty_tpl->tpl_vars['btn_class'] = new Smarty_variable('', null, 0);
                                ...
                                <?php } else { ?>
                                    <li class="disabled"><a><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a></li>
                                <?php }?>
                            <?php } else { ?>
                                <li><?php ob_start();
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['a']->value['status']=='N') {?>
                        ...
                        <div class="pull-right">
                            <a
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?>
                                    href="<?php echo htmlspecialchars(fn_url("addons.install?addon=".((string)$_smarty_tpl->tpl_vars['key']->value)."&return_url=".((string)rawurlencode($_smarty_tpl->tpl_vars['c_url']->value))), ENT_QUOTES, 'ISO-8859-1');?>
"
                                ...
                                <?php } elseif (fn_allowed_for("MULTIVENDOR")) {?>
                                    ...
                                    href="<?php echo htmlspecialchars(fn_url("functionality_restrictions.mve_ultimate_or_plus_license_required"), ENT_QUOTES, 'ISO-8859-1');?>
"
                                    data-ca-dialog-title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promo_popup_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                                <?php } else { ?>
                                    ...
                                    href="<?php echo htmlspecialchars(fn_url("functionality_restrictions.ultimate_license_required"), ENT_QUOTES, 'ISO-8859-1');?>
"
                                    data-ca-dialog-title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promo_popup_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                                <?php }?>
...
$_smarty_tpl->tpl_vars['status_meta'] = new Smarty_variable('', null, 0);
            ...
            <!--addon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></tr>
        <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
...
<p id="elm_addon_no_items<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>

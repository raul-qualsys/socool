<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:53
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/price.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6480353905ee2342901faf0-72515751%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0039289be6c3d6e5d0fd4b3c09fbfb60219875d3' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/price.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6480353905ee2342901faf0-72515751',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234290352f3_46973082',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234290352f3_46973082')) {function content_5ee234290352f3_46973082($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_format_price')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.format_price.php';
...
if ($_smarty_tpl->tpl_vars['secondary_currency']->value!=$_smarty_tpl->tpl_vars['primary_currency']->value) {?>&nbsp;(<?php if ($_smarty_tpl->tpl_vars['class']->value) {?><span class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></span><?php }
...
if ($_smarty_tpl->tpl_vars['class']->value) {?><span class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></span><?php }?>)<?php }
} else {
...
" <?php if ($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['after']=="Y") {?>data-p-sign="s"<?php }?> data-a-dec="." data-a-sep="," <?php if ($_smarty_tpl->tpl_vars['product_id']->value) {?>data-ct-product="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
<?php } else { ?>

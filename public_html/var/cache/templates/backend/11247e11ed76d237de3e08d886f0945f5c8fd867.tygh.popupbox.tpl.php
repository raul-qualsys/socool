<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:50
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/common/popupbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15436407995ee2342682d7d3-85100693%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11247e11ed76d237de3e08d886f0945f5c8fd867' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/common/popupbox.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15436407995ee2342682d7d3-85100693',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234268783e6_32774611',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234268783e6_32774611')) {function content_5ee234268783e6_32774611($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?><?php
...
<?php if (isset($_smarty_tpl->tpl_vars['title_start']->value)&&isset($_smarty_tpl->tpl_vars['title_end']->value)) {?>
    ...
    <?php $_smarty_tpl->tpl_vars['responsive_dialog_params'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['responsive_dialog_params']->value)." data-ca-dialog-text-first=\"".((string)$_smarty_tpl->tpl_vars['t_first']->value)."\"", null, 0);?>
    <?php $_smarty_tpl->tpl_vars['responsive_dialog_params'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['responsive_dialog_params']->value)." data-ca-dialog-text-second=\"".((string)$_smarty_tpl->tpl_vars['t_second']->value)."\"", null, 0);?>
<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['act']->value=="edit") {?>
    ...
    <?php }?>
    <a <?php if ($_smarty_tpl->tpl_vars['edit_onclick']->value) {?>onclick="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['edit_onclick']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['icon']->value, ENT_QUOTES, 'ISO-8859-1');
}
}?> <?php if (!$_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-dialog-opener<?php }
if ($_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-promo-popup<?php }?> <?php if ($_smarty_tpl->tpl_vars['_href']->value&&!$_smarty_tpl->tpl_vars['is_promo']->value) {?> <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['opener_ajax_class']->value)===null||$tmp==='' ? 'cm-ajax' : $tmp), ENT_QUOTES, 'ISO-8859-1');
}
if ($_smarty_tpl->tpl_vars['link_class']->value) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');
}?>" <?php if ($_smarty_tpl->tpl_vars['_href']->value&&!$_smarty_tpl->tpl_vars['is_promo']->value) {?> href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_href']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php echo $_smarty_tpl->tpl_vars['popup_params']->value;?>
 title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['link_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("edit") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['drop_left']->value) {?>data-placement="left"<?php }?>><?php if ($_smarty_tpl->tpl_vars['icon']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></i><?php }
...
<?php } elseif ($_smarty_tpl->tpl_vars['act']->value=="edit_outside") {?>
    <a <?php if ($_smarty_tpl->tpl_vars['edit_onclick']->value) {?>onclick="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['edit_onclick']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> class="hand btn cm-tooltip cm-dialog-opener <?php if ($_smarty_tpl->tpl_vars['_href']->value) {?> <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['opener_ajax_class']->value)===null||$tmp==='' ? 'cm-ajax' : $tmp), ENT_QUOTES, 'ISO-8859-1');
}
if ($_smarty_tpl->tpl_vars['link_class']->value) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');
}?>" <?php if ($_smarty_tpl->tpl_vars['_href']->value) {?> href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_href']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php echo $_smarty_tpl->tpl_vars['popup_params']->value;?>
 title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['link_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("edit") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['act']->value=="notes") {?>
 ...
 class="cm-dialog-opener <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><i class="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['icon']->value)===null||$tmp==='' ? 'icon-question-sign' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"></i></a>
<?php } elseif ($_smarty_tpl->tpl_vars['act']->value=="general") {?>
        <div class="btn-group <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            <a class="btn cm-dialog-opener <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-tooltip" <?php echo $_smarty_tpl->tpl_vars['popup_params']->value;?>
 <?php if ($_smarty_tpl->tpl_vars['edit_onclick']->value) {?>onclick="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['edit_onclick']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['href']->value) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['href']->value), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['title']->value) {?>title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>><?php if ($_smarty_tpl->tpl_vars['icon']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></i><?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
        </div>
...
<?php } elseif ($_smarty_tpl->tpl_vars['act']->value=="link") {?>
    <a class="cm-dialog-opener <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['act']->value=="default") {?>
    <a<?php if ($_smarty_tpl->tpl_vars['onclick']->value) {?> onclick="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['onclick']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }
if ($_smarty_tpl->tpl_vars['href']->value) {?> href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['href']->value), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
<?php }?>

<?php if ($_smarty_tpl->tpl_vars['content']->value) {?>
<div class="hidden <?php if (fn_allowed_for("ULTIMATE")) {?>ufa<?php }?>" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['text']->value, ENT_QUOTES, 'ISO-8859-1');?>

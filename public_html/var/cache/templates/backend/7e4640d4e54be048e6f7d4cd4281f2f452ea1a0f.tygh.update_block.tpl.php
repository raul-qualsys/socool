<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 11:17:22
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6059221975ef0d9924e8227-91560861%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7e4640d4e54be048e6f7d4cd4281f2f452ea1a0f' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_block.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6059221975ef0d9924e8227-91560861',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef0d99258b764_05903948',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef0d99258b764_05903948')) {function content_5ef0d99258b764_05903948($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_include_ext')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
_update_form">
<div id="block_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <?php if ($_REQUEST['dynamic_object']['object_id']>0) {?>
        <input type="hidden" name="dynamic_object[object_id]" value="<?php echo htmlspecialchars($_REQUEST['dynamic_object']['object_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>    
        <input type="hidden" name="dynamic_object[object_type]" value="<?php echo htmlspecialchars($_REQUEST['dynamic_object']['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>    
    <?php }?>
...
" />
    <input type="hidden" name="block_data[type]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['type'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <input type="hidden" name="block_data[block_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <input type="hidden" name="block_data[content_data][snapping_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['snapping_data']->value['snapping_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>    
    ...
    <input type="hidden" name="snapping_data[snapping_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['snapping_data']->value['snapping_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <input type="hidden" name="snapping_data[grid_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['snapping_data']->value['grid_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <input type="hidden" name="selected_location" value="<?php echo htmlspecialchars((($tmp = @$_REQUEST['selected_location'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input" />
    <?php if ($_REQUEST['assign_to']) {?>
        <input type="hidden" name="assign_to" value="<?php echo htmlspecialchars($_REQUEST['assign_to'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <?php }?>
    <input type="hidden" name="result_ids" value="<?php if ($_REQUEST['r_result_ids']) {
echo htmlspecialchars($_REQUEST['r_result_ids'], ENT_QUOTES, 'ISO-8859-1');?>
,<?php }?>block_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>

    
    
    <?php if ($_REQUEST['r_url']) {?>
        <input type="hidden" name="r_url" value="<?php echo htmlspecialchars($_REQUEST['r_url'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <?php }?>
    <div class="tabs cm-j-tabs cm-track">
        <ul class="nav nav-tabs">
            <li id="block_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js <?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_general_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("general");?>
            ...
            <?php if (trim(Smarty::$_smarty_vars['capture']['block_content'])) {?><li id="block_contents_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_contents_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("content");?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['block_scheme']->value['settings']) {?>
                <li id="block_settings_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_settings_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("block_settings");?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value&&!$_smarty_tpl->tpl_vars['hide_status']->value) {?>
                <li id="block_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_status_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("status");?>
    ...
    <div class="cm-tabs-content" id="tabs_content_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <div id="content_block_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            <div class="control-group <?php if ($_smarty_tpl->tpl_vars['editable_template_name']->value) {?>cm-no-hide-input<?php }?>">
                <label for="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_name" class="control-label cm-required"><?php echo $_smarty_tpl->__("name");?>
                ...
                <?php if ($_REQUEST['html_id']&&$_smarty_tpl->tpl_vars['id']->value>0) {?>
                    <div class="text-type-value"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
                <?php } else { ?>
                    <input type="text" name="block_data[description][name]" id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_name" class="span9" size="25" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                <?php }?>
                </div>
            </div>
...
_template"><?php echo $_smarty_tpl->__("template");?>
                    ...
                    <?php if (is_array($_smarty_tpl->tpl_vars['block_scheme']->value['templates'])) {?>
                        <select id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'ISO-8859-1');
} else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');
}?></option>
                            <?php } ?>
                        </select>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['dynamic_object']->value) {?>
                        <input type="hidden" name="block_data[properties][template]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['properties']['template'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input" />
                    <?php }?>
                    <?php if (is_array($_smarty_tpl->tpl_vars['block_scheme']->value['templates'][$_smarty_tpl->tpl_vars['block']->value['properties']['template']]['settings'])) {?>
                        <a href="#" id="sw_case_settings_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="open cm-combination" onclick="return false">
            ...
            <?php if (is_array($_smarty_tpl->tpl_vars['block_scheme']->value['templates'][$_smarty_tpl->tpl_vars['block']->value['properties']['template']]['settings'])) {?>        
                <div id="case_settings_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden">
...
_wrapper"><?php echo $_smarty_tpl->__("wrapper");?>
                    ...
                    <div class="controls">
                    <select name="snapping_data[wrapper]" id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_wrapper">
                        <option value="">--</option>
...
?>                            
                            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['block']->value['wrapper']==$_smarty_tpl->tpl_vars['k']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['w']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php } ?>
                    </select>
                    </div>
...
_user_class"><?php echo $_smarty_tpl->__("user_class");?>
                    ...
                    <div class="controls">
                    <input type="text" name="snapping_data[user_class]" id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_user_class" size="25" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['user_class'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label cm-required cm-multiple-checkboxes"
                           for="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_availability"
                    ><?php echo $_smarty_tpl->__("block_manager.availability.show_on");?>
</label>
                    <div class="controls" id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_availability">
...
?>
                                ...
                                <input type="checkbox"
                                    id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_show_on_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['device']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                                    class="cm-text-toggle btn-group-checkbox__checkbox"
                                    <?php if ($_smarty_tpl->tpl_vars['is_available']->value) {?>checked="checked"<?php }?>
                                    data-ca-toggle-text="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_availability_instance']->value->getHiddenClass($_smarty_tpl->tpl_vars['device']->value), ENT_QUOTES, 'ISO-8859-1');?>
"
                                    data-ca-toggle-text-mode="onDisable"
                                    data-ca-toggle-text-target-elem-id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_user_class"
                                />
                                <label class="btn btn-group-checkbox__label" for="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_show_on_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['device']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                    <i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['devices_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
"></i>
        ...
        <?php if (Smarty::$_smarty_vars['capture']['block_content']) {?>
            <div id="content_block_contents_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" >
                <?php if ($_smarty_tpl->tpl_vars['dynamic_object']->value['object_id']>0) {?>
                    <input type="hidden" name="block_data[content_data][object_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object']->value['object_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input" />
                    <input type="hidden" name="block_data[content_data][object_type]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input" />
                <?php }?>
...
if ($_smarty_tpl->tpl_vars['stat']->value['object_type']!='') {?><div><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"show_objects_".((string)$_smarty_tpl->tpl_vars['block']->value['block_id'])."_".((string)$_smarty_tpl->tpl_vars['stat']->value['object_type']),'text'=>$_smarty_tpl->__($_smarty_tpl->tpl_vars['stat']->value['object_type']),'link_text'=>((string)$_smarty_tpl->tpl_vars['stat']->value['contents_count']),'act'=>"link",'href'=>"block_manager.show_objects?object_type=".((string)$_smarty_tpl->tpl_vars['stat']->value['object_type'])."&block_id=".((string)$_smarty_tpl->tpl_vars['block']->value['block_id']),'opener_ajax_class'=>"cm-ajax",'link_class'=>"cm-ajax-force",'content'=>''), 0);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['stat']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
</div><?php }
}
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_block_manager_update_block_override_by_this")), 0);?>
                    ...
                    <div class="controls">
                        ...
                        <input id="block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_override_by_this" type="checkbox" class="cm-no-hide-input" name="block_data[content_data][override_by_this]" value="Y" />
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['block_scheme']->value['settings']) {?>
            <div id="content_block_settings_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" >
                    <?php  $_smarty_tpl->tpl_vars['setting_data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['setting_data']->_loop = false;
 $_smarty_tpl->tpl_vars['name'] = new Smarty_Variable;
...
?>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value&&!$_smarty_tpl->tpl_vars['hide_status']->value) {?>
        <div id="content_block_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" >
            <div class="control-group">
...
echo $_smarty_tpl->__("disabled");
            ...
            <input type="hidden" class="cm-no-hide-input" name="snapping_data[object_type]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
$_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['picker_params']['extra_url'] = trim(Smarty::$_smarty_vars['capture']['picker_extra_url']);?>
    ...
    <!--block_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>

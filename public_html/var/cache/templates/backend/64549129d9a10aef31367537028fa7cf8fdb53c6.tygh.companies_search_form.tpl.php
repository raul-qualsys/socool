<?php /* Smarty version Smarty-3.1.21, created on 2020-07-01 05:56:45
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/companies/components/companies_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15803828055efc6bede7a362-54105925%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64549129d9a10aef31367537028fa7cf8fdb53c6' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/companies/components/companies_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15803828055efc6bede7a362-54105925',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5efc6bedece033_08595319',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5efc6bedece033_08595319')) {function content_5efc6bedece033_08595319($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.array_to_fields.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('search','name','email','address','city','country','select_country','state','select_state','status','active','pending','new','disabled','zip_postal_code','phone','url'));
?>
...
<div class="sidebar-field">
    ...
    <input type="text" name="company" id="elm_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
" />
</div>
...
" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="url" id="elm_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['url'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
        </div>
    </div>

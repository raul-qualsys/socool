<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 18:33:46
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/themes/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17169748815ef13fda966848-50228940%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f460b84e1898a7d8775c82b1e4c4374533788f00' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/themes/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17169748815ef13fda966848-50228940',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef13fdaa2cfe9_23761630',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef13fdaa2cfe9_23761630')) {function content_5ef13fdaa2cfe9_23761630($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
:</p>
        <form method="post" action="<?php echo htmlspecialchars(fn_url("themes.set"), ENT_QUOTES, 'ISO-8859-1');?>
">
            <input type="hidden" name="theme_name" value="<?php echo htmlspecialchars($_GET['theme_name'], ENT_QUOTES, 'ISO-8859-1');?>
">
            <input type="hidden" name="style" value="<?php echo htmlspecialchars($_GET['style'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
                            <tr>
                                <td>
                                    <input type="checkbox" name="settings_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['object_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['object_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" checked="checked">
                                </td>
                                <td>
                                    <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting_section']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</strong>: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>

                                </td>
                                <td>
                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['current_value_readable'], ENT_QUOTES, 'ISO-8859-1');?>

                                </td>
                                <td>
                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['new_value_readable'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <div class="clearfix right">
                <a class="btn" href="<?php echo htmlspecialchars(fn_url("themes.manage"), ENT_QUOTES, 'ISO-8859-1');?>
...
" method="post" name="clone_theme_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_form" class="cm-ajax cm-comet cm-form-dialog-closer form-horizontal form-edit cm-skip-check-items">
            <input type="hidden" name="theme_data[theme_src]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            ...
            <div class="add-new-object-group">
                <div class="tabs cm-j-tabs">
                    <ul class="nav nav-tabs">
                        <li id="tab_clone_theme_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js active"><a><?php echo $_smarty_tpl->__("general");?>
</a></li>
                    </ul>
                </div>

                <div class="cm-tabs-content" id="content_tab_clone_theme_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label cm-required" for="elm_theme_dir_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("directory");?>
</label>
                            <div class="controls">
                                <input type="text" id="elm_theme_dir_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="theme_data[theme_dest]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_clone" />
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="elm_theme_title_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("name");?>
</label>
                            <div class="controls">
                                <input type="text" id="elm_theme_title_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="theme_data[title]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
" />
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="elm_theme_desc_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("description");?>
</label>
                            <div class="controls">
                                <textarea name="theme_data[description]" id="elm_theme_desc_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" cols="50" rows="4" class="span9"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                            </div>
                        </div>
...
<?php if ($_smarty_tpl->tpl_vars['theme']->value['screenshot']) {?>
    <div id="theme_image" class="span4">
        <?php if ($_smarty_tpl->tpl_vars['theme']->value['styles'][$_smarty_tpl->tpl_vars['layout']->value['style_id']]['image']) {?>
            <img class="screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['styles'][$_smarty_tpl->tpl_vars['layout']->value['style_id']]['image'], ENT_QUOTES, 'ISO-8859-1');?>
">
        <?php } else { ?>
            <img class="screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
/user_styles.png" alt="">
        <?php }?>
...
<div class="span8 theme-description" id="theme_description_container">
    <h4 class="lead"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['layout']->value['style_name']) {?>: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value['style_name'], ENT_QUOTES, 'ISO-8859-1');
}?></h4>
...
?>
                        <tr>
                            <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['available_layout']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                            <td>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['installed_theme']->value) {?>
            <div class="theme-subtitle clearfix">
                <h4 id="anchor_<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['installed_theme']->value['title']," ","_"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');
...
"> <i class="icon-trash"></i> </a>
                ...
                <span class="label pull-right"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['installed_theme']->value['layouts']), ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo $_smarty_tpl->__("layouts");?>
</span>
                <span class="label pull-right"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['installed_theme']->value['styles']), ENT_QUOTES, 'ISO-8859-1');?>
                    ...
                    <div class="span3">
                        <div class="theme <?php if ($_smarty_tpl->tpl_vars['style']->value['style_id']==$_smarty_tpl->tpl_vars['layout']->value['style_id']&&$_smarty_tpl->tpl_vars['layout']->value['theme_name']==$_smarty_tpl->tpl_vars['theme_id']->value) {?>theme-selected<?php }?>">
                            <div class="theme-title">
                               <span title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                            </div>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['style']->value['image']) {?>
                                <a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['image'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-previewer">
                                    ...
                                    <?php }?>
                                    <img class="screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['image'], ENT_QUOTES, 'ISO-8859-1');?>
" alt="">
                                </a>
                            <?php } else { ?>
                                <div>
...
/user_styles.png" alt="">
            ...
            <?php } else { ?>
                <div class="span3">
                    <div class="theme">
                        <div class="theme-title">
                           <span title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                        </div>
                        <?php if ($_smarty_tpl->tpl_vars['theme_id']->value!=$_smarty_tpl->tpl_vars['runtime']->value['layout']['theme_name']) {?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['installed_theme']->value['screenshot']) {?>
                            <a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-previewer"><img class="screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['installed_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" alt=""></a>
                        <?php }?>
                    </div>
                </div>
            ...
            <?php if ($_smarty_tpl->tpl_vars['repo_theme']->value) {?>
                <div class="span3">
                    <div class="theme">
                        ...
                        <div class="theme-title">
                        <span title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['repo_theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                        </div>
                        ...
                        <a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-previewer"><img class="screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" alt="" width="250"></a>
                        <?php }?>
                        ...
                        <div class="theme-actions">
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot']) {?>
                                <li><a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-previewer"><?php echo $_smarty_tpl->__("preview");?>
</a></li>
                                <?php }?>

                                
                                <li><a class="cm-comet cm-ajax cm-post" data-ca-target-id="themes_list" href="<?php echo htmlspecialchars(fn_url("themes.install?theme_name=".((string)$_smarty_tpl->tpl_vars['theme_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"themes:install_themes"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <?php $_smarty_tpl->tpl_vars['theme_name'] = new Smarty_variable($_smarty_tpl->tpl_vars['available_themes']->value['current']['theme_name'], null, 0);?>
    <div class="hidden" id="content_elm_clone_theme_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_inline_script(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div class="form-horizontal sidebar-row clearfix">
            ...
            <div class="control-group">
                ...
                <div class="controls right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
            </div>
            <div class="control-group">
                <div class="control-label muted" title="/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['theme_name'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("directory");?>
</div>
                <div class="controls right"><a class="pull-right" href="<?php echo htmlspecialchars(fn_url("templates.manage?selected_path=".((string)$_smarty_tpl->tpl_vars['settings']->value['theme_name'])), ENT_QUOTES, 'ISO-8859-1');?>
">/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['theme_name'], ENT_QUOTES, 'ISO-8859-1');?>
</a></div>
            </div>
            <div class="control-group">
                <div class="control-label muted"><?php echo $_smarty_tpl->__("layouts");?>
</div>
                <div class="controls right"><a href="<?php echo htmlspecialchars(fn_url("block_manager.manage"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['theme']->value['layouts']), ENT_QUOTES, 'ISO-8859-1');?>
</a></div>
            </div>
            <div class="control-group">
                <div class="control-label muted"><?php echo $_smarty_tpl->__("theme_editor.styles");?>
</div>
                <div class="controls right"><a href="#anchor_<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['theme']->value['title']," ","_"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['theme']->value['styles']), ENT_QUOTES, 'ISO-8859-1');?>
</a> </div>
            </div>
            <div class="control-group">
                <div class="control-label muted" ><?php echo $_smarty_tpl->__("developer");?>
</div>
                <div class="controls right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['developer'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
            </div>
        </div>

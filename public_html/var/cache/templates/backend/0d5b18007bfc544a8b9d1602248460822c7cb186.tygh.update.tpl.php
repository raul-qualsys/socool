<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:12:13
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/categories/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2045680805ee265edc771b4-80510848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0d5b18007bfc544a8b9d1602248460822c7cb186' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/categories/update.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2045680805ee265edc771b4-80510848',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee265edd1e945_18242619',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee265edd1e945_18242619')) {function content_5ee265edd1e945_18242619($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<input type="hidden" name="category_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
...
:</label>
        <div class="controls">
            <input type="text" name="category_data[category]" id="elm_category_name" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                <?php if (!fn_allowed_for("ULTIMATE")) {?>
                    <?php if (strpos($_smarty_tpl->tpl_vars['cat']->value['id_path'],((string)$_smarty_tpl->tpl_vars['category_data']->value['id_path'])."/")===false&&$_smarty_tpl->tpl_vars['cat']->value['category_id']!=$_smarty_tpl->tpl_vars['id']->value||!$_smarty_tpl->tpl_vars['id']->value) {?>
                        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['cat']->value['disabled']) {?>disabled="disabled"<?php }?> <?php if ($_smarty_tpl->tpl_vars['category_data']->value['parent_id']==$_smarty_tpl->tpl_vars['cat']->value['category_id']) {?>selected="selected"<?php }?>><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['cat']->value['level']),htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category'], ENT_QUOTES, 'ISO-8859-1', true));?>
</option>
                    <?php }?>
                <?php }?>
                <?php if (fn_allowed_for("ULTIMATE")) {?>
                    <?php if ($_smarty_tpl->tpl_vars['cat']->value['store']) {?>
                        ...
                        <?php }?>
                        <optgroup label="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
">
                    <?php } else { ?>
                        <?php if (strpos($_smarty_tpl->tpl_vars['cat']->value['id_path'],((string)$_smarty_tpl->tpl_vars['category_data']->value['id_path'])."/")===false&&$_smarty_tpl->tpl_vars['cat']->value['category_id']!=$_smarty_tpl->tpl_vars['id']->value||!$_smarty_tpl->tpl_vars['id']->value) {?>
                            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
        <div class="controls">
            <textarea id="elm_category_descr" name="category_data[description]" cols="55" rows="8" class="input-large cm-wysiwyg input-textarea-long"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
                <?php ob_start();
...
:</label>
        <div class="controls">
            <input type="text" name="category_data[page_title]" id="elm_category_page_title" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['page_title'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
        </div>
    </div>
...
:</label>
        <div class="controls">
            <textarea name="category_data[meta_description]" id="elm_category_meta_description" cols="55" rows="4" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['meta_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
    </div>
...
:</label>
        <div class="controls">
            <textarea name="category_data[meta_keywords]" id="elm_category_meta_keywords" cols="55" rows="4" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['meta_keywords'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
    </div>
    </div>
...
:</label>
        <div class="controls">
            <input type="text" name="category_data[position]" id="elm_category_position" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['position'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                    <option <?php if ($_smarty_tpl->tpl_vars['category_data']->value['product_details_view']==$_smarty_tpl->tpl_vars['layout']->value) {?>selected="selected"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
            <div class="controls">
            <input type="text" name="category_data[product_columns]" id="elm_category_product_columns" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['product_columns'], ENT_QUOTES, 'ISO-8859-1');?>
...
$_smarty_tpl->tpl_vars["item"]->_loop = true;
 $_smarty_tpl->tpl_vars["layout"]->value = $_smarty_tpl->tpl_vars["item"]->key;
?>
                    <label class="checkbox" for="elm_category_layout_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><input type="checkbox" class="cm-combo-checkbox cm-toggle-element" name="category_data[selected_views][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="elm_category_layout_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (($_smarty_tpl->tpl_vars['category_data']->value['selected_views'][$_smarty_tpl->tpl_vars['layout']->value])||(!$_smarty_tpl->tpl_vars['category_data']->value['selected_views']&&$_smarty_tpl->tpl_vars['item']->value['active'])) {?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['category_data']->value['selected_views']) {?>disabled="disabled"<?php }?> /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</label>
                <?php } ?>
            </div>
        </div>
...
?>
                    <?php if (($_smarty_tpl->tpl_vars['category_data']->value['selected_views'][$_smarty_tpl->tpl_vars['layout']->value])||(!$_smarty_tpl->tpl_vars['category_data']->value['selected_views']&&$_smarty_tpl->tpl_vars['item']->value['active'])) {?>
                        <option <?php if ($_smarty_tpl->tpl_vars['category_data']->value['default_view']==$_smarty_tpl->tpl_vars['layout']->value) {?>selected="selected"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                    <?php }?>
                <?php } ?>
            </select>
...
<?php if (!$_smarty_tpl->tpl_vars['id']->value) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->__("new_category"),'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'sidebar_position'=>"left",'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>

<?php } else { ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'sidebar_position'=>"left",'title_start'=>$_smarty_tpl->__("editing_category"),'title_end'=>$_smarty_tpl->tpl_vars['category_data']->value['category'],'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:02
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/product_variations/views/product_variations/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5293470505ee263121c9056-56755732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '62af62eb82d335f6f86d342567153135bdf57e29' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/product_variations/views/product_variations/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5293470505ee263121c9056-56755732',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee263121f5fd7_75928783',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee263121f5fd7_75928783')) {function content_5ee263121f5fd7_75928783($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
?><?php
...
" method="post" name="manage_variation_products_form" id="manage_variation_products_form" data-ca-main-content-selector="[data-ca-main-content]">
        <input type="hidden" value="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['redirect_url']->value), ENT_QUOTES, 'ISO-8859-1');?>
" name="redirect_url">
                ...
                <?php if ($_smarty_tpl->tpl_vars['group']->value) {?>
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                        <?php if ($_smarty_tpl->tpl_vars['group']->value) {?>
                            ...
                            <li><?php ob_start();
echo htmlspecialchars(http_build_query(array("feature_id"=>array_keys($_smarty_tpl->tpl_vars['selected_features']->value))), ENT_QUOTES, 'ISO-8859-1');
...
?>
                            <th><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</span></th>
                        <?php } ?>
...
?>
                        <?php if (!$_smarty_tpl->tpl_vars['product']->value['parent_product_id']) {?>
                            ...
                            <tbody data-ca-switch-id="product_variations_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                        <?php } else { ?>
                            <?php echo $_smarty_tpl->getSubTemplate ("addons/product_variations/views/product_variations/components/product_item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:00:00
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/reward_points/hooks/products/tabs_content.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19200638845ee263105103f0-68537990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f0dfac2d7ea27c4e2782807372cfc81ea00e3778' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/reward_points/hooks/products/tabs_content.post.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19200638845ee263105103f0-68537990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee26310542141_58088315',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee26310542141_58088315')) {function content_5ee26310542141_58088315($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
        ...
        <?php $_smarty_tpl->tpl_vars["is_auto"] = new Smarty_variable($_smarty_tpl->tpl_vars['addons']->value['reward_points']['auto_price_in_points'], null, 0);?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="hidden" id="price_in_points_exchange" value="<?php echo htmlspecialchars(ceil($_smarty_tpl->tpl_vars['rate_pip']->value), ENT_QUOTES, 'ISO-8859-1');?>
" />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="price_in_points" name="product_data[point_price]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['data']->value['point_price'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
">
                            <input type="hidden" name="product_data[reward_points][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['usergroup_id'], ENT_QUOTES, 'ISO-8859-1');?>
][usergroup_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['usergroup_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['usergroup_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="product_data[reward_points][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['m']->value['usergroup_id'], ENT_QUOTES, 'ISO-8859-1');?>
][amount]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['reward_points']->value[$_smarty_tpl->tpl_vars['m']->value['usergroup_id']]['amount'])===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>

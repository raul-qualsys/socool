<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:30:02
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/profiles/components/profiles_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8580859805f63ab2a47e029-78219439%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4fffb20c1e8588d87db5efc13c1176a92de6fb64' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/profiles/components/profiles_account.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8580859805f63ab2a47e029-78219439',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63ab2a4b8fc4_63498929',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63ab2a4b8fc4_63498929')) {function content_5f63ab2a4b8fc4_63498929($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['uid']->value==1||(fn_check_user_type_admin_area($_smarty_tpl->tpl_vars['user_data']->value)&&$_smarty_tpl->tpl_vars['user_data']->value['user_id']&&defined("RESTRICTED_ADMIN"))||$_smarty_tpl->tpl_vars['user_data']->value['is_root']=="Y"||$_smarty_tpl->tpl_vars['auth']->value['is_root']=="Y"||$_smarty_tpl->tpl_vars['user_data']->value['user_id']==$_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
    ...
    <input type="hidden" name="user_data[user_type]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['user_type'], ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php }?>
...
:</label>
    <div class="controls">
        <input type="text" id="email" name="user_data[email]" class="input-large" size="32" maxlength="128" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
<?php if (($_smarty_tpl->tpl_vars['uid']->value!=1||defined("RESTRICTED_ADMIN"))&&$_smarty_tpl->tpl_vars['user_data']->value['user_id']!=$_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['user_data']->value['is_root']!="Y"||!fn_check_user_type_admin_area($_smarty_tpl->tpl_vars['user_data']->value)||!$_smarty_tpl->tpl_vars['user_data']->value['user_id']||($_smarty_tpl->tpl_vars['user_data']->value['company_id']&&!$_smarty_tpl->tpl_vars['auth']->value['company_id'])) {?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add") {?>
            <input type="hidden" name="user_data[user_type]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_u_type']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
        <?php } else { ?>
            <div class="control-group">
...
:</label>
                ...
                <div class="controls">
                <select id="user_type" name="user_data[user_type]"<?php if (!$_smarty_tpl->tpl_vars['redirect_denied']->value) {?> onchange="Tygh.$.redirect('<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['r_url']->value)."&user_type="), ENT_QUOTES, 'ISO-8859-1');?>
' + this.value);"<?php }?>>
...
?>
            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['lang_code']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['lang_code']->value==$_smarty_tpl->tpl_vars['user_data']->value['lang_code']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
        <?php } ?>
    </select>
    </div>

<?php /* Smarty version Smarty-3.1.21, created on 2020-08-03 13:59:31
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/components/products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21370594075f285e933cbed7-35443056%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf51cdd5c87fb2a9a3812586cca603dec4648024' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/components/products.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '21370594075f285e933cbed7-35443056',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f285e9341f924_35850155',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f285e9341f924_35850155')) {function content_5f285e9341f924_35850155($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('product','price','discount','quantity','options','product','delete','sku','price','free','discount','quantity','options','expand_collapse_list','expand_collapse_list','show_options','expand_collapse_list','expand_collapse_list','hide_options','nocombination','advanced_products_search','type_to_search_or_click_button'));
?>
...
"><?php echo $_smarty_tpl->tpl_vars['cp']->value['product'];?>
            ...
            <a class="cm-confirm cm-post hidden-tools icon-remove-sign order-management-delete" href="<?php echo htmlspecialchars(fn_url("order_management.delete?cart_ids[]=".((string)$_smarty_tpl->tpl_vars['key']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_code'], ENT_QUOTES, 'ISO-8859-1');?>
</p><?php }?>
...
" width="3%" class="order-management-price-check">
        <?php if ($_smarty_tpl->tpl_vars['cp']->value['exclude_from_calculate']) {?>
            ...
            <input class="inline order-management-price-check-checkbox" type="checkbox" name="cart_products[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" width="3%" class="nowrap order-management-options">
        ...
        <div id="on_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
            <div class="order-management-options-desktop">
                <div class="icon-list-ul cm-external-click" data-ca-external-click-id="on_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
"></div>
            </div>
            <div class="order-management-options-mobile">
                <div class="btn cm-external-click" data-ca-external-click-id="on_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("show_options");?>
</div>
            </div>
        </div>
        <div id="off_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
" alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
...
">
            <div class="order-management-options-desktop">
                <div class="icon-list-ul cm-external-click" data-ca-external-click-id="off_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
"></div>
            </div>
            <div class="order-management-options-mobile">
                <div class="btn cm-external-click"  data-ca-external-click-id="off_product_options_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cp']->value['product_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('company_id'=>$_smarty_tpl->tpl_vars['order_company_id']->value,'display'=>"options_price",'extra_var'=>"order_management.add",'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_tmp1,'show_but_text'=>false), 0);?>

            <select id="product_add"
                    class="cm-object-selector cm-object-product-add"
                    <?php if ($_smarty_tpl->tpl_vars['tabindex']->value) {?>
                        tabindex="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tabindex']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                    <?php }?>
                    multiple
                    name="product_data"

<?php /* Smarty version Smarty-3.1.21, created on 2020-09-17 13:28:57
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/addons/call_requests/views/call_requests/components/requests_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4059327445f63aae95da576-02352857%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0fda9d335d84e648438ef52f1c4255f41e2743ac' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/addons/call_requests/views/call_requests/components/requests_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4059327445f63aae95da576-02352857',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f63aae9604fa4_15866548',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f63aae9604fa4_15866548')) {function content_5f63aae9604fa4_15866548($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.array_to_fields.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('search','id','person_name','phone','status','call_requests.order_exists','yes','no','order_status','call_requests.responsible'));
?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("simple_search", null, null); ob_start(); ?>
    <div class="sidebar-field">
        ...
        <input type="text" name="id" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
    ...
    <div class="sidebar-field">
        ...
        <input type="text" name="name" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
    ...
    <div class="sidebar-field">
        ...
        <input type="text" name="phone" size="20" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
...
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==$_smarty_tpl->tpl_vars['key']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                    <?php } ?>
                </select>
            </div>
...
?>
                        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['order_status']==$_smarty_tpl->tpl_vars['key']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                    <?php } ?>
                </select>
            </div>
...
" <?php if ($_smarty_tpl->tpl_vars['search']->value['user_id']==$_smarty_tpl->tpl_vars['user_id']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                    <?php } ?>
                </select>
            </div>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-15 09:51:05
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/upgrade_center/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14966219415ee78ad9b8e7f3-44316459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5733f79ce3b7277f966d677ef65a71414e78360c' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/upgrade_center/manage.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14966219415ee78ad9b8e7f3-44316459',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee78ad9bdba45_94157691',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee78ad9bdba45_94157691')) {function content_5ee78ad9bdba45_94157691($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
if (!is_callable('smarty_modifier_formatfilesize')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.formatfilesize.php';
...
?>
                ...
                <div class="upgrade-center_package">
                    <form name="upgrade_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" method="post" action="<?php echo htmlspecialchars(fn_url(), ENT_QUOTES, 'ISO-8859-1');?>
...
">
                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                        <input type="hidden" name="result_ids" value="install_notices_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
,install_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">

                        <div class="hidden upgrade-center_wizard" id="content_upgrade_center_wizard_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
                            ...
                            <div class="buttons-container">
                                ...
                                <label class="pull-left">
                                    ...
                                    <?php echo $_smarty_tpl->__("upgrade_center.skip_backup");?>
...
">
                        ...
                        <div class="upgrade-center_item">
                            ...
                            <div class="upgrade-center_content">
                                <h4 class="upgrade-center_title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</h4>
                                <ul class="upgrade-center_info">
                                    <li> <strong><?php echo $_smarty_tpl->__("new_version");?>
:</strong> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['to_version'], ENT_QUOTES, 'ISO-8859-1');?>
</li>
                                    <li> <strong><?php echo $_smarty_tpl->__("release_date");?>
:</strong> <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['package']->value['timestamp']), ENT_QUOTES, 'ISO-8859-1');?>
</li>
...
:</strong> <?php echo smarty_modifier_formatfilesize($_smarty_tpl->tpl_vars['package']->value['size']);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['package']->value['ready_to_install']) {?>
                                    ...
                                    <a class="upgrade-center_pkg cm-dialog-opener cm-ajax" href="<?php echo htmlspecialchars(fn_url("upgrade_center.package_content?package_id=".((string)$_smarty_tpl->tpl_vars['_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="package_content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-dialog-title="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['name'], ENT_QUOTES, 'ISO-8859-1', true), ENT_QUOTES, 'ISO-8859-1');?>
...
:</strong> <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['package']->value['timestamp']), ENT_QUOTES, 'ISO-8859-1');?>
                    ...
                    <?php if (!empty($_smarty_tpl->tpl_vars['package']->value['conflicts'])) {?>
                        <div class="upgrade-center_install">
                            <a class="upgrade-center_pkg cm-dialog-opener cm-ajax btn" href="<?php echo htmlspecialchars(fn_url("upgrade_center.conflicts?package_id=".((string)$_smarty_tpl->tpl_vars['package']->value['id'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="conflicts_content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-dialog-title="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['name'], ENT_QUOTES, 'ISO-8859-1', true), ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-08-03 13:59:31
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/components/totals.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16087188885f285e9351e419-98104335%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdfe13e18964cd0d410f21551ddbd16be237b412' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/order_management/components/totals.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16087188885f285e9351e419-98104335',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f285e93563e59_43487797',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f285e93563e59_43487797')) {function content_5f285e93563e59_43487797($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<div class="pull-right order-notes statistic">
    <div class="table-wrapper">
        <table>
            ...
            <tr>
                <td class="statistic-label" width="150px"><?php echo $_smarty_tpl->__("subtotal");?>
:</td>
...
?>
            <tr class="toggle-elm nowrap">
                <td class="statistic-label">&nbsp;<span>&middot;</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['description'], ENT_QUOTES, 'ISO-8859-1');
...
</span><span <?php if ($_smarty_tpl->tpl_vars['cart']->value['stored_taxes']!="Y") {?>class="hidden"<?php }?> data-ca-switch-id="manual_taxes"><input type="text" class="cm-numeric input-small" size="5" name="taxes[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" data-a-sign="% " data-m-dec="3" data-a-pad="false" data-p-sign="s" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['rate_value'], ENT_QUOTES, 'ISO-8859-1');?>
" /></span>)
                </td>
...
?>
                            ...
                            <tr>
                                <td class="right nowrap">
                                    <label><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>

                                    <input type="hidden" name="stored_shipping[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="N" />
                                    <input type="checkbox" class="valign cm-combinations" name="stored_shipping[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="Y" <?php if ($_smarty_tpl->tpl_vars['custom_ship_exists']->value) {?>checked="checked"<?php }?> id="sw_manual_shipping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" /></label>
                                </td>
                                <td class="right">
                                    <span <?php if ($_smarty_tpl->tpl_vars['custom_ship_exists']->value) {?>style="display: none;"<?php }?> data-ca-switch-id="manual_shipping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
                <tr>
                    <td class="statistic-label"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
&nbsp;

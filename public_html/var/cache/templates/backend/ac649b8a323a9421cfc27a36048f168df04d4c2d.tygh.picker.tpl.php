<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:42:47
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/pickers/orders/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:718843395ee234d7f3bbe3-37978252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac649b8a323a9421cfc27a36048f168df04d4c2d' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/pickers/orders/picker.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '718843395ee234d7f3bbe3-37978252',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee234d80400b1_02688599',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee234d80400b1_02688599')) {function content_5ee234d80400b1_02688599($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
if ($_smarty_tpl->tpl_vars['picker_view']->value) {?>[<?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['view_mode']->value=="simple") {?>
                <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_clear" class="reload-container<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value) {?> hidden<?php }?>">
                    <?php ob_start();
echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'ISO-8859-1');
...
" title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_orders") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
        </div>
    </div>
<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['view_mode']->value=="simple") {?>
    <input id="o<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
    ...
    <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_details"<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['item_ids']->value)<=$_smarty_tpl->tpl_vars['max_displayed_qty']->value) {?> class="hidden"<?php }?>><a href="<?php echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'ISO-8859-1');

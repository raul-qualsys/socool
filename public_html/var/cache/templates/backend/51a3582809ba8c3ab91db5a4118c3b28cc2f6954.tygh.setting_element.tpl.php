<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 11:17:22
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/components/setting_element.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18749929475ef0d9925a5db8-14805119%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51a3582809ba8c3ab91db5a4118c3b28cc2f6954' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/components/setting_element.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18749929475ef0d9925a5db8-14805119',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef0d9925f53b9_52894291',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef0d9925f53b9_52894291')) {function content_5ef0d9925f53b9_52894291($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.inline_script.php';
...
Tygh.$(document).ready(function() {
    Tygh.$('#additional_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['set_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
').show();
});
<?php echo '</script'; ?>
...
" value="Y" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="input-medium" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php if ($_smarty_tpl->tpl_vars['value']->value||$_smarty_tpl->tpl_vars['value']->value==="0") {
echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'ISO-8859-1');
} else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['default_value'], ENT_QUOTES, 'ISO-8859-1');
}?>" />
...
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" cols="55" rows="8" class="<?php if ($_smarty_tpl->tpl_vars['option']->value['type']=="text") {?>cm-wysiwyg<?php }?> input-textarea-long"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
...
_filling" name="block_data[content][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'ISO-8859-1');?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 18:22:19
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/shipments/components/new_shipment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1520126345ee2bcab1c2ff9-13300038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '589a41adffdd3923d5f2af9a1f6d687f43bce333' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/shipments/components/new_shipment.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1520126345ee2bcab1c2ff9-13300038',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee2bcab21a812_38869336',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee2bcab21a812_38869336')) {function content_5ee2bcab21a812_38869336($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.inline_script.php';
...
<input type="hidden" name="shipment_data[order_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
">
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['loop_amount']->value<=100) {?>
                                <select id="shipment_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small cm-shipments-product" name="shipment_data[products][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]">
...
?>
                                    <option value="<?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['section']['amount']['index'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['amount']['last']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['section']['amount']['index'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                                <?php endfor; endif; ?>
                                </select>
                            <?php } else { ?>
                                <input id="shipment_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
" type="text" class="input-text" size="3" name="shipment_data[products][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['shipment_amount'], ENT_QUOTES, 'ISO-8859-1');?>
" />&nbsp;of&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['shipment_amount'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php } ?>
                    </select>
                    <p class="description">
...
<?php echo '<script'; ?>
 type="text/javascript">
                            packages['package_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_id']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['package_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
'] = [];
                        <?php echo '</script'; ?>
><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_inline_script(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package_num']->value, ENT_QUOTES, 'ISO-8859-1');?>
 <?php if ($_smarty_tpl->tpl_vars['package']->value['shipping_params']) {?>(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['shipping_params']['box_length'], ENT_QUOTES, 'ISO-8859-1');?>
 x <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['shipping_params']['box_width'], ENT_QUOTES, 'ISO-8859-1');?>
 x <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['shipping_params']['box_height'], ENT_QUOTES, 'ISO-8859-1');?>
)<?php }?>
                        </h3>
                        <ul>
...
<?php echo '<script'; ?>
 type="text/javascript">
                                packages['package_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_id']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['package_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
']['<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
'] = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['amount']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
                            <?php echo '</script'; ?>
><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_inline_script(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                            <?php if ($_smarty_tpl->tpl_vars['order_info']->value['products'][$_smarty_tpl->tpl_vars['cart_id']->value]) {?>
                                <li><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['amount']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span> x <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['products'][$_smarty_tpl->tpl_vars['cart_id']->value]['product'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</span> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['package']->value['weight'], ENT_QUOTES, 'ISO-8859-1');?>
<br />
                        <span class="strong"><?php echo $_smarty_tpl->__("shipping_method");?>
:</span> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>

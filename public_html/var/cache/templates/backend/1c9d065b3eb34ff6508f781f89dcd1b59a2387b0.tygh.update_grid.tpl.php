<?php /* Smarty version Smarty-3.1.21, created on 2020-06-23 10:09:01
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_grid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16920634865ef21b0d967e03-30113132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c9d065b3eb34ff6508f781f89dcd1b59a2387b0' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_grid.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16920634865ef21b0d967e03-30113132',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef21b0d9b1405_52191789',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef21b0d9b1405_52191789')) {function content_5ef21b0d9b1405_52191789($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<div id="grid_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
<div class="cm-tabs-content">
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("width");?>
</label>
        <div class="controls">
        <select id="elm_grid_width_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="width">
...
"
                ...
                ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['index']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
            <?php endfor; endif; ?>
        </select>
        </div>
    ...
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_content_align_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("content_alignment");?>
</label>
        <div class="controls">
        <select id="elm_grid_content_align_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="content_align">
            <option value="<?php echo htmlspecialchars(constant("\Tygh\BlockManager\Grid::ALIGN_FULL_WIDTH"), ENT_QUOTES, 'ISO-8859-1');?>
"
            ...
            <option value="<?php echo htmlspecialchars(constant("\Tygh\BlockManager\Grid::ALIGN_LEFT"), ENT_QUOTES, 'ISO-8859-1');?>
"
            ...
            <option value="<?php echo htmlspecialchars(constant("\Tygh\BlockManager\Grid::ALIGN_RIGHT"), ENT_QUOTES, 'ISO-8859-1');?>
"
    ...
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_wrapper_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("wrapper");?>
</label>
        <div class="controls">
            <select id="elm_grid_wrapper_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="wrapper">
...
?>
                    <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wrapper_template']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['wrapper_template']->value==$_smarty_tpl->tpl_vars['grid']->value['wrapper']) {?>selected<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wrapper_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                <?php } ?>
            </select>
        </div>
    ...
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_offset_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("offset");?>
</label>
        <div class="controls">
        <select id="elm_grid_offset_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="offset">
...
" <?php if ($_smarty_tpl->tpl_vars['index']->value==$_smarty_tpl->tpl_vars['grid']->value['offset']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['index']->value, ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_user_class_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("user_class");?>
</label>
        <div class="controls">
        <input id="elm_grid_user_class_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" type="text" />
    ...
    <div class="control-group">
        <label class="control-label cm-required cm-multiple-checkboxes"
               for="grid_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_availability"
        ><?php echo $_smarty_tpl->__("block_manager.availability.show_on");?>
</label>
        <div class="controls" id="grid_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_availability">
...
?>
                    ...
                    <input type="checkbox"
                        id="elm_grid_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"
                        ...
                        data-ca-toggle-text="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['grid_availability_instance']->value->getHiddenClass($_smarty_tpl->tpl_vars['device']->value), ENT_QUOTES, 'ISO-8859-1');?>
"
                        data-ca-toggle-text-mode="onDisable"
                        data-ca-toggle-text-target-elem-id="elm_grid_user_class_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
                    />
                    <label class="btn btn-group-checkbox__label" for="elm_grid_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_show_on_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['device']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
<!--grid_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
<?php }} ?>

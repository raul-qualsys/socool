<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 12:18:32
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/profiles/components/users_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20977217455ee26768667bf2-54418015%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '345b9073440e1b68fc87d76d2068500b04f642e2' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/profiles/components/users_search_form.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20977217455ee26768667bf2-54418015',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee267686a5220_25121806',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee267686a5220_25121806')) {function content_5ee267686a5220_25121806($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.array_to_fields.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('search','person_name','company','email','usergroup','not_a_member','tax_exempt','yes','no','phone','city','country','select_country','state','select_state','address','zip_postal_code','ordered_products'));
?>
...
<?php }?>
<form name="user_search_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
...
<input type="hidden" name="user_type" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['user_type'], ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php }?>
...
<div class="sidebar-field">
    ...
    <div class="break">
        <input type="text" name="name" id="elm_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
<div class="sidebar-field">
    ...
    <div class="break">
        <input type="text" name="company" id="elm_company" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
<div class="sidebar-field">
    ...
    <div class="break">
        <input type="text" name="email" id="elm_email" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
            ...
            <?php if (!fn_allowed_for("ULTIMATE:FREE")) {?>
                <div class="control-group">
                    ...
                    <select name="usergroup_id" id="elm_usergroup_id">
                        <option value="<?php echo htmlspecialchars(@constant('ALL_USERGROUPS'), ENT_QUOTES, 'ISO-8859-1');?>
"> -- </option>
...
" <?php if ($_smarty_tpl->tpl_vars['search']->value['usergroup_id']==$_smarty_tpl->tpl_vars['usergroup']->value['usergroup_id']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['usergroup']->value['usergroup'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php } ?>
                    </select>
                    </div>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"profiles:search_form"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="group span6 form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="phone" id="elm_phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="city" id="elm_city" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['city'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>
        <div class="control-group">
...
" <?php if ($_smarty_tpl->tpl_vars['search']->value['country']==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                <?php } ?>
            </select>
            </div>
 ...
 -</option>
                ...
                <input class="cm-state cm-location-search" type="text" id="srch_state_d" name="state" maxlength="64" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
" disabled="disabled" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="address" id="elm_address" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['address'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="zipcode" id="elm_zipcode" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>

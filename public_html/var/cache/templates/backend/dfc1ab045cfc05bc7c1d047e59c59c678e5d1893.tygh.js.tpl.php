<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 17:56:07
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/pickers/categories/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10213000015ef137079d9be2-14115137%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfc1ab045cfc05bc7c1d047e59c59c678e5d1893' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/pickers/categories/js.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10213000015ef137079d9be2-14115137',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef13707a31bf8_11576165',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef13707a31bf8_11576165')) {function content_5ef13707a31bf8_11576165($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/socool.mx/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php }?>class="cm-js-item <?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> cm-clone hidden<?php }?>">
        <?php if ($_smarty_tpl->tpl_vars['position_field']->value) {?><td width="5%"><input type="text" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
            <?php } else { ?>
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
"<?php }?> size="10" name="category_name" readonly="readonly" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra']->value, ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <p class="cm-js-item cm-clone hidden">
                <?php if ($_smarty_tpl->tpl_vars['hide_input']->value!="Y") {?>
                    <label class="radio inline-block" for="category_rb_category_id">
                        <input id="category_rb_category_id" type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['radio_input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    </label>
                <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['show_active_path']->value) {?>
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_path_items']->value, ENT_QUOTES, 'ISO-8859-1');?>

                        <a target="_blank" href="<?php echo htmlspecialchars(fn_url("categories.update&category_id=".((string)$_smarty_tpl->tpl_vars['default_category_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category']->value, ENT_QUOTES, 'ISO-8859-1');?>
</a>
                    <?php } else { ?>
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category']->value, ENT_QUOTES, 'ISO-8859-1');?>

                    <?php }?>
                    <a class="icon-remove-sign cm-tooltip hand hidden" onclick="Tygh.$.cePicker('delete_js_item', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['holder']->value, ENT_QUOTES, 'ISO-8859-1');?>
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
', 'c'); return false;" title="<?php echo $_smarty_tpl->__("remove");?>
"></a>
            </p>
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['category_id']->value) {?>
        <div class="cm-js-item <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['holder']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra']->value, ENT_QUOTES, 'ISO-8859-1');?>
>
            <?php if ($_smarty_tpl->tpl_vars['hide_input']->value!="Y") {?>
                <label class="radio inline-block" for="category_radio_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    <input id="category_radio_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['main_category']->value==$_smarty_tpl->tpl_vars['category_id']->value) {?>checked<?php }?> type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['radio_input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
                </label>
            <?php }?>
...
echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('object'=>$_smarty_tpl->tpl_vars['category_data']->value,'simple'=>true), 0);
            ...
            <?php if (fn_allowed_for("ULTIMATE")) {?>
                <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']||($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&($_smarty_tpl->tpl_vars['category_data']->value['company_id']==$_smarty_tpl->tpl_vars['runtime']->value['company_id']||$_smarty_tpl->tpl_vars['runtime']->value['company_id']==$_smarty_tpl->tpl_vars['owner_company_id']->value))) {?>
                    <a onclick="Tygh.$.cePicker('delete_js_item', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['holder']->value, ENT_QUOTES, 'ISO-8859-1');?>
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>

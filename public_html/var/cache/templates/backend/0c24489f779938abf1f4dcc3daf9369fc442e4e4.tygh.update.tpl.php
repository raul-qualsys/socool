<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 13:05:25
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17009351205ee27265bde7a6-72069123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c24489f779938abf1f4dcc3daf9369fc442e4e4' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/promotions/update.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17009351205ee27265bde7a6-72069123',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee27265c36ce3_08996274',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee27265c36ce3_08996274')) {function content_5ee27265c36ce3_08996274($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/function.script.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('name','detailed_description','short_description','use_avail_period','avail_from','avail_till','priority','stop_other_rules','tt_views_promotions_update_stop_other_rules','delete','new_promotion','editing_promotion'));
?>
...
function fn_promotion_add_group(id, zone)
{
    ...
    $.ceAjax('request', fn_url('promotions.dynamic?promotion_id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
            ...
            for (var l in items[k]['items']) {
                ...
                if (l == value) {
                    if (items[k]['items'][l]['variants']) {
                        ...
                        if (count < <?php echo htmlspecialchars(@constant('PRODUCT_FEATURE_VARIANTS_THRESHOLD'), ENT_QUOTES, 'ISO-8859-1');?>
) {
...
<input type="hidden" class="cm-no-hide-input" name="promotion_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
<input type="hidden" class="cm-no-hide-input" name="selected_section" value="<?php echo htmlspecialchars($_REQUEST['selected_section'], ENT_QUOTES, 'ISO-8859-1');?>
" />
<input type="hidden" class="cm-no-hide-input" name="promotion_data[zone]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['promotion_data']->value['zone'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['zone']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
...
:</label>
        <div class="controls">
            <input type="text" name="promotion_data[name]" id="elm_promotion_name" size="25" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promotion_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
        </div>
    </div>
...
:</label>
        <div class="controls">
        <textarea id="elm_promotion_det_descr" name="promotion_data[detailed_description]" cols="55" rows="8" class="cm-wysiwyg input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promotion_data']->value['detailed_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
    </div>
...
:</label>
        <div class="controls">
            <textarea id="elm_promotion_sht_descr" name="promotion_data[short_description]" cols="55" rows="8" class="cm-wysiwyg input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promotion_data']->value['short_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
    </div>
...
><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_inline_script(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        <input type="text" name="promotion_data[priority]" id="elm_promotion_priority" size="25" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['promotion_data']->value['priority'], ENT_QUOTES, 'ISO-8859-1');?>
" />
        </div>
    </div>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_promotions_update_stop_other_rules")), 0);?>
</label>
        <div class="controls">
...
<?php } else { ?>
    <?php $_smarty_tpl->tpl_vars['title_start'] = new Smarty_variable($_smarty_tpl->__("editing_promotion"), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['title_end'] = new Smarty_variable($_smarty_tpl->tpl_vars['promotion_data']->value['name'], null, 0);?>
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title_start'=>$_smarty_tpl->tpl_vars['title_start']->value,'title_end'=>$_smarty_tpl->tpl_vars['title_end']->value,'title'=>$_smarty_tpl->tpl_vars['title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>

<?php /* Smarty version Smarty-3.1.21, created on 2020-06-11 08:39:52
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/index/components/dashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12097282245ee23428e3ec97-39466782%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2dbb9ac48b27f044d623d86f83350be936ee2b43' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/index/components/dashboard.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12097282245ee23428e3ec97-39466782',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5ee23428efcce4_41731350',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee23428efcce4_41731350')) {function content_5ee23428efcce4_41731350($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.inline_script.php';
                        ...
                        <div class="dashboard-card-content">
                            <h3>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:finance_statistic_balance")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:finance_statistic_balance"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                                    ...
                                    <a href="<?php echo htmlspecialchars(fn_url("companies.balance"), ENT_QUOTES, 'ISO-8859-1');?>
"
...
"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['orders_stat']->value['orders']), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                            <?php } else { ?>
                                <?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['orders_stat']->value['orders']), ENT_QUOTES, 'ISO-8859-1');?>
                        ...
                        <?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['orders_stat']->value['prev_orders']), ENT_QUOTES, 'ISO-8859-1');?>
, <?php if ($_smarty_tpl->tpl_vars['orders_stat']->value['diff']['orders_count']>0) {?>+<?php }
echo htmlspecialchars($_smarty_tpl->tpl_vars['orders_stat']->value['diff']['orders_count'], ENT_QUOTES, 'ISO-8859-1');?>
...
%
            ...
            <?php if (!empty($_smarty_tpl->tpl_vars['orders_stat']->value['abandoned_cart_total'])) {?>
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card-content">
                        <h3><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['orders_stat']->value['abandoned_cart_total'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</h3><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['orders_stat']->value['prev_abandoned_cart_total'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
...
$_tmp2=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.manage?amount_from=&amount_to=0&tracking[0]=".$_tmp1."&tracking[1]=".$_tmp2), ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_statuses']->value[$_smarty_tpl->tpl_vars['order']->value['status']]['description'], ENT_QUOTES, 'ISO-8859-1');?>
                            ...
                            <td><a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['order']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
if ($_smarty_tpl->tpl_vars['order']->value['user_id']) {?></a><?php }?></td>
                            <td><span class="date"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['order']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</span></td>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="dashboard-vendors-activity__label">
                                            ...
                                            <a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['url']->value), ENT_QUOTES, 'ISO-8859-1');?>
">
                                        ...
                                        <td class="dashboard-vendors-activity__value">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dashboard_vendors_activity']->value['vendors_with_sales'], ENT_QUOTES, 'ISO-8859-1');?>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="dashboard-vendors-activity__label">
                                            <a href="<?php echo htmlspecialchars(fn_url("companies.manage?created_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&created_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)."&status=A"), ENT_QUOTES, 'ISO-8859-1');?>
">
                                        ...
                                        <td class="dashboard-vendors-activity__value">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dashboard_vendors_activity']->value['new_vendors'], ENT_QUOTES, 'ISO-8859-1');?>
...
">
                                        ...
                                        <td class="dashboard-vendors-activity__value">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dashboard_vendors_activity']->value['vendors_with_new_products'], ENT_QUOTES, 'ISO-8859-1');?>
                            ...
                            <div class="span6">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="dashboard-vendors-activity__label">
                                            <a href="<?php echo htmlspecialchars(fn_url("companies.manage?not_login_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&not_login_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)."&status=A"), ENT_QUOTES, 'ISO-8859-1');?>
">
                                        ...
                                        <td class="dashboard-vendors-activity__value">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dashboard_vendors_activity']->value['vendors_not_logged'], ENT_QUOTES, 'ISO-8859-1');?>
...
">
                                        ...
                                        <td class="dashboard-vendors-activity__value">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dashboard_vendors_activity']->value['new_products'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_status']->value['status_name'], ENT_QUOTES, 'ISO-8859-1');?>
                                                ...
                                                <td width="25%"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_status']->value['count'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
...
"><?php echo $_smarty_tpl->__('show_all');?>
                        ...
                        <?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
"><?php }
echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['user'], ENT_QUOTES, 'ISO-8859-1');
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['product'], ENT_QUOTES, 'ISO-8859-1');?>
</a><br>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['category'], ENT_QUOTES, 'ISO-8859-1');?>
</a><br>
                                    <?php }?>

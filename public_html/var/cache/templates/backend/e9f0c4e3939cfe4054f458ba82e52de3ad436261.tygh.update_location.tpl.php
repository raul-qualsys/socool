<?php /* Smarty version Smarty-3.1.21, created on 2020-06-22 11:15:36
         compiled from "/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_location.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9919373335ef0d92867da23-08822167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9f0c4e3939cfe4054f458ba82e52de3ad436261' => 
    array (
      0 => '/var/www/html/socool.mx/public_html/design/backend/templates/views/block_manager/update_location.tpl',
      1 => 1564032795,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9919373335ef0d92867da23-08822167',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ef0d928708841_80697589',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ef0d928708841_80697589')) {function content_5ef0d928708841_80697589($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/socool.mx/public_html/app/functions/smarty_plugins/block.hook.php';
...
" method="post" enctype="multipart/form-data" class=" form-horizontal" name="location_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_update_form">
<div id="location_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
" />
    <input type="hidden" name="result_ids" value="location_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-no-hide-input"/>
    <input type="hidden" name="location" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['location_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    <input type="hidden" name="location_data[location_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['location_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />

    <div class="tabs cm-j-tabs">
        <ul class="nav nav-tabs">
            <li id="location_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js active"><a><?php echo $_smarty_tpl->__("general");?>
</a></li>
            <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value) {?>
                <li id="location_object_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js"><a><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type']);?>
    ...
    <div class="cm-tabs-content" id="tabs_content_location_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <div id="content_location_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"block_manager:update_location_general")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"block_manager:update_location_general"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <div class="control-group">
                    <label for="location_dispatch_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-required control-label"><?php echo $_smarty_tpl->__("dispatch");?>
: </label>
                    <div class="controls"><select id="location_dispatch_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['location']->value['dispatch']==$_smarty_tpl->tpl_vars['k']->value) {?>selected="selected"<?php $_smarty_tpl->tpl_vars['selected'] = new Smarty_variable(1, null, 0);
                        ...
                        <input id="location_dispatch_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text<?php if ($_smarty_tpl->tpl_vars['not_custom_dispatch']->value) {?> input-text-disabled<?php }?>" <?php if ($_smarty_tpl->tpl_vars['not_custom_dispatch']->value) {?>disabled<?php }?> name="location_data[dispatch]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['dispatch'], ENT_QUOTES, 'ISO-8859-1');?>
" type="text"></div>
                </div>
                <div class="control-group">
...
: </label>
                    <div class="controls">
                        <input id="location_name" type="text" name="location_data[name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
">
                    </div>
                </div>
...
: </label>
                    <div class="controls">
                        <input id="location_title" type="text" name="location_data[title]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
: </label>
                    <div class="controls">
                        <textarea id="location_meta_descr" name="location_data[meta_description]" class="span9" cols="55" rows="4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['meta_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                        <?php if ($_smarty_tpl->tpl_vars['location']->value['is_default']) {?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="location_meta_key" name="location_data[meta_keywords]" class="span9" cols="55" rows="4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['meta_keywords'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                        <?php if ($_smarty_tpl->tpl_vars['location']->value['is_default']) {?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_block_manager_update_location_head_custom_html")), 0);?>
                    ...
                    <div class="controls">
                        <textarea id="location_custom_html" name="location_data[custom_html]" class="span9" cols="55" rows="4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['custom_html'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                        <?php if ($_smarty_tpl->tpl_vars['location']->value['is_default']) {?>
...
: </label>
                    <div class="controls">
                        <input id="location_position" type="text" name="location_data[position]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['position'], ENT_QUOTES, 'ISO-8859-1');?>
">
                    </div>
                </div>
        ...
        <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value) {?>
            <div id="content_location_object_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
<!--location_properties_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
<div class="buttons-container">
    <?php if (!$_smarty_tpl->tpl_vars['location']->value['is_default']&&$_smarty_tpl->tpl_vars['location']->value['location_id']>0) {?>
        <div class="botton-picker-remove pull-left">
            <a class="cm-confirm cm-post btn cm-tooltip" href="<?php echo htmlspecialchars(fn_url("block_manager.delete_location?location_id=".((string)$_smarty_tpl->tpl_vars['location']->value['location_id'])), ENT_QUOTES, 'ISO-8859-1');?>

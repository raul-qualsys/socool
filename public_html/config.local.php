...
//if ( ! defined ( 'BOOTSTRAP' ) ) { define ( 'Access denied' , verdadero ); }
...
if ( ! defined ( 'DESARROLLO' ) ) { define ( 'DESARROLLO' , verdadero ); }

/*
 * Database connection options
 */
$config['db_host'] = 'localhost';
$config['db_name'] = 'socool_mx';
$config['db_user'] = 'socool_mx';
$config['db_password'] = 'ZAD4TgwPFczFVSZv4cU3';
...
$config['http_host'] = 'socool.mx';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'socool.mx';
$config['https_path'] = '';
...
$config['admin_index']    = 'Ml3vVCYC33Hy2MST.php';
